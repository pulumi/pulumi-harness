...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"harness_platform_apikey":                          {Tok: harnessResource(mainMod, "PlatformApiKey")},
			...
			"harness_platform_connector_azure_cloud_cost":      {Tok: harnessResource(platformMod, "AzureCloudCostConnector")},
			"harness_platform_connector_artifactory":           {Tok: harnessResource(platformMod, "ArtifactoryConnector")},
			"harness_platform_connector_azure_cloud_provider":  {Tok: harnessResource(platformMod, "AzureCloudProviderConnector")},
			...
			"harness_platform_connector_gcp_secret_manager":    {Tok: harnessResource(platformMod, "GcpSecretManagerConnector")},
			"harness_platform_connector_jenkins":               {Tok: harnessResource(platformMod, "JenkinsConnector")},
			"harness_platform_connector_kubernetes_cloud_cost": {Tok: harnessResource(platformMod, "KubernetesCloudCostConnector")},
			...
			"harness_platform_connector_terraform_cloud":       {Tok: harnessResource(platformMod, "TerraformCloudConnector")},
			...
			"harness_platform_service_overrides_v2":          {Tok: harnessResource(platformMod, "ServiceOverridesV2")},
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"harness_platform_apikey":                          {Tok: harnessDataSource(platformMod, "getApiKey")},
			...
			"harness_platform_connector_azure_cloud_cost":      {Tok: harnessDataSource(platformMod, "getAzureCloudCostConnector")},
			"harness_platform_connector_azure_cloud_provider":  {Tok: harnessDataSource(platformMod, "getAzureCloudProviderConnector")},
			"harness_platform_connector_azure_key_vault":       {Tok: harnessDataSource(platformMod, "getAzureKeyVaultConnector")},
			"harness_platform_connector_elasticsearch":         {Tok: harnessDataSource(platformMod, "getElasticsearchConnector")},
			"harness_platform_connector_gcp_cloud_cost":        {Tok: harnessDataSource(platformMod, "getGcpCloudCostConnector")},
			"harness_platform_connector_gcp_secret_manager":    {Tok: harnessDataSource(platformMod, "getGcpSecretManagerConnector")},
			"harness_platform_connector_jenkins":               {Tok: harnessDataSource(platformMod, "getJenkinsConnector")},
			"harness_platform_connector_kubernetes_cloud_cost": {Tok: harnessDataSource(platformMod, "getKubernetesCloudCostConnector")},
			"harness_platform_connector_oci_helm":              {Tok: harnessDataSource(platformMod, "getOciHelmConnector")},
			"harness_platform_connector_service_now":           {Tok: harnessDataSource(platformMod, "getServiceNowConnector")},
			...
			"harness_platform_connector_terraform_cloud":       {Tok: harnessDataSource(platformMod, "getTerraformCloudConnector")},
			...
			"harness_platform_gitops_agent_deploy_yaml":        {Tok: harnessDataSource(platformMod, "getGitopsAgentDeployYaml")},
			"harness_platform_gitops_applications":             {Tok: harnessDataSource(platformMod, "getGitopsApplications")},
			...
			"harness_platform_service_overrides_v2":            {Tok: harnessDataSource(platformMod, "getServiceOverridesV2")},
			...
			"harness_platform_variables":                       {Tok: harnessDataSource(platformMod, "getVariables")}, "harness_platform_environment": {Tok: harnessDataSource(platformMod, "getEnvironment")},

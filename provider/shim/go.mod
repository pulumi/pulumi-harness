...
require (
	github.com/harness/terraform-provider-harness v0.20.0
	github.com/hashicorp/terraform-plugin-sdk/v2 v2.26.1
	github.com/lbrlabs/pulumi-harness/provider v0.0.0-20221227064623-0d00513c0628
)
...
require (
	...
	github.com/harness/harness-go-sdk v0.3.26 // indirect

...
namespace Pulumi.Harness.Inputs
{
    ...
    public sealed class InfrastructureDefinitionAwsSshArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("tags")]
        private InputList<Inputs.InfrastructureDefinitionAwsSshTagArgs>? _tags;

        /// <summary>
        /// The tags to use when selecting the instances.
        /// </summary>
        public InputList<Inputs.InfrastructureDefinitionAwsSshTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.InfrastructureDefinitionAwsSshTagArgs>());
            set => _tags = value;
        }
        ...
        public InfrastructureDefinitionAwsSshArgs()
        {
        }
        public static new InfrastructureDefinitionAwsSshArgs Empty => new InfrastructureDefinitionAwsSshArgs();
    }
}

...
{
    [HarnessResourceType("harness:index/environmentServiceOverrides:EnvironmentServiceOverrides")]
    public partial class EnvironmentServiceOverrides : global::Pulumi.CustomResource
    {
        ...
        public EnvironmentServiceOverrides(string name, EnvironmentServiceOverridesArgs args, CustomResourceOptions? options = null)
            : base("harness:index/environmentServiceOverrides:EnvironmentServiceOverrides", name, args ?? new EnvironmentServiceOverridesArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private EnvironmentServiceOverrides(string name, Input<string> id, EnvironmentServiceOverridesState? state = null, CustomResourceOptions? options = null)
            : base("harness:index/environmentServiceOverrides:EnvironmentServiceOverrides", name, state, MakeResourceOptions(options, id))
        {
        }

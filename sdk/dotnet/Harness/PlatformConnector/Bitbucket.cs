...
namespace Lbrlabs.PulumiPackage.Harness.PlatformConnector
{
    ...
    /// </summary>
    [HarnessResourceType("harness:PlatformConnector/bitbucket:Bitbucket")]
    public partial class Bitbucket : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.BitbucketApiAuthentication?> ApiAuthentication { get; private set; } = null!;
        ...
        /// </summary>
        [Output("credentials")]
        public Output<Outputs.BitbucketCredentials> Credentials { get; private set; } = null!;
        ...
        public Bitbucket(string name, BitbucketArgs args, CustomResourceOptions? options = null)
            : base("harness:PlatformConnector/bitbucket:Bitbucket", name, args ?? new BitbucketArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Bitbucket(string name, Input<string> id, BitbucketState? state = null, CustomResourceOptions? options = null)
            : base("harness:PlatformConnector/bitbucket:Bitbucket", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BitbucketArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.BitbucketApiAuthenticationArgs>? ApiAuthentication { get; set; }
        ...
        public Input<Inputs.BitbucketCredentialsArgs> Credentials { get; set; } = null!;
    ...
    public sealed class BitbucketState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Configuration for using the BitBucket api. API Access is required for using “Git Experience”, for creation of Git based triggers, Webhooks management and updating Git statuses.
        /// </summary>
        [Input("apiAuthentication")]
        public Input<Inputs.BitbucketApiAuthenticationGetArgs>? ApiAuthentication { get; set; }
        ...
        /// </summary>
        [Input("credentials")]
        public Input<Inputs.BitbucketCredentialsGetArgs>? Credentials { get; set; }
        ...
        public static new BitbucketState Empty => new BitbucketState();
    }
}

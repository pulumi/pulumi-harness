...
namespace Lbrlabs.PulumiPackage.Harness.PlatformConnector
{
    ...
    /// </summary>
    [HarnessResourceType("harness:PlatformConnector/github:Github")]
    public partial class Github : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.GithubApiAuthentication?> ApiAuthentication { get; private set; } = null!;
        ...
        /// </summary>
        [Output("credentials")]
        public Output<Outputs.GithubCredentials> Credentials { get; private set; } = null!;
        ...
        public Github(string name, GithubArgs args, CustomResourceOptions? options = null)
            : base("harness:PlatformConnector/github:Github", name, args ?? new GithubArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Github(string name, Input<string> id, GithubState? state = null, CustomResourceOptions? options = null)
            : base("harness:PlatformConnector/github:Github", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GithubArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.GithubApiAuthenticationArgs>? ApiAuthentication { get; set; }
        ...
        public Input<Inputs.GithubCredentialsArgs> Credentials { get; set; } = null!;
    ...
    public sealed class GithubState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("apiAuthentication")]
        public Input<Inputs.GithubApiAuthenticationGetArgs>? ApiAuthentication { get; set; }
        ...
        /// </summary>
        [Input("credentials")]
        public Input<Inputs.GithubCredentialsGetArgs>? Credentials { get; set; }

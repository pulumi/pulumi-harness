...
namespace Lbrlabs.PulumiPackage.Harness.Service
{
    ...
    /// ```
    /// </summary>
    [HarnessResourceType("harness:service/ami:Ami")]
    public partial class Ami : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("variables")]
        public Output<ImmutableArray<Outputs.AmiVariable>> Variables { get; private set; } = null!;
        ...
        public Ami(string name, AmiArgs args, CustomResourceOptions? options = null)
            : base("harness:service/ami:Ami", name, args ?? new AmiArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ami(string name, Input<string> id, AmiState? state = null, CustomResourceOptions? options = null)
            : base("harness:service/ami:Ami", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AmiArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("variables")]
        private InputList<Inputs.AmiVariableArgs>? _variables;

        /// <summary>
        /// Variables to be used in the service
        /// </summary>
        public InputList<Inputs.AmiVariableArgs> Variables
        {
            get => _variables ?? (_variables = new InputList<Inputs.AmiVariableArgs>());
    ...
    public sealed class AmiState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("variables")]
        private InputList<Inputs.AmiVariableGetArgs>? _variables;

        /// <summary>
        /// Variables to be used in the service
        /// </summary>
        public InputList<Inputs.AmiVariableGetArgs> Variables
        {
            get => _variables ?? (_variables = new InputList<Inputs.AmiVariableGetArgs>());
            set => _variables = value;
        }

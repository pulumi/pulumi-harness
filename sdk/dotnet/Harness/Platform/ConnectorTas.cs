...
namespace Lbrlabs.PulumiPackage.Harness.Platform
{
    ...
    /// ```
    /// </summary>
    [HarnessResourceType("harness:platform/connectorTas:ConnectorTas")]
    public partial class ConnectorTas : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Contains Tas connector credentials.
        /// </summary>
        [Output("credentials")]
        public Output<Outputs.ConnectorTasCredentials> Credentials { get; private set; } = null!;
        ...
        public ConnectorTas(string name, ConnectorTasArgs args, CustomResourceOptions? options = null)
            : base("harness:platform/connectorTas:ConnectorTas", name, args ?? new ConnectorTasArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectorTas(string name, Input<string> id, ConnectorTasState? state = null, CustomResourceOptions? options = null)
            : base("harness:platform/connectorTas:ConnectorTas", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ConnectorTas Get(string name, Input<string> id, ConnectorTasState? state = null, CustomResourceOptions? options = null)
        {
            return new ConnectorTas(name, id, state, options);
        }
    }

    public sealed class ConnectorTasArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Contains Tas connector credentials.
        /// </summary>
        [Input("credentials", required: true)]
        public Input<Inputs.ConnectorTasCredentialsArgs> Credentials { get; set; } = null!;
        ...
        public ConnectorTasArgs()
        {
        }
        public static new ConnectorTasArgs Empty => new ConnectorTasArgs();
    }

    public sealed class ConnectorTasState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Contains Tas connector credentials.
        /// </summary>
        [Input("credentials")]
        public Input<Inputs.ConnectorTasCredentialsGetArgs>? Credentials { get; set; }
        ...
        public ConnectorTasState()
        {
        }
        public static new ConnectorTasState Empty => new ConnectorTasState();
    }
}

...
namespace Lbrlabs.PulumiPackage.Harness.Platform
{
    ...
    /// ```
    /// </summary>
    [HarnessResourceType("harness:platform/connectorServiceNow:ConnectorServiceNow")]
    public partial class ConnectorServiceNow : global::Pulumi.CustomResource
    {
        /// <summary>
        /// The credentials to use for the service now authentication.
        /// </summary>
        [Output("auth")]
        public Output<Outputs.ConnectorServiceNowAuth> Auth { get; private set; } = null!;
        ...
        public ConnectorServiceNow(string name, ConnectorServiceNowArgs args, CustomResourceOptions? options = null)
            : base("harness:platform/connectorServiceNow:ConnectorServiceNow", name, args ?? new ConnectorServiceNowArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConnectorServiceNow(string name, Input<string> id, ConnectorServiceNowState? state = null, CustomResourceOptions? options = null)
            : base("harness:platform/connectorServiceNow:ConnectorServiceNow", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ConnectorServiceNow Get(string name, Input<string> id, ConnectorServiceNowState? state = null, CustomResourceOptions? options = null)
        {
            return new ConnectorServiceNow(name, id, state, options);
        }
    }

    public sealed class ConnectorServiceNowArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The credentials to use for the service now authentication.
        /// </summary>
        [Input("auth", required: true)]
        public Input<Inputs.ConnectorServiceNowAuthArgs> Auth { get; set; } = null!;
        ...
        public ConnectorServiceNowArgs()
        {
        }
        public static new ConnectorServiceNowArgs Empty => new ConnectorServiceNowArgs();
    }

    public sealed class ConnectorServiceNowState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The credentials to use for the service now authentication.
        /// </summary>
        [Input("auth")]
        public Input<Inputs.ConnectorServiceNowAuthGetArgs>? Auth { get; set; }
        ...
        public ConnectorServiceNowState()
        {
        }
        public static new ConnectorServiceNowState Empty => new ConnectorServiceNowState();
    }
}

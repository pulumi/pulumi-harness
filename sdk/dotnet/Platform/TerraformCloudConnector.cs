...
namespace Pulumi.Harness.Platform
{
    ...
    public partial class TerraformCloudConnector : global::Pulumi.CustomResource
    {
        ...
        public TerraformCloudConnector(string name, TerraformCloudConnectorArgs args, CustomResourceOptions? options = null)
            : base("harness:platform/terraformCloudConnector:TerraformCloudConnector", name, args ?? new TerraformCloudConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TerraformCloudConnector(string name, Input<string> id, TerraformCloudConnectorState? state = null, CustomResourceOptions? options = null)
            : base("harness:platform/terraformCloudConnector:TerraformCloudConnector", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TerraformCloudConnector Get(string name, Input<string> id, TerraformCloudConnectorState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class TerraformCloudConnectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        public TerraformCloudConnectorArgs()
        {
        }
        public static new TerraformCloudConnectorArgs Empty => new TerraformCloudConnectorArgs();
    }
    ...
    public sealed class TerraformCloudConnectorState : global::Pulumi.ResourceArgs
    {
        ...
        public TerraformCloudConnectorState()
        {
        }
        public static new TerraformCloudConnectorState Empty => new TerraformCloudConnectorState();
    }
}

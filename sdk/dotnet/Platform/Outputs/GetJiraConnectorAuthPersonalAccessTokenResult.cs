...
namespace Pulumi.Harness.Platform.Outputs
{
    ...
    [OutputType]
    public sealed class GetJiraConnectorAuthPersonalAccessTokenResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly string PatRef;

        [OutputConstructor]
        private GetJiraConnectorAuthPersonalAccessTokenResult(string patRef)
        {
            PatRef = patRef;
        }
    }

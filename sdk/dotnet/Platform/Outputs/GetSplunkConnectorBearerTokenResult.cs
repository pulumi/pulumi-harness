...
namespace Pulumi.Harness.Platform.Outputs
{
    ...
    [OutputType]
    public sealed class GetSplunkConnectorBearerTokenResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly string BearerTokenRef;

        [OutputConstructor]
        private GetSplunkConnectorBearerTokenResult(string bearerTokenRef)
        {

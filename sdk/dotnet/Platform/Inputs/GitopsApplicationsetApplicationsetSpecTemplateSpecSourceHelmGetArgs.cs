...
namespace Pulumi.Harness.Platform.Inputs
{
    ...
    public sealed class GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("fileParameters")]
        private InputList<Inputs.GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmFileParameterGetArgs>? _fileParameters;

        /// <summary>
        /// File parameters for the helm template.
        /// </summary>
        public InputList<Inputs.GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmFileParameterGetArgs> FileParameters
        {
            get => _fileParameters ?? (_fileParameters = new InputList<Inputs.GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmFileParameterGetArgs>());
        ...
        [Input("parameters")]
        private InputList<Inputs.GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmParameterGetArgs>? _parameters;

        /// <summary>
        /// Helm parameters which are passed to the helm template command upon manifest generation.
        /// </summary>
        public InputList<Inputs.GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmParameterGetArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmParameterGetArgs>());
        ...
        public GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmGetArgs()
        {
        }
        public static new GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmGetArgs Empty => new GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmGetArgs();
    }
}

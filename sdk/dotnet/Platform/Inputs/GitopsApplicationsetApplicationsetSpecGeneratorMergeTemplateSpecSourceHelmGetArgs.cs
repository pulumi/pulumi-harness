...
namespace Pulumi.Harness.Platform.Inputs
{
    ...
    public sealed class GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("fileParameters")]
        private InputList<Inputs.GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmFileParameterGetArgs>? _fileParameters;

        /// <summary>
        /// File parameters for the helm template.
        /// </summary>
        public InputList<Inputs.GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmFileParameterGetArgs> FileParameters
        {
            get => _fileParameters ?? (_fileParameters = new InputList<Inputs.GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmFileParameterGetArgs>());
        ...
        [Input("parameters")]
        private InputList<Inputs.GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmParameterGetArgs>? _parameters;

        /// <summary>
        /// Helm parameters which are passed to the helm template command upon manifest generation.
        /// </summary>
        public InputList<Inputs.GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmParameterGetArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmParameterGetArgs>());
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmGetArgs()
        {
        }
        public static new GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmGetArgs Empty => new GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmGetArgs();
    }
}

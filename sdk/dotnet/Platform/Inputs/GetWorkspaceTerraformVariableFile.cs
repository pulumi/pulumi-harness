...
namespace Pulumi.Harness.Platform.Inputs
{
    ...
    public sealed class GetWorkspaceTerraformVariableFileArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public string RepositoryBranch { get; set; } = null!;

        /// <summary>
        /// Repository commit is tag to fetch the variables from. This cannot be set if repository branch or sha is set.
        /// </summary>
        [Input("repositoryCommit", required: true)]
        public string RepositoryCommit { get; set; } = null!;
        ...
        public GetWorkspaceTerraformVariableFileArgs()
        {
        }
        public static new GetWorkspaceTerraformVariableFileArgs Empty => new GetWorkspaceTerraformVariableFileArgs();
    }
}

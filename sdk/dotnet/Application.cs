...
namespace Pulumi.Harness
{
    ...
    /// ```
    /// </summary>
    [HarnessResourceType("harness:index/application:Application")]
    public partial class Application : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("gitSyncConnectorId")]
        public Output<string> GitSyncConnectorId { get; private set; } = null!;

        /// <summary>
        /// True if git sync is enabled on this application
        /// </summary>
        [Output("gitSyncEnabled")]
        public Output<bool> GitSyncEnabled { get; private set; } = null!;

        /// <summary>
        /// When this is set to true, all manual triggers will require API Key authorization
        /// </summary>
        [Output("isManualTriggerAuthorized")]
        public Output<bool?> IsManualTriggerAuthorized { get; private set; } = null!;
        ...
        public Application(string name, ApplicationArgs? args = null, CustomResourceOptions? options = null)
            : base("harness:index/application:Application", name, args ?? new ApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Application(string name, Input<string> id, ApplicationState? state = null, CustomResourceOptions? options = null)
            : base("harness:index/application:Application", name, state, MakeResourceOptions(options, id))
        {
        }

...
namespace Pulumi.Harness.Autostopping
{
    ...
    /// ```
    /// </summary>
    [HarnessResourceType("harness:autostopping/gcpProxy:GcpProxy")]
    public partial class GcpProxy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        [Output("certificates")]
        public Output<Outputs.GcpProxyCertificates?> Certificates { get; private set; } = null!;
        ...
        public GcpProxy(string name, GcpProxyArgs args, CustomResourceOptions? options = null)
            : base("harness:autostopping/gcpProxy:GcpProxy", name, args ?? new GcpProxyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GcpProxy(string name, Input<string> id, GcpProxyState? state = null, CustomResourceOptions? options = null)
            : base("harness:autostopping/gcpProxy:GcpProxy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GcpProxy Get(string name, Input<string> id, GcpProxyState? state = null, CustomResourceOptions? options = null)
        {
            return new GcpProxy(name, id, state, options);
        }
    }

    public sealed class GcpProxyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Boolean value to indicate if proxy vm needs to have static IP
        /// </summary>
        ...
        [Input("certificates")]
        public Input<Inputs.GcpProxyCertificatesArgs>? Certificates { get; set; }
        ...
        public static new GcpProxyArgs Empty => new GcpProxyArgs();
    }

    public sealed class GcpProxyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Boolean value to indicate if proxy vm needs to have static IP
        /// </summary>
        ...
        [Input("certificates")]
        public Input<Inputs.GcpProxyCertificatesGetArgs>? Certificates { get; set; }
        ...
        public GcpProxyState()
        {
        }
        public static new GcpProxyState Empty => new GcpProxyState();
    }
}

...
namespace Pulumi.Harness.PlatformConnector
{
    public static class GetPrometheus
    {
        ...
        public static Task<GetPrometheusResult> InvokeAsync(GetPrometheusArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrometheusResult>("harness:PlatformConnector/getPrometheus:getPrometheus", args ?? new GetPrometheusArgs(), options.WithDefaults());

        /// <summary>
        /// Datasource for looking up a Prometheus connector.
        /// </summary>
        public static Output<GetPrometheusResult> Invoke(GetPrometheusInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPrometheusResult>("harness:PlatformConnector/getPrometheus:getPrometheus", args ?? new GetPrometheusInvokeArgs(), options.WithDefaults());
    }

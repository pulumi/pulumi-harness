...
namespace Pulumi.Harness.Chaos.Inputs
{
    ...
    public sealed class SecurityGovernanceRuleV3TimeWindowArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("recurrence")]
        public Input<Inputs.SecurityGovernanceRuleV3TimeWindowRecurrenceArgs>? Recurrence { get; set; }
        ...
        public SecurityGovernanceRuleV3TimeWindowArgs()
        {
        }
        public static new SecurityGovernanceRuleV3TimeWindowArgs Empty => new SecurityGovernanceRuleV3TimeWindowArgs();
    }
}

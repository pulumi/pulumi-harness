...
namespace Pulumi.Harness.Chaos.Inputs
{
    ...
    public sealed class GetProbeTemplateCmdProbeInputArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Command to execute.
        /// </summary>
        ...
        [Input("comparators")]
        private InputList<Inputs.GetProbeTemplateCmdProbeComparatorInputArgs>? _comparators;

        /// <summary>
        /// Comparator for command output validation.
        /// </summary>
        public InputList<Inputs.GetProbeTemplateCmdProbeComparatorInputArgs> Comparators
        {
            get => _comparators ?? (_comparators = new InputList<Inputs.GetProbeTemplateCmdProbeComparatorInputArgs>());
            set => _comparators = value;
        }

        [Input("envs")]
        private InputList<Inputs.GetProbeTemplateCmdProbeEnvInputArgs>? _envs;

        /// <summary>
        /// Environment variables for the command.
        /// </summary>
        public InputList<Inputs.GetProbeTemplateCmdProbeEnvInputArgs> Envs
        {
            get => _envs ?? (_envs = new InputList<Inputs.GetProbeTemplateCmdProbeEnvInputArgs>());
            set => _envs = value;
        }
        ...
        public GetProbeTemplateCmdProbeInputArgs()
        {
        }
        public static new GetProbeTemplateCmdProbeInputArgs Empty => new GetProbeTemplateCmdProbeInputArgs();
    }
}

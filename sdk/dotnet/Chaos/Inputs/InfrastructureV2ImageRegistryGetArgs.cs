...
namespace Pulumi.Harness.Chaos.Inputs
{
    ...
    public sealed class InfrastructureV2ImageRegistryGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("customImages")]
        private InputList<Inputs.InfrastructureV2ImageRegistryCustomImageGetArgs>? _customImages;

        /// <summary>
        /// Custom image configurations. Required when use*custom*images is true.
        /// </summary>
        public InputList<Inputs.InfrastructureV2ImageRegistryCustomImageGetArgs> CustomImages
        {
            get => _customImages ?? (_customImages = new InputList<Inputs.InfrastructureV2ImageRegistryCustomImageGetArgs>());
            set => _customImages = value;
        }

        [Input("identifiers")]
        private InputList<Inputs.InfrastructureV2ImageRegistryIdentifierGetArgs>? _identifiers;

        /// <summary>
        /// Scoped identifiers for the registry.
        /// </summary>
        public InputList<Inputs.InfrastructureV2ImageRegistryIdentifierGetArgs> Identifiers
        {
            get => _identifiers ?? (_identifiers = new InputList<Inputs.InfrastructureV2ImageRegistryIdentifierGetArgs>());
        ...
        public InfrastructureV2ImageRegistryGetArgs()
        {
        }
        public static new InfrastructureV2ImageRegistryGetArgs Empty => new InfrastructureV2ImageRegistryGetArgs();
    }
}

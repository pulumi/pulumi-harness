...
namespace Pulumi.Harness
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pulumi";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Harness.version.txt");
    ...
    internal sealed class HarnessResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public HarnessResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}

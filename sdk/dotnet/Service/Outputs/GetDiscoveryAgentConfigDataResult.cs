...
namespace Pulumi.Harness.Service.Outputs
{
    ...
    [OutputType]
    public sealed class GetDiscoveryAgentConfigDataResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDiscoveryAgentConfigDataCronResult> Crons;
        /// <summary>
        ...
        [OutputConstructor]
        private GetDiscoveryAgentConfigDataResult(
            ImmutableArray<string> blacklistedNamespaces,

            int collectionWindowInMin,

            ImmutableArray<Outputs.GetDiscoveryAgentConfigDataCronResult> crons,

...
namespace Pulumi.Harness.Service.Inputs
{
    ...
    public sealed class DiscoveryAgentConfigDataGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("crons")]
        private InputList<Inputs.DiscoveryAgentConfigDataCronGetArgs>? _crons;

        /// <summary>
        /// Cron schedule for data collection.
        /// </summary>
        public InputList<Inputs.DiscoveryAgentConfigDataCronGetArgs> Crons
        {
            get => _crons ?? (_crons = new InputList<Inputs.DiscoveryAgentConfigDataCronGetArgs>());
            set => _crons = value;
        }
        ...
        public DiscoveryAgentConfigDataGetArgs()
        {
        }
        public static new DiscoveryAgentConfigDataGetArgs Empty => new DiscoveryAgentConfigDataGetArgs();
    }
}

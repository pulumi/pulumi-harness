...
class GetAwsAlbResult:
    ...
    def alb_arn(self) -> Optional[builtins.str]:
        """
...
def get_aws_alb(alb_arn: Optional[builtins.str] = None,
    ...
    :param builtins.str alb_arn: Arn of AWS ALB to be imported. Required only for importing existing ALB
...
def get_aws_alb_output(alb_arn: Optional[pulumi.Input[Optional[builtins.str]]] = None,

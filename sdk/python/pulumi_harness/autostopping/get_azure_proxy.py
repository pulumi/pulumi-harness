...
def get_azure_proxy(allocate_static_ip: Optional[builtins.bool] = None,
    ...
    :param builtins.str keypair: Name of SSH Key to be used for proxy VM
    :param builtins.str machine_type: Type of instance to be used for proxy
...
def get_azure_proxy_output(allocate_static_ip: Optional[pulumi.Input[Optional[builtins.bool]]] = None,

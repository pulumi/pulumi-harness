...
class GetDelegateResult:
    ...
    def polling_mode_enabled(self) -> builtins.bool:
        """
...
def get_delegate(hostname: Optional[builtins.str] = None,
    ...
    :param builtins.str hostname: The hostname of the delegate.
    :param builtins.str id: Unique identifier of the delegate
...
def get_delegate_output(hostname: Optional[pulumi.Input[Optional[builtins.str]]] = None,

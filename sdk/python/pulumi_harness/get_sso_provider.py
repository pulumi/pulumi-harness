...
def get_sso_provider(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Unique identifier of the SSO provider.
    :param builtins.str name: The name of the SSO provider.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_sso_provider_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,

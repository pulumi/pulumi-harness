...
class DelegateApprovalArgs:
    def __init__(__self__, *,
                 approve: pulumi.Input[builtins.bool],
                 delegate_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a DelegateApproval resource.
        :param pulumi.Input[builtins.bool] approve: Whether or not to approve the delegate.
        :param pulumi.Input[builtins.str] delegate_id: The id of the delegate.
        """
    ...
    @property
    @pulumi.getter
    def approve(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @approve.setter
    def approve(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "approve", value)

    @property
    @pulumi.getter(name="delegateId")
    def delegate_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @delegate_id.setter
    def delegate_id(self, value: pulumi.Input[builtins.str]):
...
class _DelegateApprovalState:
    def __init__(__self__, *,
                 approve: Optional[pulumi.Input[builtins.bool]] = None,
                 delegate_id: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering DelegateApproval resources.
        :param pulumi.Input[builtins.bool] approve: Whether or not to approve the delegate.
        :param pulumi.Input[builtins.str] delegate_id: The id of the delegate.
        :param pulumi.Input[builtins.str] status: The status of the delegate.
        """
    ...
    @property
    @pulumi.getter
    def approve(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether or not to approve the delegate.
        """
        return pulumi.get(self, "approve")
    ...
    @approve.setter
    def approve(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "approve", value)

    @property
    @pulumi.getter(name="delegateId")
    def delegate_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The id of the delegate.
        """
        return pulumi.get(self, "delegate_id")
    ...
    @delegate_id.setter
    def delegate_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "delegate_id", value)
...
@pulumi.type_token("harness:index/delegateApproval:DelegateApproval")
class DelegateApproval(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            approve: Optional[pulumi.Input[builtins.bool]] = None,
            delegate_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'DelegateApproval':
        """
    ...
    @property
    @pulumi.getter
    def approve(self) -> pulumi.Output[builtins.bool]:
        """
        Whether or not to approve the delegate.
        """
        return pulumi.get(self, "approve")
    ...
    @property
    @pulumi.getter(name="delegateId")
    def delegate_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the delegate.
        """
        return pulumi.get(self, "delegate_id")

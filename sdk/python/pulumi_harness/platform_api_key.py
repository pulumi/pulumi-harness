...
class PlatformApiKeyArgs:
    def __init__(__self__, *,
                 ...
                 default_time_to_expire_token: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] default_time_to_expire_token: Default expiration time of the Token within API Key
    ...
    def default_time_to_expire_token(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def default_time_to_expire_token(self, value: Optional[pulumi.Input[builtins.int]]):
...
class PlatformApiKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            parent_id: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'PlatformApiKey':
        """
    ...
    @property
    @pulumi.getter(name="defaultTimeToExpireToken")
    def default_time_to_expire_token(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Default expiration time of the Token within API Key
        """
        return pulumi.get(self, "default_time_to_expire_token")

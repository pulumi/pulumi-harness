...
class RuleSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cloud_provider: The cloud provider for the rule set. It should be either AWS, AZURE or GCP.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] rule_ids: List of rule IDs
        :param pulumi.Input[builtins.str] description: Description for rule set.
        :param pulumi.Input[builtins.str] name: Name of the rule set.
        """
...
class _RuleSetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the rule set.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] rule_ids: List of rule IDs
        :param pulumi.Input[builtins.str] rule_set_id: Id of the rule.
        """
    ...
    def rule_set_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Id of the rule.
        """
    ...
    @rule_set_id.setter
    def rule_set_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RuleSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            rule_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            rule_set_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RuleSet':
        """

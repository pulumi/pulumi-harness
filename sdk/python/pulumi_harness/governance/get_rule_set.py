...
def get_rule_set(rule_set_id: Optional[builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRuleSetResult:
    """
    Datasource for looking up a rule.


    :param builtins.str rule_set_id: Id of rule set.
    """
    __args__ = dict()
...
def get_rule_set_output(rule_set_id: Optional[pulumi.Input[builtins.str]] = None,

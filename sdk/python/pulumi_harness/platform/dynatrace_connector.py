...
class DynatraceConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_token_ref: The reference to the Harness secret containing the api token. To reference a secret at the organization scope, prefix 'org' to the expression: org.{identifier}. To reference a secret at the account scope, prefix 'account` to the expression: account.{identifier}.
        :param pulumi.Input[builtins.str] identifier: Unique identifier of the resource.
        :param pulumi.Input[builtins.str] url: URL of the Dynatrace server.
...
class _DynatraceConnectorState:
    def __init__(__self__, *,
                 api_token_ref: Optional[pulumi.Input[builtins.str]] = None,
                 delegate_selectors: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="apiTokenRef")
    def api_token_ref(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The reference to the Harness secret containing the api token. To reference a secret at the organization scope, prefix 'org' to the expression: org.{identifier}. To reference a secret at the account scope, prefix 'account` to the expression: account.{identifier}.
        """
        return pulumi.get(self, "api_token_ref")
    ...
    @api_token_ref.setter
    def api_token_ref(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "api_token_ref", value)
...
class DynatraceConnector(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'DynatraceConnector':
        """
    ...
    @property
    @pulumi.getter(name="apiTokenRef")
    def api_token_ref(self) -> pulumi.Output[builtins.str]:
        """
        The reference to the Harness secret containing the api token. To reference a secret at the organization scope, prefix 'org' to the expression: org.{identifier}. To reference a secret at the account scope, prefix 'account` to the expression: account.{identifier}.
        """
        return pulumi.get(self, "api_token_ref")

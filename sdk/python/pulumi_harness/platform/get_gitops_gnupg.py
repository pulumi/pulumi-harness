...
def get_gitops_gnupg(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str account_id: Account Identifier for the GnuPG Key.
    :param builtins.str agent_id: Agent identifier for the GnuPG Key.
    :param builtins.str identifier: Identifier for the GnuPG Key.
    :param builtins.str org_id: Organization Identifier for the GnuPG Key.
    :param builtins.str project_id: Project Identifier for the GnuPG Key.
...
def get_gitops_gnupg_output(account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,

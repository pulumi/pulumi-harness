...
def get_gitops_gnupg(account_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str account_id: Account Identifier for the GnuPG Key.
    :param _builtins.str agent_id: Agent identifier for the GnuPG Key.

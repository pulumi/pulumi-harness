...
class GetDynatraceConnectorResult:
    ...
    def api_token_ref(self) -> _builtins.str:
        """
...
def get_dynatrace_connector(identifier: Optional[_builtins.str] = None,
...
def get_dynatrace_connector_output(identifier: Optional[pulumi.Input[_builtins.str]] = None,

...
class TemplateFiltersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the template filters.
...
class _TemplateFiltersState:
    def __init__(__self__, *,
                 filter_properties: pulumi.Input[Optional['TemplateFiltersFilterPropertiesArgs']] = None,
                 filter_visibility: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="filterProperties")
    def filter_properties(self) -> pulumi.Input[Optional['TemplateFiltersFilterPropertiesArgs']]:
        """
        Properties of the filters entity defined in Harness.
        """
        return pulumi.get(self, "filter_properties")
    ...
    @filter_properties.setter
    def filter_properties(self, value: pulumi.Input[Optional['TemplateFiltersFilterPropertiesArgs']]):
        pulumi.set(self, "filter_properties", value)
...
class TemplateFilters(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 filter_properties: pulumi.Input[Optional[Union['TemplateFiltersFilterPropertiesArgs', 'TemplateFiltersFilterPropertiesArgsDict', 'outputs.TemplateFiltersFilterProperties']]] = None,
                 filter_visibility: pulumi.Input[Optional[_builtins.str]] = None,
                 identifier: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 org_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Union['TemplateFiltersFilterPropertiesArgs', 'TemplateFiltersFilterPropertiesArgsDict', 'outputs.TemplateFiltersFilterProperties']] filter_properties: Properties of the filters entity defined in Harness.
        :param pulumi.Input[_builtins.str] filter_visibility: Only accept values "EveryOne" and "OnlyCreator". This indicates visibility of filters. By default, everyone can view this filter.
        :param pulumi.Input[_builtins.str] identifier: Unique identifier of the resource.
        :param pulumi.Input[_builtins.str] name: Name of the template filters.
        :param pulumi.Input[_builtins.str] org_id: Organization Identifier for the Entity.
    ...
    def get(resource_name: str,
            ...
            org_id: pulumi.Input[Optional[_builtins.str]] = None,
            project_id: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None) -> 'TemplateFilters':
        """

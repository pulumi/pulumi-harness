...
def get_azure_cloud_cost_connector(identifier: Optional[builtins.str] = None,
...
def get_azure_cloud_cost_connector_output(identifier: Optional[pulumi.Input[builtins.str]] = None,

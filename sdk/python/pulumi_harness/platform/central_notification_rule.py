...
class CentralNotificationRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 custom_notification_template_ref: pulumi.Input[Optional[Union['CentralNotificationRuleCustomNotificationTemplateRefArgs', 'CentralNotificationRuleCustomNotificationTemplateRefArgsDict', 'outputs.CentralNotificationRuleCustomNotificationTemplateRef']]] = None,
                 identifier: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 notification_channel_refs: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 notification_conditions: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CentralNotificationRuleNotificationConditionArgs', 'CentralNotificationRuleNotificationConditionArgsDict', 'outputs.CentralNotificationRuleNotificationCondition']]]]] = None,
                 org: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 status: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):

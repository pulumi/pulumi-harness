...
class GetGitopsAppProjectMappingResult:
    ...
    def argo_project_name(self) -> _builtins.str:
        """
...
def get_gitops_app_project_mapping(account_id: Optional[_builtins.str] = None,
                                   agent_id: Optional[_builtins.str] = None,
                                   argo_project_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str argo_project_name: ArgoCD Project name which is to be mapped to the Harness project.
    :param _builtins.str org_id: Organization identifier of the GitOps agent's Application Project.
    :param _builtins.str project_id: Project identifier of the GitOps agent's Application Project.
    """
    __args__ = dict()

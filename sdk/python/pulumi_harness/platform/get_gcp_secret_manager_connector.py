...
class GetGcpSecretManagerConnectorResult:
    ...
    def inherit_from_delegate(self) -> _builtins.bool:
        """
...
def get_gcp_secret_manager_connector(identifier: Optional[_builtins.str] = None,
...
def get_gcp_secret_manager_connector_output(identifier: Optional[pulumi.Input[_builtins.str]] = None,

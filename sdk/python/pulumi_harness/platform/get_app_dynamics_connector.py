...
def get_app_dynamics_connector(identifier: Optional[_builtins.str] = None,
...
def get_app_dynamics_connector_output(identifier: Optional[pulumi.Input[_builtins.str]] = None,

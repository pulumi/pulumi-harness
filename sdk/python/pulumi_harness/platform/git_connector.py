...
class GitConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_type: Whether the connection we're making is to a git repository or a git account. Valid values are Account, Repo.
        :param pulumi.Input['GitConnectorCredentialsArgs'] credentials: Credentials to use for the connection.
        :param pulumi.Input[builtins.str] identifier: Unique identifier of the resource.
        :param pulumi.Input[builtins.str] url: URL of the git repository or account.
...
class GitConnector(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            validation_repo: Optional[pulumi.Input[builtins.str]] = None) -> 'GitConnector':
        """

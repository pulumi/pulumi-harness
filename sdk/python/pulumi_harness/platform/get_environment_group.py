...
def get_environment_group(color: Optional[_builtins.str] = None,
    ...
    :param _builtins.str color: Color of the environment group.
    :param _builtins.str identifier: identifier of the environment group.
    :param _builtins.str org_id: org_id of the environment group.
    :param _builtins.str project_id: project_id of the environment group.
    """
    __args__ = dict()
...
def get_environment_group_output(color: Optional[pulumi.Input[Optional[_builtins.str]]] = None,

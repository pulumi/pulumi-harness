...
__all__ = [
    'GetTasConnectorResult',
    'AwaitableGetTasConnectorResult',
    'get_tas_connector',
    'get_tas_connector_output',
]

@pulumi.output_type
class GetTasConnectorResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def credentials(self) -> Sequence['outputs.GetTasConnectorCredentialResult']:
        """
...
class AwaitableGetTasConnectorResult(GetTasConnectorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetTasConnectorResult(
...
def get_tas_connector(identifier: Optional[_builtins.str] = None,
                      name: Optional[_builtins.str] = None,
                      org_id: Optional[_builtins.str] = None,
                      project_id: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTasConnectorResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('harness:platform/getTasConnector:getTasConnector', __args__, opts=opts, typ=GetTasConnectorResult).value

    return AwaitableGetTasConnectorResult(
...
def get_tas_connector_output(identifier: Optional[pulumi.Input[_builtins.str]] = None,
                             name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             org_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             project_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTasConnectorResult]:
    """
    Datasource for looking up an Tas Connector.
    ...
    __ret__ = pulumi.runtime.invoke_output('harness:platform/getTasConnector:getTasConnector', __args__, opts=opts, typ=GetTasConnectorResult)
    return __ret__.apply(lambda __response__: GetTasConnectorResult(

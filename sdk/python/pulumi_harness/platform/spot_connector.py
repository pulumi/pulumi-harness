...
class _SpotConnectorState:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 org_id: pulumi.Input[Optional[_builtins.str]] = None,
                 permanent_token: pulumi.Input[Optional['SpotConnectorPermanentTokenArgs']] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="permanentToken")
    def permanent_token(self) -> pulumi.Input[Optional['SpotConnectorPermanentTokenArgs']]:
        """
        Authenticate to Spot using account id and permanent token.
        """
        return pulumi.get(self, "permanent_token")
    ...
    @permanent_token.setter
    def permanent_token(self, value: pulumi.Input[Optional['SpotConnectorPermanentTokenArgs']]):
        pulumi.set(self, "permanent_token", value)

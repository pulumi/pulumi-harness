...
def get_elasticsearch_connector(identifier: Optional[builtins.str] = None,
...
def get_elasticsearch_connector_output(identifier: Optional[pulumi.Input[builtins.str]] = None,

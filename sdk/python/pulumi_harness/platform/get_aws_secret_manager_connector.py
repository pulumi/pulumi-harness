...
class GetAwsSecretManagerConnectorResult:
    ...
    def force_delete_without_recovery(self) -> Optional[_builtins.bool]:
        """
    ...
    def secret_name_prefix(self) -> _builtins.str:
        """
    ...
    def use_put_secret(self) -> _builtins.bool:
        """
...
def get_aws_secret_manager_connector(force_delete_without_recovery: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool force_delete_without_recovery: Whether to force delete secret value or not.

...
def get_infra_module_testing(module_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str provisioner_type: Provisioner type for testing purposes (e.g., terraform, tofu)
...
def get_infra_module_testing_output(module_id: pulumi.Input[Optional[_builtins.str]] = None,
                                    org: pulumi.Input[Optional[_builtins.str]] = None,
                                    pipelines: pulumi.Input[Optional[Sequence[_builtins.str]]] = None,

...
def get_bitbucket_connector(identifier: Optional[builtins.str] = None,
...
def get_bitbucket_connector_output(identifier: Optional[pulumi.Input[builtins.str]] = None,

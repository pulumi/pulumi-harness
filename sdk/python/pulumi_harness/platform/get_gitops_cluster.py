...
def get_gitops_cluster(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str account_id: Account identifier of the GitOps cluster.
    :param builtins.str agent_id: Agent identifier of the GitOps cluster.
    :param builtins.str identifier: Identifier of the GitOps cluster.
    :param builtins.str org_id: Organization identifier of the cluster.
    :param builtins.str project_id: Project identifier of the GitOps cluster.
    """
    __args__ = dict()
...
def get_gitops_cluster_output(account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,

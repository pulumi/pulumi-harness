...
def get_template_filters(identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str type: Type of filter. Currently supported types are {TemplateSetup, TemplateExecution, Deployment, Template, EnvironmentGroup, Environment}.
    """
    __args__ = dict()
...
def get_template_filters_output(identifier: Optional[pulumi.Input[builtins.str]] = None,

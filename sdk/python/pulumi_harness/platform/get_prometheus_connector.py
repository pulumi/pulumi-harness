...
def get_prometheus_connector(identifier: Optional[_builtins.str] = None,
...
def get_prometheus_connector_output(identifier: Optional[pulumi.Input[_builtins.str]] = None,

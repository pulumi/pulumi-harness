...
def get_pipeline_filters(identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str type: Type of filter. Currently supported types are {PipelineSetup, PipelineExecution, Deployment, Template, EnvironmentGroup, Environment}.
    """
    __args__ = dict()
...
def get_pipeline_filters_output(identifier: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('harness:platform/getPipelineFilters:getPipelineFilters', __args__, opts=opts, typ=GetPipelineFiltersResult)
    return __ret__.apply(lambda __response__: GetPipelineFiltersResult(

...
def get_pipeline_filters(identifier: Optional[_builtins.str] = None,
    ...
    :param _builtins.str type: Type of filter. Currently supported types are {PipelineSetup, PipelineExecution, Deployment, Template, EnvironmentGroup, Environment}.
    """
    __args__ = dict()

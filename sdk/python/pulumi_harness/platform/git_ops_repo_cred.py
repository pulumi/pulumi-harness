...
class GitOpsRepoCredArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] agent_id: Agent identifier of the Repository Credentials.
        :param pulumi.Input[builtins.str] identifier: Identifier of the Repository Credentials.
        :param pulumi.Input[builtins.str] account_id: Account identifier of the Repository Credentials.
        :param pulumi.Input[Sequence[pulumi.Input['GitOpsRepoCredCredArgs']]] creds: credential details.
        :param pulumi.Input[builtins.str] org_id: Organization identifier of the Repository Credentials.
        :param pulumi.Input[builtins.str] project_id: Project identifier of the Repository Credentials.
        :param pulumi.Input[builtins.bool] upsert: Indicates if the GitOps repository credential should be updated if existing and inserted if not.
        """
...
class GitOpsRepoCred(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            org_id: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            upsert: Optional[pulumi.Input[builtins.bool]] = None) -> 'GitOpsRepoCred':
        """

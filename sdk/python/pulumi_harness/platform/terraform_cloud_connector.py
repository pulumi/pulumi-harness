...
class TerraformCloudConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] execute_on_delegate: Enable this flag to execute on delegate (default: true).
...
class TerraformCloudConnector(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'TerraformCloudConnector':
        """
    ...
    @property
    @pulumi.getter(name="executeOnDelegate")
    def execute_on_delegate(self) -> pulumi.Output[builtins.bool]:
        """
        Enable this flag to execute on delegate (default: true).
        """
        return pulumi.get(self, "execute_on_delegate")

...
def get_artifactory_connector(identifier: Optional[builtins.str] = None,
...
def get_artifactory_connector_output(identifier: Optional[pulumi.Input[Optional[builtins.str]]] = None,

...
def get_terraform_cloud_connector(identifier: Optional[builtins.str] = None,
...
def get_terraform_cloud_connector_output(identifier: Optional[pulumi.Input[builtins.str]] = None,

...
class NewrelicConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] url: URL of the NewRelic server.
...
@pulumi.type_token("harness:platform/newrelicConnector:NewrelicConnector")
class NewrelicConnector(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: pulumi.Input[Optional[_builtins.str]] = None,
            tags: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            url: pulumi.Input[Optional[_builtins.str]] = None) -> 'NewrelicConnector':
        """

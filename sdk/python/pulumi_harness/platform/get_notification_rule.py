...
def get_notification_rule(identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str org_id: Identifier of the organization in which the Notification Rule is configured.
    :param builtins.str project_id: Identifier of the project in which the Notification Rule is configured.
    """
    __args__ = dict()
...
def get_notification_rule_output(identifier: Optional[pulumi.Input[builtins.str]] = None,

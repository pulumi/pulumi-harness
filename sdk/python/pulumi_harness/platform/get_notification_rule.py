...
def get_notification_rule(identifier: Optional[_builtins.str] = None,
    ...
    :param _builtins.str org_id: Identifier of the organization in which the Notification Rule is configured.
    :param _builtins.str project_id: Identifier of the project in which the Notification Rule is configured.
    """
    __args__ = dict()
...
def get_notification_rule_output(identifier: Optional[pulumi.Input[_builtins.str]] = None,

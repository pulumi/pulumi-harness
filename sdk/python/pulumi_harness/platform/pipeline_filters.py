...
class PipelineFiltersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Type of pipeline filters. Currently supported types are {PipelineSetup, PipelineExecution, Deployment, Template, EnvironmentGroup, Environment}
        ...
        :param pulumi.Input[_builtins.str] name: Name of the pipeline filters.
...
class _PipelineFiltersState:
    def __init__(__self__, *,
                 filter_properties: pulumi.Input[Optional['PipelineFiltersFilterPropertiesArgs']] = None,
                 filter_visibility: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="filterProperties")
    def filter_properties(self) -> pulumi.Input[Optional['PipelineFiltersFilterPropertiesArgs']]:
        """
        Properties of the filters entity defined in Harness.
        """
        return pulumi.get(self, "filter_properties")
    ...
    @filter_properties.setter
    def filter_properties(self, value: pulumi.Input[Optional['PipelineFiltersFilterPropertiesArgs']]):
        pulumi.set(self, "filter_properties", value)
...
class PipelineFilters(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 filter_properties: pulumi.Input[Optional[Union['PipelineFiltersFilterPropertiesArgs', 'PipelineFiltersFilterPropertiesArgsDict', 'outputs.PipelineFiltersFilterProperties']]] = None,
                 filter_visibility: pulumi.Input[Optional[_builtins.str]] = None,
                 identifier: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 org_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Union['PipelineFiltersFilterPropertiesArgs', 'PipelineFiltersFilterPropertiesArgsDict', 'outputs.PipelineFiltersFilterProperties']] filter_properties: Properties of the filters entity defined in Harness.
        :param pulumi.Input[_builtins.str] filter_visibility: This indicates visibility of filters. By default, everyone can view this filter.
        :param pulumi.Input[_builtins.str] identifier: Unique identifier of the resource.
        :param pulumi.Input[_builtins.str] name: Name of the pipeline filters.
        :param pulumi.Input[_builtins.str] org_id: Organization Identifier for the Entity.
    ...
    def get(resource_name: str,
            ...
            org_id: pulumi.Input[Optional[_builtins.str]] = None,
            project_id: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None) -> 'PipelineFilters':
        """

...
def get_pagerduty_connector(identifier: Optional[builtins.str] = None,
...
def get_pagerduty_connector_output(identifier: Optional[pulumi.Input[builtins.str]] = None,

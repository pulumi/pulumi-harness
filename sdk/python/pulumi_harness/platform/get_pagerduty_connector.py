...
def get_pagerduty_connector(identifier: Optional[_builtins.str] = None,
...
def get_pagerduty_connector_output(identifier: Optional[pulumi.Input[_builtins.str]] = None,

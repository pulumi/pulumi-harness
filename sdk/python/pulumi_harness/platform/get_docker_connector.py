...
__all__ = [
    'GetDockerConnectorResult',
    'AwaitableGetDockerConnectorResult',
    'get_docker_connector',
    'get_docker_connector_output',
]

@pulumi.output_type
class GetDockerConnectorResult:
    """
    A collection of values returned by getDockerConnector.
    """
    def __init__(__self__, credentials=None, delegate_selectors=None, description=None, id=None, identifier=None, name=None, org_id=None, project_id=None, tags=None, type=None, url=None):
    ...
    @_builtins.property
    @pulumi.getter
    def credentials(self) -> Sequence['outputs.GetDockerConnectorCredentialResult']:
        """
...
class AwaitableGetDockerConnectorResult(GetDockerConnectorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDockerConnectorResult(
...
def get_docker_connector(identifier: Optional[_builtins.str] = None,
                         name: Optional[_builtins.str] = None,
                         org_id: Optional[_builtins.str] = None,
                         project_id: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDockerConnectorResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('harness:platform/getDockerConnector:getDockerConnector', __args__, opts=opts, typ=GetDockerConnectorResult).value

    return AwaitableGetDockerConnectorResult(
...
def get_docker_connector_output(identifier: Optional[pulumi.Input[_builtins.str]] = None,

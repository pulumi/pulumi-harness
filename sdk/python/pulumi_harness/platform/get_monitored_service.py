...
def get_monitored_service(identifier: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project_id: Identifier of the project in which the monitored service is configured.
    """
    __args__ = dict()
...
def get_monitored_service_output(identifier: Optional[pulumi.Input[_builtins.str]] = None,

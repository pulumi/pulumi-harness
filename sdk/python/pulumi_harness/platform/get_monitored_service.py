...
def get_monitored_service(identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str identifier: Identifier of the monitored service.
    :param builtins.str org_id: Identifier of the organization in which the monitored service is configured.
    :param builtins.str project_id: Identifier of the project in which the monitored service is configured.
    """
    __args__ = dict()
...
def get_monitored_service_output(identifier: Optional[pulumi.Input[builtins.str]] = None,

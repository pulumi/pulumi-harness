...
def get_filters(identifier: Optional[_builtins.str] = None,
    ...
    :param _builtins.str type: Type of filter. Currently supported types are {Connector, DelegateProfile, Delegate, EnvironmentGroup, FileStore, Environment}.
    """
    __args__ = dict()
...
def get_filters_output(identifier: Optional[pulumi.Input[_builtins.str]] = None,

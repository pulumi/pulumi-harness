...
def get_roles(allowed_scope_levels: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] allowed_scope_levels: The scope levels at which this role can be used
    :param _builtins.str identifier: Unique identifier of the resource.
    :param _builtins.str name: Name of the resource.
    :param _builtins.str org_id: Unique identifier of the organization.
    :param Sequence[_builtins.str] permissions: List of the permission identifiers

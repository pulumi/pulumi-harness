...
def get_gitops_repo_cred(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str account_id: Account identifier of the Repository Credentials.
    :param builtins.str agent_id: Agent identifier of the Repository Credentials.
    :param Sequence[Union['GetGitopsRepoCredCredArgs', 'GetGitopsRepoCredCredArgsDict']] creds: credential details.
    :param builtins.str identifier: Identifier of the Repository Credentials.
    :param builtins.str org_id: Organization identifier of the Repository Credentials.
    :param builtins.str project_id: Project identifier of the Repository Credentials.
    """
    __args__ = dict()
...
def get_gitops_repo_cred_output(account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,

...
__all__ = ['FiltersArgs', 'Filters']

@pulumi.input_type
class FiltersArgs:
    def __init__(__self__, *,
                 filter_properties: pulumi.Input['FiltersFilterPropertiesArgs'],
    ...
    def filter_properties(self) -> pulumi.Input['FiltersFilterPropertiesArgs']:
        """
    ...
    def filter_properties(self, value: pulumi.Input['FiltersFilterPropertiesArgs']):
...
class _FiltersState:
    def __init__(__self__, *,
                 filter_properties: pulumi.Input[Optional['FiltersFilterPropertiesArgs']] = None,
                 filter_visibility: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="filterProperties")
    def filter_properties(self) -> pulumi.Input[Optional['FiltersFilterPropertiesArgs']]:
        """
        Properties of the filter entity defined in Harness.
        """
        return pulumi.get(self, "filter_properties")
    ...
    @filter_properties.setter
    def filter_properties(self, value: pulumi.Input[Optional['FiltersFilterPropertiesArgs']]):
        pulumi.set(self, "filter_properties", value)
...
class Filters(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 filter_properties: pulumi.Input[Optional[Union['FiltersFilterPropertiesArgs', 'FiltersFilterPropertiesArgsDict', 'outputs.FiltersFilterProperties']]] = None,
                 filter_visibility: pulumi.Input[Optional[_builtins.str]] = None,
                 identifier: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 org_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Union['FiltersFilterPropertiesArgs', 'FiltersFilterPropertiesArgsDict', 'outputs.FiltersFilterProperties']] filter_properties: Properties of the filter entity defined in Harness.
        :param pulumi.Input[_builtins.str] filter_visibility: This indicates visibility of filter. By default, everyone can view this filter. Can either be EveryOne or OnlyCreator
        :param pulumi.Input[_builtins.str] identifier: Unique identifier of the resource
        :param pulumi.Input[_builtins.str] name: Name of the Filter
        :param pulumi.Input[_builtins.str] org_id: organization Identifier for the Entity
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FiltersArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FiltersArgs.__new__(FiltersArgs)
        ...
        super(Filters, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            org_id: pulumi.Input[Optional[_builtins.str]] = None,
            project_id: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None) -> 'Filters':
        """
        ...
        __props__ = _FiltersState.__new__(_FiltersState)
        ...
        __props__.__dict__["project_id"] = project_id
        __props__.__dict__["type"] = type
        return Filters(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter(name="filterProperties")
    def filter_properties(self) -> pulumi.Output['outputs.FiltersFilterProperties']:
        """
        Properties of the filter entity defined in Harness.
        """
        return pulumi.get(self, "filter_properties")
    ...
    @_builtins.property
    @pulumi.getter(name="filterVisibility")
    def filter_visibility(self) -> pulumi.Output[_builtins.str]:
        """
        This indicates visibility of filter. By default, everyone can view this filter. Can either be EveryOne or OnlyCreator
        """
        return pulumi.get(self, "filter_visibility")

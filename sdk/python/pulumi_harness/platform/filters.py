...
class FiltersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Type of filter. Currently supported types are {Connector, DelegateProfile, Delegate, EnvironmentGroup, FileStore, Environment}
        :param pulumi.Input[builtins.str] filter_visibility: This indicates visibility of filter. By default, everyone can view this filter. Can either be EveryOne or OnlyCreator
...
class _FiltersState:
    def __init__(__self__, *,
                 filter_properties: Optional[pulumi.Input['FiltersFilterPropertiesArgs']] = None,
                 filter_visibility: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="filterProperties")
    def filter_properties(self) -> Optional[pulumi.Input['FiltersFilterPropertiesArgs']]:
        """
        Properties of the filter entity defined in Harness.
        """
        return pulumi.get(self, "filter_properties")
    ...
    @filter_properties.setter
    def filter_properties(self, value: Optional[pulumi.Input['FiltersFilterPropertiesArgs']]):
        pulumi.set(self, "filter_properties", value)
...
class Filters(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            org_id: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'Filters':
        """
    ...
    @property
    @pulumi.getter(name="filterVisibility")
    def filter_visibility(self) -> pulumi.Output[builtins.str]:
        """
        This indicates visibility of filter. By default, everyone can view this filter. Can either be EveryOne or OnlyCreator
        """
        return pulumi.get(self, "filter_visibility")

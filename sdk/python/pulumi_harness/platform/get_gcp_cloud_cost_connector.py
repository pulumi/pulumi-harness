...
def get_gcp_cloud_cost_connector(identifier: Optional[_builtins.str] = None,
...
def get_gcp_cloud_cost_connector_output(identifier: Optional[pulumi.Input[_builtins.str]] = None,

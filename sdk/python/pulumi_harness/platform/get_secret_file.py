...
class GetSecretFileResult:
    ...
    def secret_manager_identifier(self) -> builtins.str:
        """
...
def get_secret_file(identifier: Optional[builtins.str] = None,
...
def get_secret_file_output(identifier: Optional[pulumi.Input[builtins.str]] = None,

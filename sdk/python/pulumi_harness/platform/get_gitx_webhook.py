...
def get_gitx_webhook(description: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] tags: Tags to associate with the resource. These should match the tag value passed in the YAML; if this parameter is null or not passed, the tags specified in YAML should also be null.
    """
    __args__ = dict()
...
def get_gitx_webhook_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,

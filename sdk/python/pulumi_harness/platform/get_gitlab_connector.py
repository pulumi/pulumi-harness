...
__all__ = [
    ...
    'AwaitableGetGitlabConnectorResult',
    'get_gitlab_connector',
    'get_gitlab_connector_output',
]

@pulumi.output_type
class GetGitlabConnectorResult:
    """
    ...
    def api_authentications(self) -> Sequence['outputs.GetGitlabConnectorApiAuthenticationResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def credentials(self) -> Sequence['outputs.GetGitlabConnectorCredentialResult']:
        """
...
class AwaitableGetGitlabConnectorResult(GetGitlabConnectorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGitlabConnectorResult(
...
def get_gitlab_connector(identifier: Optional[_builtins.str] = None,
                         name: Optional[_builtins.str] = None,
                         org_id: Optional[_builtins.str] = None,
                         project_id: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGitlabConnectorResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('harness:platform/getGitlabConnector:getGitlabConnector', __args__, opts=opts, typ=GetGitlabConnectorResult).value

    return AwaitableGetGitlabConnectorResult(
...
def get_gitlab_connector_output(identifier: Optional[pulumi.Input[_builtins.str]] = None,

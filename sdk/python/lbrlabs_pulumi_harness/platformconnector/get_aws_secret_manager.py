...
__all__ = [
    'GetAwsSecretManagerResult',
    'AwaitableGetAwsSecretManagerResult',
    'get_aws_secret_manager',
    'get_aws_secret_manager_output',
]

@pulumi.output_type
class GetAwsSecretManagerResult:
    """
    ...
    @property
    @pulumi.getter
    def credentials(self) -> Sequence['outputs.GetAwsSecretManagerCredentialResult']:
        """
...
class AwaitableGetAwsSecretManagerResult(GetAwsSecretManagerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAwsSecretManagerResult(
...
def get_aws_secret_manager(identifier: Optional[str] = None,
                           name: Optional[str] = None,
                           org_id: Optional[str] = None,
                           project_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAwsSecretManagerResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('harness:PlatformConnector/getAwsSecretManager:getAwsSecretManager', __args__, opts=opts, typ=GetAwsSecretManagerResult).value

    return AwaitableGetAwsSecretManagerResult(
...
@_utilities.lift_output_func(get_aws_secret_manager)
def get_aws_secret_manager_output(identifier: Optional[pulumi.Input[Optional[str]]] = None,
                                  name: Optional[pulumi.Input[Optional[str]]] = None,
                                  org_id: Optional[pulumi.Input[Optional[str]]] = None,
                                  project_id: Optional[pulumi.Input[Optional[str]]] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAwsSecretManagerResult]:
    """
    Datasource for looking up an AWS Secret Manager connector.

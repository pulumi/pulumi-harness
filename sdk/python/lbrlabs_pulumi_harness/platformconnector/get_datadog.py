...
__all__ = [
    'GetDatadogResult',
    'AwaitableGetDatadogResult',
    'get_datadog',
    'get_datadog_output',
]

@pulumi.output_type
class GetDatadogResult:
    """
...
class AwaitableGetDatadogResult(GetDatadogResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatadogResult(
...
def get_datadog(delegate_selectors: Optional[Sequence[str]] = None,
                identifier: Optional[str] = None,
                name: Optional[str] = None,
                org_id: Optional[str] = None,
                project_id: Optional[str] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatadogResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('harness:PlatformConnector/getDatadog:getDatadog', __args__, opts=opts, typ=GetDatadogResult).value

    return AwaitableGetDatadogResult(
...
@_utilities.lift_output_func(get_datadog)
def get_datadog_output(delegate_selectors: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                       identifier: Optional[pulumi.Input[Optional[str]]] = None,
                       name: Optional[pulumi.Input[Optional[str]]] = None,
                       org_id: Optional[pulumi.Input[Optional[str]]] = None,
                       project_id: Optional[pulumi.Input[Optional[str]]] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDatadogResult]:
    """
    Datasource for looking up a Datadog connector.

...
class GetGitResult:
    ...
    @property
    @pulumi.getter
    def credentials(self) -> Sequence['outputs.GetGitCredentialResult']:
        """
...
def get_git(identifier: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('harness:PlatformConnector/getGit:getGit', __args__, opts=opts, typ=GetGitResult).value
...
@_utilities.lift_output_func(get_git)
def get_git_output(identifier: Optional[pulumi.Input[Optional[str]]] = None,
                   name: Optional[pulumi.Input[Optional[str]]] = None,
                   org_id: Optional[pulumi.Input[Optional[str]]] = None,
                   project_id: Optional[pulumi.Input[Optional[str]]] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetGitResult]:
    """
    Datasource for looking up a Git connector.

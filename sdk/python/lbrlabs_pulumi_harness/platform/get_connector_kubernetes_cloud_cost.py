...
__all__ = [
    'GetConnectorKubernetesCloudCostResult',
    'AwaitableGetConnectorKubernetesCloudCostResult',
    'get_connector_kubernetes_cloud_cost',
    'get_connector_kubernetes_cloud_cost_output',
]

@pulumi.output_type
class GetConnectorKubernetesCloudCostResult:
    """
...
class AwaitableGetConnectorKubernetesCloudCostResult(GetConnectorKubernetesCloudCostResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetConnectorKubernetesCloudCostResult(
...
def get_connector_kubernetes_cloud_cost(identifier: Optional[str] = None,
                                        name: Optional[str] = None,
                                        org_id: Optional[str] = None,
                                        project_id: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConnectorKubernetesCloudCostResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('harness:platform/getConnectorKubernetesCloudCost:getConnectorKubernetesCloudCost', __args__, opts=opts, typ=GetConnectorKubernetesCloudCostResult).value

    return AwaitableGetConnectorKubernetesCloudCostResult(
...
@_utilities.lift_output_func(get_connector_kubernetes_cloud_cost)
def get_connector_kubernetes_cloud_cost_output(identifier: Optional[pulumi.Input[str]] = None,
                                               name: Optional[pulumi.Input[Optional[str]]] = None,
                                               org_id: Optional[pulumi.Input[Optional[str]]] = None,
                                               project_id: Optional[pulumi.Input[Optional[str]]] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetConnectorKubernetesCloudCostResult]:
    """
    Datasource for looking up a Kubernetes Cloud Cost connector.

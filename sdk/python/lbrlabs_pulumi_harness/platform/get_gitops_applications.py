...
def get_gitops_applications(account_id: Optional[str] = None,
    ...
    return AwaitableGetGitopsApplicationsResult(
        ...
        kind=__ret__.kind,
        name=__ret__.name,
        options_remove_existing_finalizers=__ret__.options_remove_existing_finalizers,
        org_id=__ret__.org_id,
        project=__ret__.project,
        project_id=__ret__.project_id,
        query_project=__ret__.query_project,
        query_refresh=__ret__.query_refresh,
        query_repo=__ret__.query_repo,
        query_resource_version=__ret__.query_resource_version,
        query_selector=__ret__.query_selector,
        repo_id=__ret__.repo_id,
        request_cascade=__ret__.request_cascade,
        request_name=__ret__.request_name,
        request_propagation_policy=__ret__.request_propagation_policy,
        upsert=__ret__.upsert,

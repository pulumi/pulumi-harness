...
def get_policyset(action: Optional[str] = None,
...
@_utilities.lift_output_func(get_policyset)
def get_policyset_output(action: Optional[pulumi.Input[str]] = None,

...
def get_apikey(account_id: Optional[str] = None,
    ...
    return AwaitableGetApikeyResult(
        ...
        apikey_type=__ret__.apikey_type,
        default_time_to_expire_token=__ret__.default_time_to_expire_token,
...
@_utilities.lift_output_func(get_apikey)
def get_apikey_output(account_id: Optional[pulumi.Input[str]] = None,

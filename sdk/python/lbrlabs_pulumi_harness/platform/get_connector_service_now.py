...
__all__ = [
    'GetConnectorServiceNowResult',
    'AwaitableGetConnectorServiceNowResult',
    'get_connector_service_now',
    'get_connector_service_now_output',
]

@pulumi.output_type
class GetConnectorServiceNowResult:
    """
    ...
    @property
    @pulumi.getter
    def auths(self) -> Sequence['outputs.GetConnectorServiceNowAuthResult']:
        """
...
class AwaitableGetConnectorServiceNowResult(GetConnectorServiceNowResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetConnectorServiceNowResult(
            auths=self.auths,
...
def get_connector_service_now(identifier: Optional[str] = None,
                              name: Optional[str] = None,
                              org_id: Optional[str] = None,
                              project_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConnectorServiceNowResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('harness:platform/getConnectorServiceNow:getConnectorServiceNow', __args__, opts=opts, typ=GetConnectorServiceNowResult).value

    return AwaitableGetConnectorServiceNowResult(
        auths=__ret__.auths,
        ...
        service_now_url=__ret__.service_now_url,
        tags=__ret__.tags,
        username=__ret__.username,
        username_ref=__ret__.username_ref)


@_utilities.lift_output_func(get_connector_service_now)
def get_connector_service_now_output(identifier: Optional[pulumi.Input[str]] = None,
                                     name: Optional[pulumi.Input[Optional[str]]] = None,
                                     org_id: Optional[pulumi.Input[Optional[str]]] = None,
                                     project_id: Optional[pulumi.Input[Optional[str]]] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetConnectorServiceNowResult]:
    """
    Datasource for looking up a Service Now connector.

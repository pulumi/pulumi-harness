...
__all__ = ['ConnectorTasArgs', 'ConnectorTas']

@pulumi.input_type
class ConnectorTasArgs:
    def __init__(__self__, *,
                 credentials: pulumi.Input['ConnectorTasCredentialsArgs'],
        ...
        :param pulumi.Input['ConnectorTasCredentialsArgs'] credentials: Contains Tas connector credentials.
    ...
    @property
    @pulumi.getter
    def credentials(self) -> pulumi.Input['ConnectorTasCredentialsArgs']:
        """
    ...
    @credentials.setter
    def credentials(self, value: pulumi.Input['ConnectorTasCredentialsArgs']):
...
@pulumi.input_type
class _ConnectorTasState:
    def __init__(__self__, *,
                 credentials: Optional[pulumi.Input['ConnectorTasCredentialsArgs']] = None,
                 delegate_selectors: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 execute_on_delegate: Optional[pulumi.Input[bool]] = None,
    ...
    @property
    @pulumi.getter
    def credentials(self) -> Optional[pulumi.Input['ConnectorTasCredentialsArgs']]:
        """
        Contains Tas connector credentials.
        """
        return pulumi.get(self, "credentials")
    ...
    @credentials.setter
    def credentials(self, value: Optional[pulumi.Input['ConnectorTasCredentialsArgs']]):
        pulumi.set(self, "credentials", value)
...
class ConnectorTas(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 credentials: Optional[pulumi.Input[pulumi.InputType['ConnectorTasCredentialsArgs']]] = None,
                 delegate_selectors: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 execute_on_delegate: Optional[pulumi.Input[bool]] = None,
                 identifier: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['ConnectorTasCredentialsArgs']] credentials: Contains Tas connector credentials.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] delegate_selectors: Tags to filter delegates for connection.
        :param pulumi.Input[str] description: Description of the resource.
        :param pulumi.Input[bool] execute_on_delegate: Execute on delegate or not.
        :param pulumi.Input[str] identifier: Unique identifier of the resource.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ConnectorTasArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ConnectorTasArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ConnectorTasArgs.__new__(ConnectorTasArgs)
        ...
        super(ConnectorTas, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            org_id: Optional[pulumi.Input[str]] = None,
            project_id: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'ConnectorTas':
        """
        ...
        __props__ = _ConnectorTasState.__new__(_ConnectorTasState)
        ...
        __props__.__dict__["project_id"] = project_id
        __props__.__dict__["tags"] = tags
        return ConnectorTas(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def credentials(self) -> pulumi.Output['outputs.ConnectorTasCredentials']:
        """
        Contains Tas connector credentials.
        """
        return pulumi.get(self, "credentials")

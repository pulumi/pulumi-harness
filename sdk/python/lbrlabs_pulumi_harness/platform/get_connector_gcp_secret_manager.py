...
__all__ = [
    'GetConnectorGcpSecretManagerResult',
    'AwaitableGetConnectorGcpSecretManagerResult',
    'get_connector_gcp_secret_manager',
    'get_connector_gcp_secret_manager_output',
]

@pulumi.output_type
class GetConnectorGcpSecretManagerResult:
    """
...
class AwaitableGetConnectorGcpSecretManagerResult(GetConnectorGcpSecretManagerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetConnectorGcpSecretManagerResult(
...
def get_connector_gcp_secret_manager(identifier: Optional[str] = None,
                                     name: Optional[str] = None,
                                     org_id: Optional[str] = None,
                                     project_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConnectorGcpSecretManagerResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('harness:platform/getConnectorGcpSecretManager:getConnectorGcpSecretManager', __args__, opts=opts, typ=GetConnectorGcpSecretManagerResult).value

    return AwaitableGetConnectorGcpSecretManagerResult(
        credentials_ref=__ret__.credentials_ref,
...
@_utilities.lift_output_func(get_connector_gcp_secret_manager)
def get_connector_gcp_secret_manager_output(identifier: Optional[pulumi.Input[str]] = None,
                                            name: Optional[pulumi.Input[Optional[str]]] = None,
                                            org_id: Optional[pulumi.Input[Optional[str]]] = None,
                                            project_id: Optional[pulumi.Input[Optional[str]]] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetConnectorGcpSecretManagerResult]:
    """
    Datasource for looking up GCP Secret Manager connector.

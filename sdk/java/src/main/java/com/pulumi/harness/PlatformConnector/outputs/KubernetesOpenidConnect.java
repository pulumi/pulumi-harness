...
@CustomType
public final class KubernetesOpenidConnect {
    /**
    ...
    private KubernetesOpenidConnect() {}
    /**
     * @return Reference to the secret containing the client ID for the connector.
     * 
     */
    ...
    public static Builder builder(KubernetesOpenidConnect defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(KubernetesOpenidConnect defaults) {
        ...
        public KubernetesOpenidConnect build() {
            final var o = new KubernetesOpenidConnect();

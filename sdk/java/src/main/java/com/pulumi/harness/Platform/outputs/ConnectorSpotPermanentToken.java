...
@CustomType
public final class ConnectorSpotPermanentToken {
    /**
    ...
    private ConnectorSpotPermanentToken() {}
    /**
     * @return Reference to the Harness secret containing the permanent api token. To reference a secret at the organization scope, prefix &#39;org&#39; to the expression: org.{identifier}. To reference a secret at the account scope, prefix &#39;account` to the expression: account.{identifier}.
     * 
     */
    ...
    public static Builder builder(ConnectorSpotPermanentToken defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String spotAccountIdRef;
        public Builder() {}
        public Builder(ConnectorSpotPermanentToken defaults) {
        ...
        public ConnectorSpotPermanentToken build() {
            final var o = new ConnectorSpotPermanentToken();

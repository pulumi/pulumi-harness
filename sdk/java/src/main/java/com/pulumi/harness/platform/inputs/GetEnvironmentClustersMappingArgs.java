...
public final class GetEnvironmentClustersMappingArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetEnvironmentClustersMappingArgs build() {
            if ($.envId == null) {
                throw new MissingRequiredPropertyException("GetEnvironmentClustersMappingArgs", "envId");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("GetEnvironmentClustersMappingArgs", "identifier");
            }
            return $;
        }
    }

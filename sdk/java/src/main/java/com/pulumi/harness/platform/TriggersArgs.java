...
public final class TriggersArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public TriggersArgs build() {
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("TriggersArgs", "identifier");
            }
            if ($.orgId == null) {
                throw new MissingRequiredPropertyException("TriggersArgs", "orgId");
            }
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("TriggersArgs", "projectId");
            }
            if ($.targetId == null) {
                throw new MissingRequiredPropertyException("TriggersArgs", "targetId");
            }
            if ($.yaml == null) {
                throw new MissingRequiredPropertyException("TriggersArgs", "yaml");
            }
            return $;
        }
    }

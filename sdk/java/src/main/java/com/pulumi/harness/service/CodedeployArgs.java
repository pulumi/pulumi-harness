...
public final class CodedeployArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CodedeployArgs(CodedeployArgs $) {
        this.appId = $.appId;
    ...
    public static Builder builder(CodedeployArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CodedeployArgs defaults) {
            $ = new CodedeployArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CodedeployArgs build() {
            if ($.appId == null) {
                throw new MissingRequiredPropertyException("CodedeployArgs", "appId");
            }
            return $;
        }
    }

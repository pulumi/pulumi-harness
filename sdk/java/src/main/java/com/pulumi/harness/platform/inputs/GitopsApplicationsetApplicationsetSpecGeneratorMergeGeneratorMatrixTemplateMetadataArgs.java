...
public final class GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorMatrixTemplateMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorMatrixTemplateMetadataArgs Empty = new GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorMatrixTemplateMetadataArgs();
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorMatrixTemplateMetadataArgs() {}

    private GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorMatrixTemplateMetadataArgs(GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorMatrixTemplateMetadataArgs $) {
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorMatrixTemplateMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorMatrixTemplateMetadataArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorMatrixTemplateMetadataArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorMatrixTemplateMetadataArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorMatrixTemplateMetadataArgs build() {
            return $;
        }
    }

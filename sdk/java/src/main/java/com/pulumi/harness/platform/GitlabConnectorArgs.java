...
public final class GitlabConnectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitlabConnectorArgs Empty = new GitlabConnectorArgs();
    ...
    private Output<GitlabConnectorCredentialsArgs> credentials;

    /**
     * @return Credentials to use for the connection.
     * 
     */
    public Output<GitlabConnectorCredentialsArgs> credentials() {
    ...
    private GitlabConnectorArgs() {}

    private GitlabConnectorArgs(GitlabConnectorArgs $) {
    ...
    public static Builder builder(GitlabConnectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitlabConnectorArgs();
        }

        public Builder(GitlabConnectorArgs defaults) {
            $ = new GitlabConnectorArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder credentials(Output<GitlabConnectorCredentialsArgs> credentials) {
        ...
        public GitlabConnectorArgs build() {
            if ($.connectionType == null) {
                throw new MissingRequiredPropertyException("GitlabConnectorArgs", "connectionType");
            }
            if ($.credentials == null) {
                throw new MissingRequiredPropertyException("GitlabConnectorArgs", "credentials");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("GitlabConnectorArgs", "identifier");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GitlabConnectorArgs", "url");
            }
            return $;
        }
    }

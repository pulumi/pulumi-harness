...
import com.pulumi.harness.platform.inputs.ConnectorAzureRepoApiAuthenticationArgs;
import com.pulumi.harness.platform.inputs.ConnectorAzureRepoCredentialsArgs;
...
public final class ConnectorAzureRepoArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConnectorAzureRepoArgs Empty = new ConnectorAzureRepoArgs();
    ...
    private Output<ConnectorAzureRepoCredentialsArgs> credentials;

    /**
     * @return Credentials to use for the connection.
     * 
     */
    public Output<ConnectorAzureRepoCredentialsArgs> credentials() {
    ...
    private ConnectorAzureRepoArgs() {}

    private ConnectorAzureRepoArgs(ConnectorAzureRepoArgs $) {
    ...
    public static Builder builder(ConnectorAzureRepoArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectorAzureRepoArgs();
        }

        public Builder(ConnectorAzureRepoArgs defaults) {
            $ = new ConnectorAzureRepoArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder apiAuthentication(@Nullable Output<ConnectorAzureRepoApiAuthenticationArgs> apiAuthentication) {
         ...
         * 
         */
        public Builder apiAuthentication(ConnectorAzureRepoApiAuthenticationArgs apiAuthentication) {
            return apiAuthentication(Output.of(apiAuthentication));
        }

        /**
         * @param connectionType Whether the connection we&#39;re making is to a azure repository or a azure account. Valid values are Project, Repo.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder credentials(Output<ConnectorAzureRepoCredentialsArgs> credentials) {
         ...
         * 
         */
        public Builder credentials(ConnectorAzureRepoCredentialsArgs credentials) {
        ...
        /**
         * @param url URL of the azure repository or account.
         * 
         * @return builder
         * 
         */
        ...
        public ConnectorAzureRepoArgs build() {
            if ($.connectionType == null) {
                throw new MissingRequiredPropertyException("ConnectorAzureRepoArgs", "connectionType");
            }
            if ($.credentials == null) {
                throw new MissingRequiredPropertyException("ConnectorAzureRepoArgs", "credentials");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("ConnectorAzureRepoArgs", "identifier");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("ConnectorAzureRepoArgs", "url");
            }
            return $;
        }
    }

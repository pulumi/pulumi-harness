...
@CustomType
public final class RuleRdsDepend {
    /**
    ...
    public static Builder builder(RuleRdsDepend defaults) {
    ...
    public static final class Builder {
        ...
        private Integer ruleId;
        public Builder() {}
        public Builder(RuleRdsDepend defaults) {
        ...
        public Builder ruleId(Integer ruleId) {
            if (ruleId == null) {
              throw new MissingRequiredPropertyException("RuleRdsDepend", "ruleId");
            }
            this.ruleId = ruleId;
            return this;
        }
        public RuleRdsDepend build() {
            final var _resultValue = new RuleRdsDepend();

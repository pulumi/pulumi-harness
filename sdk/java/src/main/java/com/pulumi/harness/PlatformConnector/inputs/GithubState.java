...
public final class GithubState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<GithubCredentialsArgs> credentials;

    /**
     * @return Credentials to use for the connection.
     * 
     */
    public Optional<Output<GithubCredentialsArgs>> credentials() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder credentials(@Nullable Output<GithubCredentialsArgs> credentials) {

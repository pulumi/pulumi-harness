...
public final class InfraModuleTestingArgs extends com.pulumi.resources.ResourceArgs {

    public static final InfraModuleTestingArgs Empty = new InfraModuleTestingArgs();
    ...
    private InfraModuleTestingArgs() {}

    private InfraModuleTestingArgs(InfraModuleTestingArgs $) {
    ...
    public static Builder builder(InfraModuleTestingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InfraModuleTestingArgs();
        }

        public Builder(InfraModuleTestingArgs defaults) {
            $ = new InfraModuleTestingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InfraModuleTestingArgs build() {
            if ($.moduleId == null) {
                throw new MissingRequiredPropertyException("InfraModuleTestingArgs", "moduleId");
            }
            if ($.org == null) {
                throw new MissingRequiredPropertyException("InfraModuleTestingArgs", "org");
            }
            if ($.pipelines == null) {
                throw new MissingRequiredPropertyException("InfraModuleTestingArgs", "pipelines");
            }
            if ($.project == null) {
                throw new MissingRequiredPropertyException("InfraModuleTestingArgs", "project");
            }
            if ($.providerConnector == null) {
                throw new MissingRequiredPropertyException("InfraModuleTestingArgs", "providerConnector");
            }
            if ($.provisionerType == null) {
                throw new MissingRequiredPropertyException("InfraModuleTestingArgs", "provisionerType");
            }
            if ($.provisionerVersion == null) {
                throw new MissingRequiredPropertyException("InfraModuleTestingArgs", "provisionerVersion");
            }
            return $;
        }
    }

...
public final class GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorPullRequestTemplateMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorPullRequestTemplateMetadataArgs Empty = new GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorPullRequestTemplateMetadataArgs();
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorPullRequestTemplateMetadataArgs() {}

    private GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorPullRequestTemplateMetadataArgs(GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorPullRequestTemplateMetadataArgs $) {
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorPullRequestTemplateMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorPullRequestTemplateMetadataArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorPullRequestTemplateMetadataArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorPullRequestTemplateMetadataArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorPullRequestTemplateMetadataArgs build() {
            return $;
        }
    }

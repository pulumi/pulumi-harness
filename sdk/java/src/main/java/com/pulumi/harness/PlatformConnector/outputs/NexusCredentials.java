...
@CustomType
public final class NexusCredentials {
    /**
    ...
    public static Builder builder(NexusCredentials defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(NexusCredentials defaults) {
        ...
        public NexusCredentials build() {
            final var o = new NexusCredentials();

...
public final class GetOverridesGitDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetOverridesGitDetailsArgs Empty = new GetOverridesGitDetailsArgs();
    ...
    private GetOverridesGitDetailsArgs() {}

    private GetOverridesGitDetailsArgs(GetOverridesGitDetailsArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(GetOverridesGitDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOverridesGitDetailsArgs();
        }

        public Builder(GetOverridesGitDetailsArgs defaults) {
            $ = new GetOverridesGitDetailsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOverridesGitDetailsArgs build() {
            if ($.branch == null) {
                throw new MissingRequiredPropertyException("GetOverridesGitDetailsArgs", "branch");
            }
            if ($.loadFromCache == null) {
                throw new MissingRequiredPropertyException("GetOverridesGitDetailsArgs", "loadFromCache");
            }
            if ($.loadFromFallbackBranch == null) {
                throw new MissingRequiredPropertyException("GetOverridesGitDetailsArgs", "loadFromFallbackBranch");
            }
            if ($.repoName == null) {
                throw new MissingRequiredPropertyException("GetOverridesGitDetailsArgs", "repoName");
            }
            return $;
        }
    }

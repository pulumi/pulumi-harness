...
public final class GetInfraModuleTestingMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetInfraModuleTestingMetadataArgs Empty = new GetInfraModuleTestingMetadataArgs();
    ...
    private GetInfraModuleTestingMetadataArgs() {}
    ...
    public static Builder builder(GetInfraModuleTestingMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetInfraModuleTestingMetadataArgs();
        }

        public Builder(GetInfraModuleTestingMetadataArgs defaults) {
            $ = new GetInfraModuleTestingMetadataArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetInfraModuleTestingMetadataArgs build() {
            if ($.account == null) {
            ...
            if ($.provisionerType == null) {
                throw new MissingRequiredPropertyException("GetInfraModuleTestingMetadataArgs", "provisionerType");
            }
            if ($.provisionerVersion == null) {
                throw new MissingRequiredPropertyException("GetInfraModuleTestingMetadataArgs", "provisionerVersion");
            }
            if ($.releasePipeline == null) {
                throw new MissingRequiredPropertyException("GetInfraModuleTestingMetadataArgs", "releasePipeline");
            }
            return $;
        }
    }

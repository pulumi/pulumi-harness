...
public final class GetRuleScaleGroupHttpHealthArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRuleScaleGroupHttpHealthArgs Empty = new GetRuleScaleGroupHttpHealthArgs();
    ...
    private GetRuleScaleGroupHttpHealthArgs() {}

    private GetRuleScaleGroupHttpHealthArgs(GetRuleScaleGroupHttpHealthArgs $) {
        this.path = $.path;
        this.port = $.port;
    ...
    public static Builder builder(GetRuleScaleGroupHttpHealthArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRuleScaleGroupHttpHealthArgs();
        }

        public Builder(GetRuleScaleGroupHttpHealthArgs defaults) {
            $ = new GetRuleScaleGroupHttpHealthArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRuleScaleGroupHttpHealthArgs build() {
            if ($.port == null) {
                throw new MissingRequiredPropertyException("GetRuleScaleGroupHttpHealthArgs", "port");
            }
            if ($.protocol == null) {
                throw new MissingRequiredPropertyException("GetRuleScaleGroupHttpHealthArgs", "protocol");
            }
            return $;
        }
    }

...
public final class NewrelicConnectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final NewrelicConnectorArgs Empty = new NewrelicConnectorArgs();
    ...
    private NewrelicConnectorArgs() {}

    private NewrelicConnectorArgs(NewrelicConnectorArgs $) {
    ...
    public static Builder builder(NewrelicConnectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NewrelicConnectorArgs();
        }

        public Builder(NewrelicConnectorArgs defaults) {
            $ = new NewrelicConnectorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NewrelicConnectorArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("NewrelicConnectorArgs", "accountId");
            }
            if ($.apiKeyRef == null) {
                throw new MissingRequiredPropertyException("NewrelicConnectorArgs", "apiKeyRef");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("NewrelicConnectorArgs", "identifier");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("NewrelicConnectorArgs", "url");
            }
            return $;
        }
    }

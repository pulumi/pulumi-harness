...
import com.pulumi.harness.PlatformConnector.inputs.BitbucketApiAuthenticationArgs;
import com.pulumi.harness.PlatformConnector.inputs.BitbucketCredentialsArgs;
...
public final class BitbucketState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<BitbucketApiAuthenticationArgs> apiAuthentication;
     ...
     * 
     */
    public Optional<Output<BitbucketApiAuthenticationArgs>> apiAuthentication() {
    ...
    private @Nullable Output<BitbucketCredentialsArgs> credentials;

    /**
     * @return Credentials to use for the connection.
     * 
     */
    public Optional<Output<BitbucketCredentialsArgs>> credentials() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder apiAuthentication(@Nullable Output<BitbucketApiAuthenticationArgs> apiAuthentication) {
         ...
         * 
         */
        public Builder apiAuthentication(BitbucketApiAuthenticationArgs apiAuthentication) {
         ...
         * 
         */
        public Builder credentials(@Nullable Output<BitbucketCredentialsArgs> credentials) {
         ...
         * 
         */
        public Builder credentials(BitbucketCredentialsArgs credentials) {

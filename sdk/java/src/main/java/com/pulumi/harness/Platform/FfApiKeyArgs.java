...
public final class FfApiKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final FfApiKeyArgs Empty = new FfApiKeyArgs();
    ...
    private FfApiKeyArgs() {}

    private FfApiKeyArgs(FfApiKeyArgs $) {
    ...
    public static Builder builder(FfApiKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FfApiKeyArgs defaults) {
            $ = new FfApiKeyArgs(Objects.requireNonNull(defaults));
        }

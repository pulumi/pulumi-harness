...
public final class EnvironmentServiceOverridesArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public EnvironmentServiceOverridesArgs build() {
            if ($.envId == null) {
                throw new MissingRequiredPropertyException("EnvironmentServiceOverridesArgs", "envId");
            }
            if ($.serviceId == null) {
                throw new MissingRequiredPropertyException("EnvironmentServiceOverridesArgs", "serviceId");
            }
            if ($.yaml == null) {
                throw new MissingRequiredPropertyException("EnvironmentServiceOverridesArgs", "yaml");
            }
            return $;
        }
    }

...
public final class SecurityGovernanceConditionV3Args extends com.pulumi.resources.ResourceArgs {

    public static final SecurityGovernanceConditionV3Args Empty = new SecurityGovernanceConditionV3Args();
    ...
    private Output<SecurityGovernanceConditionV3FaultSpecArgs> faultSpec;

    /**
     * @return Specification for faults to be included in the condition
     * 
     */
    public Output<SecurityGovernanceConditionV3FaultSpecArgs> faultSpec() {
     ...
     */
    @Import(name="k8sSpec")
    private @Nullable Output<SecurityGovernanceConditionV3K8sSpecArgs> k8sSpec;

    /**
     * @return Kubernetes specific configuration (required when infra*type is Kubernetes or KubernetesV2)
     * 
     */
    public Optional<Output<SecurityGovernanceConditionV3K8sSpecArgs>> k8sSpec() {
    ...
    private @Nullable Output<SecurityGovernanceConditionV3MachineSpecArgs> machineSpec;

    /**
     * @return Machine specific configuration (required when infra*type is Linux or Windows)
     * 
     */
    public Optional<Output<SecurityGovernanceConditionV3MachineSpecArgs>> machineSpec() {
    ...
    private SecurityGovernanceConditionV3Args() {}

    private SecurityGovernanceConditionV3Args(SecurityGovernanceConditionV3Args $) {
    ...
    public static Builder builder(SecurityGovernanceConditionV3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecurityGovernanceConditionV3Args();
        }

        public Builder(SecurityGovernanceConditionV3Args defaults) {
            $ = new SecurityGovernanceConditionV3Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder faultSpec(Output<SecurityGovernanceConditionV3FaultSpecArgs> faultSpec) {
            $.faultSpec = faultSpec;
            return this;
        }
         ...
         * 
         */
        public Builder faultSpec(SecurityGovernanceConditionV3FaultSpecArgs faultSpec) {
         ...
         * 
         */
        public Builder k8sSpec(@Nullable Output<SecurityGovernanceConditionV3K8sSpecArgs> k8sSpec) {
            $.k8sSpec = k8sSpec;
            return this;
        }
         ...
         * 
         */
        public Builder k8sSpec(SecurityGovernanceConditionV3K8sSpecArgs k8sSpec) {
         ...
         * 
         */
        public Builder machineSpec(@Nullable Output<SecurityGovernanceConditionV3MachineSpecArgs> machineSpec) {
         ...
         * 
         */
        public Builder machineSpec(SecurityGovernanceConditionV3MachineSpecArgs machineSpec) {
        ...
        public SecurityGovernanceConditionV3Args build() {
            if ($.faultSpec == null) {
                throw new MissingRequiredPropertyException("SecurityGovernanceConditionV3Args", "faultSpec");
            }
            if ($.infraType == null) {
                throw new MissingRequiredPropertyException("SecurityGovernanceConditionV3Args", "infraType");
            }
            if ($.orgId == null) {
                throw new MissingRequiredPropertyException("SecurityGovernanceConditionV3Args", "orgId");
            }
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("SecurityGovernanceConditionV3Args", "projectId");
            }
            return $;
        }
    }

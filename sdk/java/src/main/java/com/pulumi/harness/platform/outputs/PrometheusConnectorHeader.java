...
public final class PrometheusConnectorHeader {
    ...
    public static Builder builder(PrometheusConnectorHeader defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean valueEncrypted;
        public Builder() {}
        public Builder(PrometheusConnectorHeader defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("PrometheusConnectorHeader", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public PrometheusConnectorHeader build() {
            final var _resultValue = new PrometheusConnectorHeader();

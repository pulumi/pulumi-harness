...
@CustomType
public final class EnvironmentGitDetails {
    /**
    ...
    public static Builder builder(EnvironmentGitDetails defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String storeType;
        public Builder() {}
        public Builder(EnvironmentGitDetails defaults) {
        ...
        public EnvironmentGitDetails build() {
            final var _resultValue = new EnvironmentGitDetails();

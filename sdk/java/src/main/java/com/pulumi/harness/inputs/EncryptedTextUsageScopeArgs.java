...
public final class EncryptedTextUsageScopeArgs extends com.pulumi.resources.ResourceArgs {

    public static final EncryptedTextUsageScopeArgs Empty = new EncryptedTextUsageScopeArgs();
    ...
    private EncryptedTextUsageScopeArgs() {}

    private EncryptedTextUsageScopeArgs(EncryptedTextUsageScopeArgs $) {
    ...
    public static Builder builder(EncryptedTextUsageScopeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EncryptedTextUsageScopeArgs();
        }

        public Builder(EncryptedTextUsageScopeArgs defaults) {
            $ = new EncryptedTextUsageScopeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EncryptedTextUsageScopeArgs build() {
            return $;
        }
    }

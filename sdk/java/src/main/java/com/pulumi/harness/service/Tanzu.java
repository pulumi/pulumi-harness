...
public class Tanzu extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="variables", refs={List.class,TanzuVariable.class}, tree="[0,1]")
    ...
    public Tanzu(java.lang.String name, TanzuArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:service/tanzu:Tanzu", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Tanzu(java.lang.String name, Output<java.lang.String> id, @Nullable TanzuState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:service/tanzu:Tanzu", name, state, makeResourceOptions(options, id), false);
    }

...
public class GitopsAppProjectMapping extends com.pulumi.resources.CustomResource {
     ...
     */
    public GitopsAppProjectMapping(String name) {
     ...
     */
    public GitopsAppProjectMapping(String name, GitopsAppProjectMappingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/gitopsAppProjectMapping:GitopsAppProjectMapping", name, args == null ? GitopsAppProjectMappingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private GitopsAppProjectMapping(String name, Output<String> id, @Nullable GitopsAppProjectMappingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/gitopsAppProjectMapping:GitopsAppProjectMapping", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static GitopsAppProjectMapping get(String name, Output<String> id, @Nullable GitopsAppProjectMappingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

...
@CustomType
public final class ConnectorAzureRepoCredentialsSsh {
    /**
    ...
    private ConnectorAzureRepoCredentialsSsh() {}
    /**
     * @return Reference to the Harness secret containing the ssh key. To reference a secret at the organization scope, prefix &#39;org&#39; to the expression: org.{identifier}. To reference a secret at the account scope, prefix &#39;account` to the expression: account.{identifier}.
     * 
     */
    ...
    public static Builder builder(ConnectorAzureRepoCredentialsSsh defaults) {
    ...
    public static final class Builder {
        private String sshKeyRef;
        public Builder() {}
        public Builder(ConnectorAzureRepoCredentialsSsh defaults) {
        ...
        public Builder sshKeyRef(String sshKeyRef) {
            if (sshKeyRef == null) {
              throw new MissingRequiredPropertyException("ConnectorAzureRepoCredentialsSsh", "sshKeyRef");
            }
            this.sshKeyRef = sshKeyRef;
            return this;
        }
        public ConnectorAzureRepoCredentialsSsh build() {
            final var _resultValue = new ConnectorAzureRepoCredentialsSsh();

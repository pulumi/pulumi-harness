...
public final class RuleScaleGroupHttpHealthArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleScaleGroupHttpHealthArgs Empty = new RuleScaleGroupHttpHealthArgs();
    ...
    private RuleScaleGroupHttpHealthArgs() {}

    private RuleScaleGroupHttpHealthArgs(RuleScaleGroupHttpHealthArgs $) {
        this.path = $.path;
        this.port = $.port;
    ...
    public static Builder builder(RuleScaleGroupHttpHealthArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleScaleGroupHttpHealthArgs();
        }

        public Builder(RuleScaleGroupHttpHealthArgs defaults) {
            $ = new RuleScaleGroupHttpHealthArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RuleScaleGroupHttpHealthArgs build() {
            if ($.port == null) {
                throw new MissingRequiredPropertyException("RuleScaleGroupHttpHealthArgs", "port");
            }
            if ($.protocol == null) {
                throw new MissingRequiredPropertyException("RuleScaleGroupHttpHealthArgs", "protocol");
            }
            return $;
        }
    }

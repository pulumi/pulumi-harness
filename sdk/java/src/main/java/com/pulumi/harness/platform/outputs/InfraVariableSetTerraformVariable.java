...
public final class InfraVariableSetTerraformVariable {
    ...
    public static Builder builder(InfraVariableSetTerraformVariable defaults) {
    ...
    public static final class Builder {
        ...
        private String valueType;
        public Builder() {}
        public Builder(InfraVariableSetTerraformVariable defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("InfraVariableSetTerraformVariable", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("InfraVariableSetTerraformVariable", "value");
            }
            this.value = value;
            return this;
        }
        ...
        public Builder valueType(String valueType) {
            if (valueType == null) {
              throw new MissingRequiredPropertyException("InfraVariableSetTerraformVariable", "valueType");
            }
            this.valueType = valueType;
            return this;
        }
        public InfraVariableSetTerraformVariable build() {
            final var _resultValue = new InfraVariableSetTerraformVariable();

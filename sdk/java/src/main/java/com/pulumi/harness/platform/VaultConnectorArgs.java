...
public final class VaultConnectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final VaultConnectorArgs Empty = new VaultConnectorArgs();
     ...
     * 
     */
    @Import(name="renewalIntervalMinutes", required=true)
     ...
     * 
     */
    @Import(name="vaultUrl", required=true)
    ...
    private VaultConnectorArgs() {}

    private VaultConnectorArgs(VaultConnectorArgs $) {
    ...
    public static Builder builder(VaultConnectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VaultConnectorArgs();
        }

        public Builder(VaultConnectorArgs defaults) {
            $ = new VaultConnectorArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder renewalIntervalMinutes(Output<Integer> renewalIntervalMinutes) {
         ...
         * 
         */
        public Builder vaultUrl(Output<String> vaultUrl) {
            $.vaultUrl = vaultUrl;
            return this;
        }
        ...
        public VaultConnectorArgs build() {
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("VaultConnectorArgs", "identifier");
            }
            if ($.renewalIntervalMinutes == null) {
                throw new MissingRequiredPropertyException("VaultConnectorArgs", "renewalIntervalMinutes");
            }
            if ($.vaultUrl == null) {
                throw new MissingRequiredPropertyException("VaultConnectorArgs", "vaultUrl");
            }
            return $;
        }
    }

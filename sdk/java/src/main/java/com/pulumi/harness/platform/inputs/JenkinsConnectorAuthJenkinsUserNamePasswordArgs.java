...
public final class JenkinsConnectorAuthJenkinsUserNamePasswordArgs extends com.pulumi.resources.ResourceArgs {

    public static final JenkinsConnectorAuthJenkinsUserNamePasswordArgs Empty = new JenkinsConnectorAuthJenkinsUserNamePasswordArgs();
    ...
    private JenkinsConnectorAuthJenkinsUserNamePasswordArgs() {}

    private JenkinsConnectorAuthJenkinsUserNamePasswordArgs(JenkinsConnectorAuthJenkinsUserNamePasswordArgs $) {
    ...
    public static Builder builder(JenkinsConnectorAuthJenkinsUserNamePasswordArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JenkinsConnectorAuthJenkinsUserNamePasswordArgs();
        }

        public Builder(JenkinsConnectorAuthJenkinsUserNamePasswordArgs defaults) {
            $ = new JenkinsConnectorAuthJenkinsUserNamePasswordArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param usernameRef Username reference to use for authentication.
         * 
         * @return builder
         * 
         */
        ...
        public JenkinsConnectorAuthJenkinsUserNamePasswordArgs build() {
            if ($.passwordRef == null) {
                throw new MissingRequiredPropertyException("JenkinsConnectorAuthJenkinsUserNamePasswordArgs", "passwordRef");
            }
            return $;
        }
    }

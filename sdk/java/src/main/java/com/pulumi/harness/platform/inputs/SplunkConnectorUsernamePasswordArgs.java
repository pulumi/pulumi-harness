...
public final class SplunkConnectorUsernamePasswordArgs extends com.pulumi.resources.ResourceArgs {

    public static final SplunkConnectorUsernamePasswordArgs Empty = new SplunkConnectorUsernamePasswordArgs();
    ...
    private SplunkConnectorUsernamePasswordArgs() {}

    private SplunkConnectorUsernamePasswordArgs(SplunkConnectorUsernamePasswordArgs $) {
    ...
    public static Builder builder(SplunkConnectorUsernamePasswordArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SplunkConnectorUsernamePasswordArgs();
        }

        public Builder(SplunkConnectorUsernamePasswordArgs defaults) {
            $ = new SplunkConnectorUsernamePasswordArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SplunkConnectorUsernamePasswordArgs build() {
            if ($.passwordRef == null) {
                throw new MissingRequiredPropertyException("SplunkConnectorUsernamePasswordArgs", "passwordRef");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("SplunkConnectorUsernamePasswordArgs", "username");
            }
            return $;
        }
    }

...
import com.pulumi.harness.platform.outputs.GetConnectorServiceNowAuth;
...
@CustomType
public final class GetConnectorServiceNowResult {
    /**
     * @return The credentials to use for the service now authentication.
     * 
     */
    private List<GetConnectorServiceNowAuth> auths;
    /**
     ...
     * 
     */
    public List<GetConnectorServiceNowAuth> auths() {
        return this.auths;
    }
    /**
     * @return Tags to filter delegates for connection.
    ...
    public static Builder builder(GetConnectorServiceNowResult defaults) {
    ...
    public static final class Builder {
        ...
        private String usernameRef;
        public Builder() {}
        public Builder(GetConnectorServiceNowResult defaults) {
        ...
        @CustomType.Setter
        public Builder auths(List<GetConnectorServiceNowAuth> auths) {
            this.auths = Objects.requireNonNull(auths);
            return this;
        }
        public Builder auths(GetConnectorServiceNowAuth... auths) {
        ...
        public GetConnectorServiceNowResult build() {
            final var o = new GetConnectorServiceNowResult();
            o.auths = auths;

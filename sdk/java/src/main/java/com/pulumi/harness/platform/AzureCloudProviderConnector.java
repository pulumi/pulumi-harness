...
public class AzureCloudProviderConnector extends com.pulumi.resources.CustomResource {
     ...
     */
    public AzureCloudProviderConnector(java.lang.String name) {
     ...
     */
    public AzureCloudProviderConnector(java.lang.String name, AzureCloudProviderConnectorArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AzureCloudProviderConnector(java.lang.String name, AzureCloudProviderConnectorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/azureCloudProviderConnector:AzureCloudProviderConnector", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AzureCloudProviderConnector(java.lang.String name, Output<java.lang.String> id, @Nullable AzureCloudProviderConnectorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/azureCloudProviderConnector:AzureCloudProviderConnector", name, state, makeResourceOptions(options, id), false);
    }

    private static AzureCloudProviderConnectorArgs makeArgs(AzureCloudProviderConnectorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AzureCloudProviderConnectorArgs.Empty : args;
    }
     ...
     */
    public static AzureCloudProviderConnector get(java.lang.String name, Output<java.lang.String> id, @Nullable AzureCloudProviderConnectorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

...
@CustomType
public final class ConnectorServiceNowAuthUsernamePassword {
    /**
    ...
    private ConnectorServiceNowAuthUsernamePassword() {}
    /**
     * @return Reference to a secret containing the password to use for authentication. To reference a secret at the organization scope, prefix &#39;org&#39; to the expression: org.{identifier}. To reference a secret at the account scope, prefix &#39;account` to the expression: account.{identifier}.
     * 
     */
    ...
    public static Builder builder(ConnectorServiceNowAuthUsernamePassword defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(ConnectorServiceNowAuthUsernamePassword defaults) {
        ...
        public ConnectorServiceNowAuthUsernamePassword build() {
            final var o = new ConnectorServiceNowAuthUsernamePassword();

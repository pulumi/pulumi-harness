...
@CustomType
public final class TemplateGitDetails {
    /**
    ...
    public static Builder builder(TemplateGitDetails defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String storeType;
        public Builder() {}
        public Builder(TemplateGitDetails defaults) {
        ...
        public TemplateGitDetails build() {
            final var _resultValue = new TemplateGitDetails();

...
@CustomType
public final class OciHelmConnectorCredentials {
    /**
    ...
    private OciHelmConnectorCredentials() {}
    /**
     * @return Reference to a secret containing the password to use for authentication. To reference a secret at the organization scope, prefix &#39;org&#39; to the expression: org.{identifier}. To reference a secret at the account scope, prefix &#39;account` to the expression: account.{identifier}.
     * 
     */
    ...
    public static Builder builder(OciHelmConnectorCredentials defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(OciHelmConnectorCredentials defaults) {
        ...
        public Builder passwordRef(String passwordRef) {
            if (passwordRef == null) {
              throw new MissingRequiredPropertyException("OciHelmConnectorCredentials", "passwordRef");
            }
        ...
        public OciHelmConnectorCredentials build() {
            final var _resultValue = new OciHelmConnectorCredentials();

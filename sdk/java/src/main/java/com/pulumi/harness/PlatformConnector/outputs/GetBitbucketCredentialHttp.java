...
@CustomType
public final class GetBitbucketCredentialHttp {
    private String passwordRef;
    private String username;
    private String usernameRef;

    private GetBitbucketCredentialHttp() {}
    ...
    public static Builder builder(GetBitbucketCredentialHttp defaults) {
    ...
    public static final class Builder {
        ...
        private String usernameRef;
        public Builder() {}
        public Builder(GetBitbucketCredentialHttp defaults) {
        ...
        public GetBitbucketCredentialHttp build() {
            final var o = new GetBitbucketCredentialHttp();

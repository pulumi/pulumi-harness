...
@CustomType
public final class RuleVmTcpForwardRule {
    /**
    ...
    public static Builder builder(RuleVmTcpForwardRule defaults) {
    ...
    public static final class Builder {
        ...
        private Integer port;
        public Builder() {}
        public Builder(RuleVmTcpForwardRule defaults) {
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("RuleVmTcpForwardRule", "port");
            }
            this.port = port;
            return this;
        }
        public RuleVmTcpForwardRule build() {
            final var _resultValue = new RuleVmTcpForwardRule();

...
@CustomType
public final class GetConnectorTasCredentialTasManualDetail {
    private String endpointUrl;
    private String passwordRef;
    private String username;
    private String usernameRef;

    private GetConnectorTasCredentialTasManualDetail() {}
    ...
    public static Builder builder(GetConnectorTasCredentialTasManualDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String usernameRef;
        public Builder() {}
        public Builder(GetConnectorTasCredentialTasManualDetail defaults) {
        ...
        public GetConnectorTasCredentialTasManualDetail build() {
            final var o = new GetConnectorTasCredentialTasManualDetail();

...
@CustomType
public final class GetGcpManual {
    private List<String> delegateSelectors;
    private String secretKeyRef;

    private GetGcpManual() {}
    ...
    public static Builder builder(GetGcpManual defaults) {
    ...
    public static final class Builder {
        ...
        private String secretKeyRef;
        public Builder() {}
        public Builder(GetGcpManual defaults) {
        ...
        public GetGcpManual build() {
            final var o = new GetGcpManual();

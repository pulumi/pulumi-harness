...
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryJsonnetArgs;
...
public final class GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs Empty = new GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs();
     ...
     */
    @Import(name="jsonnet")
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryJsonnetArgs> jsonnet;

    /**
     * @return Jsonnet specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryJsonnetArgs>> jsonnet() {
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs() {}

    private GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs(GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs $) {
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder jsonnet(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryJsonnetArgs> jsonnet) {
            $.jsonnet = jsonnet;
            return this;
        }
         ...
         * 
         */
        public Builder jsonnet(GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryJsonnetArgs jsonnet) {
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs build() {
            return $;
        }
    }

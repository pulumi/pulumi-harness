...
public class Datacenter extends com.pulumi.resources.CustomResource {
    ...
    public Datacenter(java.lang.String name, @Nullable DatacenterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:cloudprovider/datacenter:Datacenter", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Datacenter(java.lang.String name, Output<java.lang.String> id, @Nullable DatacenterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:cloudprovider/datacenter:Datacenter", name, state, makeResourceOptions(options, id), false);
    }

...
public class Spot extends com.pulumi.resources.CustomResource {
     ...
     */
    public Spot(String name, SpotArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:cloudprovider/spot:Spot", name, args == null ? SpotArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Spot(String name, Output<String> id, @Nullable SpotState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:cloudprovider/spot:Spot", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static Spot get(String name, Output<String> id, @Nullable SpotState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

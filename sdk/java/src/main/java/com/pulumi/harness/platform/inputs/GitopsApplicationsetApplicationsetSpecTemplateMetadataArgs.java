...
public final class GitopsApplicationsetApplicationsetSpecTemplateMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecTemplateMetadataArgs Empty = new GitopsApplicationsetApplicationsetSpecTemplateMetadataArgs();
    ...
    private GitopsApplicationsetApplicationsetSpecTemplateMetadataArgs() {}

    private GitopsApplicationsetApplicationsetSpecTemplateMetadataArgs(GitopsApplicationsetApplicationsetSpecTemplateMetadataArgs $) {
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecTemplateMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecTemplateMetadataArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecTemplateMetadataArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecTemplateMetadataArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GitopsApplicationsetApplicationsetSpecTemplateMetadataArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GitopsApplicationsetApplicationsetSpecTemplateMetadataArgs", "name");
            }
            return $;
        }
    }

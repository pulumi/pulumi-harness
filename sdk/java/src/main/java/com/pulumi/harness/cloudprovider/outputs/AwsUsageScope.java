...
@CustomType
public final class AwsUsageScope {
    /**
    ...
    public static Builder builder(AwsUsageScope defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String environmentId;
        public Builder() {}
        public Builder(AwsUsageScope defaults) {
        ...
        public AwsUsageScope build() {
            final var _resultValue = new AwsUsageScope();

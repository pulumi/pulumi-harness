...
@CustomType
public final class DatacenterUsageScope {
    /**
    ...
    public static Builder builder(DatacenterUsageScope defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String environmentId;
        public Builder() {}
        public Builder(DatacenterUsageScope defaults) {
        ...
        public DatacenterUsageScope build() {
            final var _resultValue = new DatacenterUsageScope();

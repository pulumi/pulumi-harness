...
public final class OrchestratorConfigReplacementScheduleWindowDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final OrchestratorConfigReplacementScheduleWindowDetailsArgs Empty = new OrchestratorConfigReplacementScheduleWindowDetailsArgs();
    ...
    private OrchestratorConfigReplacementScheduleWindowDetailsArgs() {}

    private OrchestratorConfigReplacementScheduleWindowDetailsArgs(OrchestratorConfigReplacementScheduleWindowDetailsArgs $) {
        this.allDay = $.allDay;
        this.days = $.days;
    ...
    public static Builder builder(OrchestratorConfigReplacementScheduleWindowDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OrchestratorConfigReplacementScheduleWindowDetailsArgs();
        }

        public Builder(OrchestratorConfigReplacementScheduleWindowDetailsArgs defaults) {
            $ = new OrchestratorConfigReplacementScheduleWindowDetailsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OrchestratorConfigReplacementScheduleWindowDetailsArgs build() {
            if ($.days == null) {
                throw new MissingRequiredPropertyException("OrchestratorConfigReplacementScheduleWindowDetailsArgs", "days");
            }
            if ($.timeZone == null) {
                throw new MissingRequiredPropertyException("OrchestratorConfigReplacementScheduleWindowDetailsArgs", "timeZone");
            }
            return $;
        }
    }

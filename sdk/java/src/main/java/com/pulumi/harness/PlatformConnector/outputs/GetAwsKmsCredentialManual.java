...
@CustomType
public final class GetAwsKmsCredentialManual {
    private String accessKeyRef;
    private String secretKeyRef;

    private GetAwsKmsCredentialManual() {}
    ...
    public static Builder builder(GetAwsKmsCredentialManual defaults) {
    ...
    public static final class Builder {
        ...
        private String secretKeyRef;
        public Builder() {}
        public Builder(GetAwsKmsCredentialManual defaults) {
        ...
        public GetAwsKmsCredentialManual build() {
            final var o = new GetAwsKmsCredentialManual();

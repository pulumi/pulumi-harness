...
@CustomType
public final class ServiceGitDetails {
    /**
    ...
    public static Builder builder(ServiceGitDetails defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String storeType;
        public Builder() {}
        public Builder(ServiceGitDetails defaults) {
        ...
        public ServiceGitDetails build() {
            final var _resultValue = new ServiceGitDetails();

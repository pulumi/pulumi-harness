...
public final class AppDynamicsConnectorArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AppDynamicsConnectorArgs build() {
            if ($.accountName == null) {
                throw new MissingRequiredPropertyException("AppDynamicsConnectorArgs", "accountName");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("AppDynamicsConnectorArgs", "identifier");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("AppDynamicsConnectorArgs", "url");
            }
            return $;
        }
    }

    ...
    public static final class Builder {
        ...
        public GithubConnectorArgs build() {
            if ($.connectionType == null) {
                throw new MissingRequiredPropertyException("GithubConnectorArgs", "connectionType");
            }
            if ($.credentials == null) {
                throw new MissingRequiredPropertyException("GithubConnectorArgs", "credentials");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("GithubConnectorArgs", "identifier");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GithubConnectorArgs", "url");
            }
            return $;
        }
    }

...
import com.pulumi.harness.platform.ConnectorAzureRepoArgs;
import com.pulumi.harness.platform.inputs.ConnectorAzureRepoState;
import com.pulumi.harness.platform.outputs.ConnectorAzureRepoApiAuthentication;
import com.pulumi.harness.platform.outputs.ConnectorAzureRepoCredentials;
...
public class ConnectorAzureRepo extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="credentials", refs={ConnectorAzureRepoCredentials.class}, tree="[0]")
    private Output<ConnectorAzureRepoCredentials> credentials;

    /**
     * @return Credentials to use for the connection.
     * 
     */
    public Output<ConnectorAzureRepoCredentials> credentials() {
    ...
    /**
     * @return URL of the azure repository or account.
     * 
     */
     ...
     */
    public ConnectorAzureRepo(java.lang.String name) {
        this(name, ConnectorAzureRepoArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ConnectorAzureRepo(java.lang.String name, ConnectorAzureRepoArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ConnectorAzureRepo(java.lang.String name, ConnectorAzureRepoArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/connectorAzureRepo:ConnectorAzureRepo", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ConnectorAzureRepo(java.lang.String name, Output<java.lang.String> id, @Nullable ConnectorAzureRepoState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/connectorAzureRepo:ConnectorAzureRepo", name, state, makeResourceOptions(options, id), false);
    }

    private static ConnectorAzureRepoArgs makeArgs(ConnectorAzureRepoArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ConnectorAzureRepoArgs.Empty : args;
    }
     ...
     */
    public static ConnectorAzureRepo get(java.lang.String name, Output<java.lang.String> id, @Nullable ConnectorAzureRepoState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

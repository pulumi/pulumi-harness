...
public final class AwsManualArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsManualArgs Empty = new AwsManualArgs();
    ...
    private AwsManualArgs() {}

    private AwsManualArgs(AwsManualArgs $) {
    ...
    public static Builder builder(AwsManualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AwsManualArgs defaults) {
            $ = new AwsManualArgs(Objects.requireNonNull(defaults));
        }

...
public final class GetSshCredentialUsageScope extends com.pulumi.resources.InvokeArgs {

    public static final GetSshCredentialUsageScope Empty = new GetSshCredentialUsageScope();
    ...
    private GetSshCredentialUsageScope() {}

    private GetSshCredentialUsageScope(GetSshCredentialUsageScope $) {
    ...
    public static Builder builder(GetSshCredentialUsageScope defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSshCredentialUsageScope();
        }

        public Builder(GetSshCredentialUsageScope defaults) {
            $ = new GetSshCredentialUsageScope(Objects.requireNonNull(defaults));
        }
        ...
        public GetSshCredentialUsageScope build() {
            return $;
        }
    }

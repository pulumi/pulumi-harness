...
public final class GetJiraConnectorResult {
    ...
    public static final class Builder {
        ...
        public Builder auths(List<GetJiraConnectorAuth> auths) {
            if (auths == null) {
              throw new MissingRequiredPropertyException("GetJiraConnectorResult", "auths");
            }
            this.auths = auths;
            return this;
        }
        ...
        public Builder delegateSelectors(List<String> delegateSelectors) {
            if (delegateSelectors == null) {
              throw new MissingRequiredPropertyException("GetJiraConnectorResult", "delegateSelectors");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetJiraConnectorResult", "description");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetJiraConnectorResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder identifier(String identifier) {
            if (identifier == null) {
              throw new MissingRequiredPropertyException("GetJiraConnectorResult", "identifier");
            }
        ...
        public Builder passwordRef(String passwordRef) {
            if (passwordRef == null) {
              throw new MissingRequiredPropertyException("GetJiraConnectorResult", "passwordRef");
            }
        ...
        public Builder tags(List<String> tags) {
            if (tags == null) {
              throw new MissingRequiredPropertyException("GetJiraConnectorResult", "tags");
            }
            this.tags = tags;
            return this;
        }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetJiraConnectorResult", "url");
            }
            this.url = url;
            return this;
        }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetJiraConnectorResult", "username");
            }
        ...
        public Builder usernameRef(String usernameRef) {
            if (usernameRef == null) {
              throw new MissingRequiredPropertyException("GetJiraConnectorResult", "usernameRef");
            }
            this.usernameRef = usernameRef;
            return this;
        }
        public GetJiraConnectorResult build() {
            final var _resultValue = new GetJiraConnectorResult();

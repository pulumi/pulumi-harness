...
public class RuleVm extends com.pulumi.resources.CustomResource {
     ...
     */
    public RuleVm(String name, RuleVmArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:autostopping/ruleVm:RuleVm", name, args == null ? RuleVmArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RuleVm(String name, Output<String> id, @Nullable RuleVmState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:autostopping/ruleVm:RuleVm", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static RuleVm get(String name, Output<String> id, @Nullable RuleVmState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

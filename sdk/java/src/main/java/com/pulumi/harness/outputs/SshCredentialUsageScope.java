...
@CustomType
public final class SshCredentialUsageScope {
    /**
    ...
    private SshCredentialUsageScope() {}
    /**
     * @return Id of the application to scope to. If empty then this scope applies to all applications.
     * 
     */
    ...
    public static Builder builder(SshCredentialUsageScope defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String environmentId;
        public Builder() {}
        public Builder(SshCredentialUsageScope defaults) {
        ...
        public SshCredentialUsageScope build() {
            final var _resultValue = new SshCredentialUsageScope();

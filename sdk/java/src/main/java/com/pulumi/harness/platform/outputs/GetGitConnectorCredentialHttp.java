...
public final class GetGitConnectorCredentialHttp {
    ...
    public static final class Builder {
        ...
        public Builder passwordRef(String passwordRef) {
            if (passwordRef == null) {
              throw new MissingRequiredPropertyException("GetGitConnectorCredentialHttp", "passwordRef");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetGitConnectorCredentialHttp", "username");
            }
        ...
        public Builder usernameRef(String usernameRef) {
            if (usernameRef == null) {
              throw new MissingRequiredPropertyException("GetGitConnectorCredentialHttp", "usernameRef");
            }
            this.usernameRef = usernameRef;
            return this;
        }
        public GetGitConnectorCredentialHttp build() {
            final var _resultValue = new GetGitConnectorCredentialHttp();

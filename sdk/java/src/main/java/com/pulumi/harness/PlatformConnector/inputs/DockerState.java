...
import com.pulumi.harness.PlatformConnector.inputs.DockerCredentialsArgs;
...
public final class DockerState extends com.pulumi.resources.ResourceArgs {

    public static final DockerState Empty = new DockerState();
    ...
    private @Nullable Output<DockerCredentialsArgs> credentials;
     ...
     * 
     */
    public Optional<Output<DockerCredentialsArgs>> credentials() {
    ...
    public static Builder builder(DockerState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DockerState defaults) {
            $ = new DockerState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder credentials(@Nullable Output<DockerCredentialsArgs> credentials) {
         ...
         * 
         */
        public Builder credentials(DockerCredentialsArgs credentials) {

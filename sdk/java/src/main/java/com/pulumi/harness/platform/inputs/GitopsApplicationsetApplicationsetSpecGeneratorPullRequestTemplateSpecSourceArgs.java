...
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceHelmArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceKustomizeArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourcePluginArgs;
...
public final class GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceArgs Empty = new GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceArgs();
    ...
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs> directory;

    /**
     * @return Path/directory specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs>> directory() {
     ...
     */
    @Import(name="helm")
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceHelmArgs> helm;

    /**
     * @return Helm specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceHelmArgs>> helm() {
    ...
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceKustomizeArgs> kustomize;

    /**
     * @return Kustomize specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceKustomizeArgs>> kustomize() {
     ...
     */
    @Import(name="plugin")
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourcePluginArgs> plugin;

    /**
     * @return Config management plugin specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourcePluginArgs>> plugin() {
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceArgs() {}

    private GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceArgs(GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceArgs $) {
        this.chart = $.chart;
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder directory(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs> directory) {
            $.directory = directory;
            return this;
        }
         ...
         * 
         */
        public Builder directory(GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs directory) {
         ...
         * 
         */
        public Builder helm(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceHelmArgs> helm) {
            $.helm = helm;
            return this;
        }
         ...
         * 
         */
        public Builder helm(GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceHelmArgs helm) {
         ...
         * 
         */
        public Builder kustomize(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceKustomizeArgs> kustomize) {
            $.kustomize = kustomize;
            return this;
        }
         ...
         * 
         */
        public Builder kustomize(GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceKustomizeArgs kustomize) {
         ...
         * 
         */
        public Builder plugin(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourcePluginArgs> plugin) {
            $.plugin = plugin;
            return this;
        }
         ...
         * 
         */
        public Builder plugin(GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourcePluginArgs plugin) {
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceArgs build() {
            return $;
        }
    }

...
public final class GetGitlabConnectorCredentialHttp {
    ...
    public static final class Builder {
        ...
        public Builder passwordRef(String passwordRef) {
            if (passwordRef == null) {
              throw new MissingRequiredPropertyException("GetGitlabConnectorCredentialHttp", "passwordRef");
            }
        ...
        public Builder tokenRef(String tokenRef) {
            if (tokenRef == null) {
              throw new MissingRequiredPropertyException("GetGitlabConnectorCredentialHttp", "tokenRef");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetGitlabConnectorCredentialHttp", "username");
            }
        ...
        public Builder usernameRef(String usernameRef) {
            if (usernameRef == null) {
              throw new MissingRequiredPropertyException("GetGitlabConnectorCredentialHttp", "usernameRef");
            }
            this.usernameRef = usernameRef;
            return this;
        }
        public GetGitlabConnectorCredentialHttp build() {
            final var _resultValue = new GetGitlabConnectorCredentialHttp();

...
public final class GcpConnectorOidcAuthentication {
    ...
    private GcpConnectorOidcAuthentication() {}
    /**
     * @return The delegates to inherit the credentials from.
     * 
     */
    ...
    public static Builder builder(GcpConnectorOidcAuthentication defaults) {
    ...
    public static final class Builder {
        ...
        private String workloadPoolId;
        public Builder() {}
        public Builder(GcpConnectorOidcAuthentication defaults) {
        ...
        public Builder gcpProjectId(String gcpProjectId) {
            if (gcpProjectId == null) {
              throw new MissingRequiredPropertyException("GcpConnectorOidcAuthentication", "gcpProjectId");
            }
        ...
        public Builder providerId(String providerId) {
            if (providerId == null) {
              throw new MissingRequiredPropertyException("GcpConnectorOidcAuthentication", "providerId");
            }
        ...
        public Builder serviceAccountEmail(String serviceAccountEmail) {
            if (serviceAccountEmail == null) {
              throw new MissingRequiredPropertyException("GcpConnectorOidcAuthentication", "serviceAccountEmail");
            }
        ...
        public Builder workloadPoolId(String workloadPoolId) {
            if (workloadPoolId == null) {
              throw new MissingRequiredPropertyException("GcpConnectorOidcAuthentication", "workloadPoolId");
            }
            this.workloadPoolId = workloadPoolId;
            return this;
        }
        public GcpConnectorOidcAuthentication build() {
            final var _resultValue = new GcpConnectorOidcAuthentication();

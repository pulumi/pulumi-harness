    ...
    public static final class Builder {
        ...
        public Builder encryptedValueRef(String encryptedValueRef) {
            if (encryptedValueRef == null) {
              throw new MissingRequiredPropertyException("GetPrometheusConnectorHeader", "encryptedValueRef");
            }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetPrometheusConnectorHeader", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetPrometheusConnectorHeader", "value");
            }
            this.value = value;
            return this;
        }
        ...
        public Builder valueEncrypted(Boolean valueEncrypted) {
            if (valueEncrypted == null) {
              throw new MissingRequiredPropertyException("GetPrometheusConnectorHeader", "valueEncrypted");
            }
            this.valueEncrypted = valueEncrypted;
            return this;
        }
        public GetPrometheusConnectorHeader build() {
            final var _resultValue = new GetPrometheusConnectorHeader();

...
public final class GetSloArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetSloArgs build() {
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("GetSloArgs", "identifier");
            }
            if ($.orgId == null) {
                throw new MissingRequiredPropertyException("GetSloArgs", "orgId");
            }
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("GetSloArgs", "projectId");
            }
            return $;
        }
    }

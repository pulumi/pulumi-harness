...
public final class FiltersArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<FiltersFilterPropertiesArgs> filterProperties;

    /**
     * @return Properties of the filter entity defined in Harness.
     * 
     */
    public Output<FiltersFilterPropertiesArgs> filterProperties() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder filterProperties(Output<FiltersFilterPropertiesArgs> filterProperties) {
        ...
        public FiltersArgs build() {
            if ($.filterProperties == null) {
                throw new MissingRequiredPropertyException("FiltersArgs", "filterProperties");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("FiltersArgs", "identifier");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("FiltersArgs", "type");
            }
            return $;
        }
    }

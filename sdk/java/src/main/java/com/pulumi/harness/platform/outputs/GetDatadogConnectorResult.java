...
public final class GetDatadogConnectorResult {
    ...
    public static final class Builder {
        ...
        public Builder apiKeyRef(String apiKeyRef) {
            if (apiKeyRef == null) {
              throw new MissingRequiredPropertyException("GetDatadogConnectorResult", "apiKeyRef");
            }
        ...
        public Builder applicationKeyRef(String applicationKeyRef) {
            if (applicationKeyRef == null) {
              throw new MissingRequiredPropertyException("GetDatadogConnectorResult", "applicationKeyRef");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetDatadogConnectorResult", "description");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetDatadogConnectorResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder identifier(String identifier) {
            if (identifier == null) {
              throw new MissingRequiredPropertyException("GetDatadogConnectorResult", "identifier");
            }
        ...
        public Builder tags(List<String> tags) {
            if (tags == null) {
              throw new MissingRequiredPropertyException("GetDatadogConnectorResult", "tags");
            }
            this.tags = tags;
            return this;
        }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetDatadogConnectorResult", "url");
            }
            this.url = url;
            return this;
        }
        public GetDatadogConnectorResult build() {
            final var _resultValue = new GetDatadogConnectorResult();
            _resultValue.apiKeyRef = apiKeyRef;
            _resultValue.applicationKeyRef = applicationKeyRef;

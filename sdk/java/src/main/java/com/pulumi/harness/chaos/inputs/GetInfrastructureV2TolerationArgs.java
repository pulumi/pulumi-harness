...
public final class GetInfrastructureV2TolerationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetInfrastructureV2TolerationArgs Empty = new GetInfrastructureV2TolerationArgs();
    ...
    private GetInfrastructureV2TolerationArgs() {}

    private GetInfrastructureV2TolerationArgs(GetInfrastructureV2TolerationArgs $) {
        this.effect = $.effect;
        this.key = $.key;
    ...
    public static Builder builder(GetInfrastructureV2TolerationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetInfrastructureV2TolerationArgs();
        }

        public Builder(GetInfrastructureV2TolerationArgs defaults) {
            $ = new GetInfrastructureV2TolerationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetInfrastructureV2TolerationArgs build() {
            if ($.effect == null) {
                throw new MissingRequiredPropertyException("GetInfrastructureV2TolerationArgs", "effect");
            }
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetInfrastructureV2TolerationArgs", "key");
            }
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("GetInfrastructureV2TolerationArgs", "operator");
            }
            return $;
        }
    }

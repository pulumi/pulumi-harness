...
public final class DynatraceConnectorArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DynatraceConnectorArgs() {}

    private DynatraceConnectorArgs(DynatraceConnectorArgs $) {
    ...
    public static Builder builder(DynatraceConnectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DynatraceConnectorArgs();
        }

        public Builder(DynatraceConnectorArgs defaults) {
            $ = new DynatraceConnectorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DynatraceConnectorArgs build() {
            if ($.apiTokenRef == null) {
                throw new MissingRequiredPropertyException("DynatraceConnectorArgs", "apiTokenRef");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("DynatraceConnectorArgs", "identifier");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("DynatraceConnectorArgs", "url");
            }
            return $;
        }
    }

...
@CustomType
public final class GitopsApplicationsetApplicationsetSpecGeneratorScmProviderTemplateMetadata {
    /**
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorScmProviderTemplateMetadata() {}
    /**
     * @return An unstructured key value map that may be used to store arbitrary metadata for the resulting Application.
     * 
     */
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorScmProviderTemplateMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String namespace;
        public Builder() {}
        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorScmProviderTemplateMetadata defaults) {
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorScmProviderTemplateMetadata build() {
            final var _resultValue = new GitopsApplicationsetApplicationsetSpecGeneratorScmProviderTemplateMetadata();

...
@CustomType
public final class InfrastructureV2VolumeMount {
    /**
    ...
    public static Builder builder(InfrastructureV2VolumeMount defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subPathExpr;
        public Builder() {}
        public Builder(InfrastructureV2VolumeMount defaults) {
        ...
        public Builder mountPath(String mountPath) {
            if (mountPath == null) {
              throw new MissingRequiredPropertyException("InfrastructureV2VolumeMount", "mountPath");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("InfrastructureV2VolumeMount", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public InfrastructureV2VolumeMount build() {
            final var _resultValue = new InfrastructureV2VolumeMount();

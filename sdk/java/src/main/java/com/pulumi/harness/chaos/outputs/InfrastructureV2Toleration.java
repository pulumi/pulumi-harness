...
@CustomType
public final class InfrastructureV2Toleration {
    /**
    ...
    private InfrastructureV2Toleration() {}
    /**
     * @return Effect indicates the taint effect to match. When specified, allowed values are NoSchedule, PreferNoSchedule and NoExecute.
     * 
     */
    ...
    public static Builder builder(InfrastructureV2Toleration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(InfrastructureV2Toleration defaults) {
        ...
        public Builder effect(String effect) {
            if (effect == null) {
              throw new MissingRequiredPropertyException("InfrastructureV2Toleration", "effect");
            }
            this.effect = effect;
            return this;
        }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("InfrastructureV2Toleration", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("InfrastructureV2Toleration", "operator");
            }
        ...
        public InfrastructureV2Toleration build() {
            final var _resultValue = new InfrastructureV2Toleration();

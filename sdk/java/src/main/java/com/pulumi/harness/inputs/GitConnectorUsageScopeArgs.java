...
public final class GitConnectorUsageScopeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitConnectorUsageScopeArgs Empty = new GitConnectorUsageScopeArgs();
    ...
    private GitConnectorUsageScopeArgs() {}

    private GitConnectorUsageScopeArgs(GitConnectorUsageScopeArgs $) {
    ...
    public static Builder builder(GitConnectorUsageScopeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitConnectorUsageScopeArgs();
        }

        public Builder(GitConnectorUsageScopeArgs defaults) {
            $ = new GitConnectorUsageScopeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GitConnectorUsageScopeArgs build() {
            return $;
        }
    }

...
public final class TemplateGitDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final TemplateGitDetailsArgs Empty = new TemplateGitDetailsArgs();
    ...
    private TemplateGitDetailsArgs() {}

    private TemplateGitDetailsArgs(TemplateGitDetailsArgs $) {
    ...
    public static Builder builder(TemplateGitDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TemplateGitDetailsArgs();
        }

        public Builder(TemplateGitDetailsArgs defaults) {
            $ = new TemplateGitDetailsArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param storeType Specifies whether the Entity is to be stored in Git or not. Possible values: INLINE, REMOTE. Important: If your Harness account has the default store type configured as REMOTE (via account-level Git Experience settings), you must explicitly set this field to INLINE within a git*details block to create inline templates. Omitting git*details or this field will cause the server to apply the account default (REMOTE), which will fail unless all required remote Git fields are also provided.
         * 
         * @return builder
         * 
         */
        ...
        public TemplateGitDetailsArgs build() {
            return $;
        }
    }

...
import com.pulumi.harness.platform.outputs.GitopsApplicationsetApplicationsetSpecGeneratorClusterTemplateSpecSourceHelmFileParameter;
import com.pulumi.harness.platform.outputs.GitopsApplicationsetApplicationsetSpecGeneratorClusterTemplateSpecSourceHelmParameter;
...
@CustomType
public final class GitopsApplicationsetApplicationsetSpecGeneratorClusterTemplateSpecSourceHelm {
    /**
     * @return File parameters for the helm template.
     * 
     */
    private @Nullable List<GitopsApplicationsetApplicationsetSpecGeneratorClusterTemplateSpecSourceHelmFileParameter> fileParameters;
    /**
     ...
     * 
     */
    private @Nullable List<GitopsApplicationsetApplicationsetSpecGeneratorClusterTemplateSpecSourceHelmParameter> parameters;
    /**
     ...
     * 
     */
    public List<GitopsApplicationsetApplicationsetSpecGeneratorClusterTemplateSpecSourceHelmFileParameter> fileParameters() {
     ...
     * 
     */
    public List<GitopsApplicationsetApplicationsetSpecGeneratorClusterTemplateSpecSourceHelmParameter> parameters() {
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorClusterTemplateSpecSourceHelm defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder fileParameters(@Nullable List<GitopsApplicationsetApplicationsetSpecGeneratorClusterTemplateSpecSourceHelmFileParameter> fileParameters) {

            this.fileParameters = fileParameters;
            return this;
        }
        public Builder fileParameters(GitopsApplicationsetApplicationsetSpecGeneratorClusterTemplateSpecSourceHelmFileParameter... fileParameters) {
        ...
        @CustomType.Setter
        public Builder parameters(@Nullable List<GitopsApplicationsetApplicationsetSpecGeneratorClusterTemplateSpecSourceHelmParameter> parameters) {

            this.parameters = parameters;
            return this;
        }
        public Builder parameters(GitopsApplicationsetApplicationsetSpecGeneratorClusterTemplateSpecSourceHelmParameter... parameters) {

...
public class Ami extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="variables", refs={List.class,AmiVariable.class}, tree="[0,1]")
     ...
     */
    public Ami(java.lang.String name, AmiArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Ami(java.lang.String name, AmiArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:service/ami:Ami", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Ami(java.lang.String name, Output<java.lang.String> id, @Nullable AmiState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:service/ami:Ami", name, state, makeResourceOptions(options, id), false);
    }

    private static AmiArgs makeArgs(AmiArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {

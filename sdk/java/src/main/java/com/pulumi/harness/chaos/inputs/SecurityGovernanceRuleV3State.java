...
public final class SecurityGovernanceRuleV3State extends com.pulumi.resources.ResourceArgs {

    public static final SecurityGovernanceRuleV3State Empty = new SecurityGovernanceRuleV3State();
    ...
    private @Nullable Output<List<SecurityGovernanceRuleV3TimeWindowArgs>> timeWindows;

    /**
     * @return Time windows during which the rule is active
     * 
     */
    public Optional<Output<List<SecurityGovernanceRuleV3TimeWindowArgs>>> timeWindows() {
    ...
    private SecurityGovernanceRuleV3State() {}

    private SecurityGovernanceRuleV3State(SecurityGovernanceRuleV3State $) {
    ...
    public static Builder builder(SecurityGovernanceRuleV3State defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecurityGovernanceRuleV3State();
        }

        public Builder(SecurityGovernanceRuleV3State defaults) {
            $ = new SecurityGovernanceRuleV3State(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder timeWindows(@Nullable Output<List<SecurityGovernanceRuleV3TimeWindowArgs>> timeWindows) {
        ...
        public SecurityGovernanceRuleV3State build() {
            return $;
        }
    }

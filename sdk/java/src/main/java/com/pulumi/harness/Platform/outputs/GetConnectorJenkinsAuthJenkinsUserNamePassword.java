...
@CustomType
public final class GetConnectorJenkinsAuthJenkinsUserNamePassword {
    private String passwordRef;
    private String username;
    private String usernameRef;

    private GetConnectorJenkinsAuthJenkinsUserNamePassword() {}
    ...
    public static Builder builder(GetConnectorJenkinsAuthJenkinsUserNamePassword defaults) {
    ...
    public static final class Builder {
        ...
        private String usernameRef;
        public Builder() {}
        public Builder(GetConnectorJenkinsAuthJenkinsUserNamePassword defaults) {
        ...
        public GetConnectorJenkinsAuthJenkinsUserNamePassword build() {
            final var o = new GetConnectorJenkinsAuthJenkinsUserNamePassword();

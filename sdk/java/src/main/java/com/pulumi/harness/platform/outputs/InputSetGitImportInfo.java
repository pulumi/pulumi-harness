...
@CustomType
public final class InputSetGitImportInfo {
    /**
    ...
    public static Builder builder(InputSetGitImportInfo defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repoName;
        public Builder() {}
        public Builder(InputSetGitImportInfo defaults) {
        ...
        public InputSetGitImportInfo build() {
            final var _resultValue = new InputSetGitImportInfo();

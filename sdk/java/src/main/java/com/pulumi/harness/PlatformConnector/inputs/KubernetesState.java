...
public final class KubernetesState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<KubernetesClientKeyCertArgs> clientKeyCert;

    /**
     * @return Client key and certificate config for the connector.
     * 
     */
    public Optional<Output<KubernetesClientKeyCertArgs>> clientKeyCert() {
    ...
    private @Nullable Output<KubernetesInheritFromDelegateArgs> inheritFromDelegate;

    /**
     * @return Credentials are inherited from the delegate.
     * 
     */
    public Optional<Output<KubernetesInheritFromDelegateArgs>> inheritFromDelegate() {
    ...
    private @Nullable Output<KubernetesOpenidConnectArgs> openidConnect;

    /**
     * @return OpenID configuration for the connector.
     * 
     */
    public Optional<Output<KubernetesOpenidConnectArgs>> openidConnect() {
    ...
    private @Nullable Output<KubernetesUsernamePasswordArgs> usernamePassword;

    /**
     * @return Username and password for the connector.
     * 
     */
    public Optional<Output<KubernetesUsernamePasswordArgs>> usernamePassword() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder clientKeyCert(@Nullable Output<KubernetesClientKeyCertArgs> clientKeyCert) {
         ...
         * 
         */
        public Builder clientKeyCert(KubernetesClientKeyCertArgs clientKeyCert) {
         ...
         * 
         */
        public Builder inheritFromDelegate(@Nullable Output<KubernetesInheritFromDelegateArgs> inheritFromDelegate) {
         ...
         * 
         */
        public Builder inheritFromDelegate(KubernetesInheritFromDelegateArgs inheritFromDelegate) {
         ...
         * 
         */
        public Builder openidConnect(@Nullable Output<KubernetesOpenidConnectArgs> openidConnect) {
         ...
         * 
         */
        public Builder openidConnect(KubernetesOpenidConnectArgs openidConnect) {
         ...
         * 
         */
        public Builder usernamePassword(@Nullable Output<KubernetesUsernamePasswordArgs> usernamePassword) {
         ...
         * 
         */
        public Builder usernamePassword(KubernetesUsernamePasswordArgs usernamePassword) {

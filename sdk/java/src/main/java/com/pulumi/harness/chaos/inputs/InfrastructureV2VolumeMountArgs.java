...
public final class InfrastructureV2VolumeMountArgs extends com.pulumi.resources.ResourceArgs {

    public static final InfrastructureV2VolumeMountArgs Empty = new InfrastructureV2VolumeMountArgs();
    ...
    private InfrastructureV2VolumeMountArgs() {}

    private InfrastructureV2VolumeMountArgs(InfrastructureV2VolumeMountArgs $) {
    ...
    public static Builder builder(InfrastructureV2VolumeMountArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InfrastructureV2VolumeMountArgs();
        }

        public Builder(InfrastructureV2VolumeMountArgs defaults) {
            $ = new InfrastructureV2VolumeMountArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InfrastructureV2VolumeMountArgs build() {
            if ($.mountPath == null) {
                throw new MissingRequiredPropertyException("InfrastructureV2VolumeMountArgs", "mountPath");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("InfrastructureV2VolumeMountArgs", "name");
            }
            return $;
        }
    }

...
public final class EncryptedTextArgs extends com.pulumi.resources.ResourceArgs {

    public static final EncryptedTextArgs Empty = new EncryptedTextArgs();
     ...
     * 
     */
    @Import(name="secretManagerId", required=true)
    ...
    private EncryptedTextArgs() {}

    private EncryptedTextArgs(EncryptedTextArgs $) {
    ...
    public static Builder builder(EncryptedTextArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EncryptedTextArgs();
        }

        public Builder(EncryptedTextArgs defaults) {
            $ = new EncryptedTextArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder secretManagerId(Output<String> secretManagerId) {
        ...
        public EncryptedTextArgs build() {
            $.secretManagerId = Objects.requireNonNull($.secretManagerId, "expected parameter 'secretManagerId' to be non-null");
            return $;
        }
    }

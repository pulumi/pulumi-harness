...
@CustomType
public final class GetKubernetesUsernamePassword {
    private String masterUrl;
    private String passwordRef;
    private String username;
    private String usernameRef;

    private GetKubernetesUsernamePassword() {}
    ...
    public static Builder builder(GetKubernetesUsernamePassword defaults) {
    ...
    public static final class Builder {
        ...
        private String usernameRef;
        public Builder() {}
        public Builder(GetKubernetesUsernamePassword defaults) {
        ...
        public GetKubernetesUsernamePassword build() {
            final var o = new GetKubernetesUsernamePassword();

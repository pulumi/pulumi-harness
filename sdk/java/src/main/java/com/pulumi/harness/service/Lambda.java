...
public class Lambda extends com.pulumi.resources.CustomResource {
    ...
    public Lambda(java.lang.String name, LambdaArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:service/lambda:Lambda", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Lambda(java.lang.String name, Output<java.lang.String> id, @Nullable LambdaState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:service/lambda:Lambda", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static Lambda get(java.lang.String name, Output<java.lang.String> id, @Nullable LambdaState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

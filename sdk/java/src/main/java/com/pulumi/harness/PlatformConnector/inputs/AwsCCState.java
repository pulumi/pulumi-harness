...
import com.pulumi.harness.PlatformConnector.inputs.AwsCCCrossAccountAccessArgs;
...
public final class AwsCCState extends com.pulumi.resources.ResourceArgs {

    public static final AwsCCState Empty = new AwsCCState();
    ...
    private @Nullable Output<AwsCCCrossAccountAccessArgs> crossAccountAccess;
     ...
     * 
     */
    public Optional<Output<AwsCCCrossAccountAccessArgs>> crossAccountAccess() {
    ...
    public static Builder builder(AwsCCState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AwsCCState defaults) {
            $ = new AwsCCState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder crossAccountAccess(@Nullable Output<AwsCCCrossAccountAccessArgs> crossAccountAccess) {
         ...
         * 
         */
        public Builder crossAccountAccess(AwsCCCrossAccountAccessArgs crossAccountAccess) {

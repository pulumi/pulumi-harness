...
public final class ServiceNowConnectorAuthUsernamePasswordArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceNowConnectorAuthUsernamePasswordArgs Empty = new ServiceNowConnectorAuthUsernamePasswordArgs();
    ...
    private ServiceNowConnectorAuthUsernamePasswordArgs() {}

    private ServiceNowConnectorAuthUsernamePasswordArgs(ServiceNowConnectorAuthUsernamePasswordArgs $) {
    ...
    public static Builder builder(ServiceNowConnectorAuthUsernamePasswordArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceNowConnectorAuthUsernamePasswordArgs();
        }

        public Builder(ServiceNowConnectorAuthUsernamePasswordArgs defaults) {
            $ = new ServiceNowConnectorAuthUsernamePasswordArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceNowConnectorAuthUsernamePasswordArgs build() {
            if ($.passwordRef == null) {
                throw new MissingRequiredPropertyException("ServiceNowConnectorAuthUsernamePasswordArgs", "passwordRef");
            }
            return $;
        }
    }

...
@CustomType
public final class ActionTemplateContainerActionResources {
    /**
    ...
    private ActionTemplateContainerActionResources() {}
    /**
     * @return Resource limits.
     * 
     */
    ...
    public static Builder builder(ActionTemplateContainerActionResources defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,String> requests;
        public Builder() {}
        public Builder(ActionTemplateContainerActionResources defaults) {
        ...
        public ActionTemplateContainerActionResources build() {
            final var _resultValue = new ActionTemplateContainerActionResources();

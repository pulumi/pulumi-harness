...
@CustomType
public final class GetAwsConnectorOidcAuthentication {
    /**
    ...
    private GetAwsConnectorOidcAuthentication() {}
    /**
     * @return The delegates to inherit the credentials from.
     * 
     */
    ...
    public static Builder builder(GetAwsConnectorOidcAuthentication defaults) {
    ...
    public static final class Builder {
        ...
        public Builder delegateSelectors(List<String> delegateSelectors) {
            if (delegateSelectors == null) {
              throw new MissingRequiredPropertyException("GetAwsConnectorOidcAuthentication", "delegateSelectors");
            }
        ...
        public Builder iamRoleArn(String iamRoleArn) {
            if (iamRoleArn == null) {
              throw new MissingRequiredPropertyException("GetAwsConnectorOidcAuthentication", "iamRoleArn");
            }
        ...
        public GetAwsConnectorOidcAuthentication build() {

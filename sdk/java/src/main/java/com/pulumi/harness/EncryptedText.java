...
public class EncryptedText extends com.pulumi.resources.CustomResource {
     ...
     */
    public EncryptedText(String name) {
     ...
     */
    public EncryptedText(String name, EncryptedTextArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:index/encryptedText:EncryptedText", name, args == null ? EncryptedTextArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private EncryptedText(String name, Output<String> id, @Nullable EncryptedTextState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:index/encryptedText:EncryptedText", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static EncryptedText get(String name, Output<String> id, @Nullable EncryptedTextState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

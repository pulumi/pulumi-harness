...
public final class InputSetGitImportInfoArgs extends com.pulumi.resources.ResourceArgs {

    public static final InputSetGitImportInfoArgs Empty = new InputSetGitImportInfoArgs();
    ...
    private InputSetGitImportInfoArgs() {}

    private InputSetGitImportInfoArgs(InputSetGitImportInfoArgs $) {
    ...
    public static Builder builder(InputSetGitImportInfoArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InputSetGitImportInfoArgs();
        }

        public Builder(InputSetGitImportInfoArgs defaults) {
            $ = new InputSetGitImportInfoArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InputSetGitImportInfoArgs build() {
            return $;
        }
    }

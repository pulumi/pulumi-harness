...
import com.pulumi.harness.PlatformConnector.inputs.NexusCredentialsArgs;
...
public final class NexusArgs extends com.pulumi.resources.ResourceArgs {

    public static final NexusArgs Empty = new NexusArgs();
    ...
    private @Nullable Output<NexusCredentialsArgs> credentials;

    /**
     * @return Credentials to use for authentication.
     * 
     */
    public Optional<Output<NexusCredentialsArgs>> credentials() {
    ...
    public static Builder builder(NexusArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(NexusArgs defaults) {
            $ = new NexusArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder credentials(@Nullable Output<NexusCredentialsArgs> credentials) {
         ...
         * 
         */
        public Builder credentials(NexusCredentialsArgs credentials) {

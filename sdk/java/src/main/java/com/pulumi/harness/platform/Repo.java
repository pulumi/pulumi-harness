...
public class Repo extends com.pulumi.resources.CustomResource {
    ...
    public Repo(String name, RepoArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/repo:Repo", name, args == null ? RepoArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Repo(String name, Output<String> id, @Nullable RepoState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/repo:Repo", name, state, makeResourceOptions(options, id));
    }

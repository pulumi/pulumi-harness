...
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubTokenRefArgs;
...
public final class GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubArgs Empty = new GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubArgs();
    ...
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubTokenRefArgs> tokenRef;

    /**
     * @return Authentication token reference.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubTokenRefArgs>> tokenRef() {
        return Optional.ofNullable(this.tokenRef);
    }

    private GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubArgs() {}

    private GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubArgs(GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubArgs $) {
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder tokenRef(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubTokenRefArgs> tokenRef) {
            $.tokenRef = tokenRef;
            return this;
        }
         ...
         * 
         */
        public Builder tokenRef(GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubTokenRefArgs tokenRef) {
            return tokenRef(Output.of(tokenRef));
        }

        public GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubArgs build() {
            if ($.organization == null) {
                throw new MissingRequiredPropertyException("GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGithubArgs", "organization");
            }
            return $;
        }
    }

...
public final class KubernetesState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<KubernetesAuthenticationArgs> authentication;

    /**
     * @return Authentication configuration for the Kubernetes cluster
     * 
     */
    public Optional<Output<KubernetesAuthenticationArgs>> authentication() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder authentication(@Nullable Output<KubernetesAuthenticationArgs> authentication) {

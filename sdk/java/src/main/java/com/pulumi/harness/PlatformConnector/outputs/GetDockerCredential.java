...
@CustomType
public final class GetDockerCredential {
    private String passwordRef;
    private String username;
    private String usernameRef;

    private GetDockerCredential() {}
    ...
    public static Builder builder(GetDockerCredential defaults) {
    ...
    public static final class Builder {
        ...
        private String usernameRef;
        public Builder() {}
        public Builder(GetDockerCredential defaults) {
        ...
        public GetDockerCredential build() {
            final var o = new GetDockerCredential();

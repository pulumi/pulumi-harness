...
@CustomType
public final class GitCredentialsHttp {
    private String passwordRef;
    private @Nullable String username;
    private @Nullable String usernameRef;

    private GitCredentialsHttp() {}
    ...
    public static Builder builder(GitCredentialsHttp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(GitCredentialsHttp defaults) {
        ...
        public GitCredentialsHttp build() {
            final var o = new GitCredentialsHttp();

...
public final class GetTokenArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetTokenArgs build() {
            ...
            if ($.apikeyId == null) {
                throw new MissingRequiredPropertyException("GetTokenArgs", "apikeyId");
            }
            if ($.apikeyType == null) {
                throw new MissingRequiredPropertyException("GetTokenArgs", "apikeyType");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("GetTokenArgs", "identifier");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetTokenArgs", "name");
            }
            if ($.parentId == null) {
                throw new MissingRequiredPropertyException("GetTokenArgs", "parentId");
            }
            return $;
        }
    }

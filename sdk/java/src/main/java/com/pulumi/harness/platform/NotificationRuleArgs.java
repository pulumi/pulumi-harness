...
public final class NotificationRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public NotificationRuleArgs build() {
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("NotificationRuleArgs", "identifier");
            }
            if ($.orgId == null) {
                throw new MissingRequiredPropertyException("NotificationRuleArgs", "orgId");
            }
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("NotificationRuleArgs", "projectId");
            }
            return $;
        }
    }

    ...
    public static final class Builder {
        ...
        public TasConnectorCredentialsArgs build() {
            if ($.tasManualDetails == null) {
                throw new MissingRequiredPropertyException("TasConnectorCredentialsArgs", "tasManualDetails");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("TasConnectorCredentialsArgs", "type");
            }
            return $;
        }
    }

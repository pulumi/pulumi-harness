...
public final class CcmFiltersState extends com.pulumi.resources.ResourceArgs {

    public static final CcmFiltersState Empty = new CcmFiltersState();
    ...
    private @Nullable Output<CcmFiltersFilterPropertiesArgs> filterProperties;

    /**
     * @return Properties of the filters entity defined in Harness.
     * 
     */
    public Optional<Output<CcmFiltersFilterPropertiesArgs>> filterProperties() {
    ...
    private CcmFiltersState() {}

    private CcmFiltersState(CcmFiltersState $) {
    ...
    public static Builder builder(CcmFiltersState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CcmFiltersState defaults) {
            $ = new CcmFiltersState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder filterProperties(@Nullable Output<CcmFiltersFilterPropertiesArgs> filterProperties) {

...
public class ManualFreeze extends com.pulumi.resources.CustomResource {
     ...
     */
    public ManualFreeze(String name) {
     ...
     */
    public ManualFreeze(String name, ManualFreezeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/manualFreeze:ManualFreeze", name, args == null ? ManualFreezeArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ManualFreeze(String name, Output<String> id, @Nullable ManualFreezeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/manualFreeze:ManualFreeze", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static ManualFreeze get(String name, Output<String> id, @Nullable ManualFreezeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

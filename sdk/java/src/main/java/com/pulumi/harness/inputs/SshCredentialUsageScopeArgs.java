...
public final class SshCredentialUsageScopeArgs extends com.pulumi.resources.ResourceArgs {

    public static final SshCredentialUsageScopeArgs Empty = new SshCredentialUsageScopeArgs();
    ...
    private SshCredentialUsageScopeArgs() {}

    private SshCredentialUsageScopeArgs(SshCredentialUsageScopeArgs $) {
    ...
    public static Builder builder(SshCredentialUsageScopeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SshCredentialUsageScopeArgs();
        }

        public Builder(SshCredentialUsageScopeArgs defaults) {
            $ = new SshCredentialUsageScopeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SshCredentialUsageScopeArgs build() {
            return $;
        }
    }

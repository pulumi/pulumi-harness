...
public final class TasConnectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final TasConnectorArgs Empty = new TasConnectorArgs();
    ...
    private Output<TasConnectorCredentialsArgs> credentials;

    /**
     * @return Contains Tas connector credentials.
     * 
     */
    public Output<TasConnectorCredentialsArgs> credentials() {
    ...
    private TasConnectorArgs() {}

    private TasConnectorArgs(TasConnectorArgs $) {
    ...
    public static Builder builder(TasConnectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TasConnectorArgs();
        }

        public Builder(TasConnectorArgs defaults) {
            $ = new TasConnectorArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder credentials(Output<TasConnectorCredentialsArgs> credentials) {
         ...
         * 
         */
        public Builder credentials(TasConnectorCredentialsArgs credentials) {
        ...
        public TasConnectorArgs build() {
            if ($.credentials == null) {
                throw new MissingRequiredPropertyException("TasConnectorArgs", "credentials");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("TasConnectorArgs", "identifier");
            }
            return $;
        }
    }

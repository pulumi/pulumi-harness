...
@CustomType
public final class GetAwsSecretManagerCredentialManual {
    private String accessKeyRef;
    private String secretKeyRef;

    private GetAwsSecretManagerCredentialManual() {}
    ...
    public static Builder builder(GetAwsSecretManagerCredentialManual defaults) {
    ...
    public static final class Builder {
        ...
        private String secretKeyRef;
        public Builder() {}
        public Builder(GetAwsSecretManagerCredentialManual defaults) {
        ...
        public GetAwsSecretManagerCredentialManual build() {
            final var o = new GetAwsSecretManagerCredentialManual();

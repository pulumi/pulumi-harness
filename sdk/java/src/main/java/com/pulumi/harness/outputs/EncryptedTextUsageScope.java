...
@CustomType
public final class EncryptedTextUsageScope {
    /**
    ...
    private EncryptedTextUsageScope() {}
    /**
     * @return Id of the application to scope to. If empty then this scope applies to all applications.
     * 
     */
    ...
    public static Builder builder(EncryptedTextUsageScope defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String environmentId;
        public Builder() {}
        public Builder(EncryptedTextUsageScope defaults) {
        ...
        public EncryptedTextUsageScope build() {
            final var _resultValue = new EncryptedTextUsageScope();

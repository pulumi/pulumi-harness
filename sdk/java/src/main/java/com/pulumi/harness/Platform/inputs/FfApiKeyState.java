...
public final class FfApiKeyState extends com.pulumi.resources.ResourceArgs {

    public static final FfApiKeyState Empty = new FfApiKeyState();
    ...
    private FfApiKeyState() {}

    private FfApiKeyState(FfApiKeyState $) {
        this.apiKey = $.apiKey;
    ...
    public static Builder builder(FfApiKeyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FfApiKeyState defaults) {
            $ = new FfApiKeyState(Objects.requireNonNull(defaults));
        }

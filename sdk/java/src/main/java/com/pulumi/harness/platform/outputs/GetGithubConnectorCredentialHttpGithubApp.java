...
@CustomType
public final class GetGithubConnectorCredentialHttpGithubApp {
    /**
    ...
    private GetGithubConnectorCredentialHttpGithubApp() {}
    /**
     * @return Enter the GitHub App ID from the GitHub App General tab.
     * 
     */
    ...
    public static Builder builder(GetGithubConnectorCredentialHttpGithubApp defaults) {
    ...
    public static final class Builder {
        ...
        private String privateKeyRef;
        public Builder() {}
        public Builder(GetGithubConnectorCredentialHttpGithubApp defaults) {
        ...
        public Builder applicationId(String applicationId) {
            if (applicationId == null) {
              throw new MissingRequiredPropertyException("GetGithubConnectorCredentialHttpGithubApp", "applicationId");
            }
        ...
        public Builder applicationIdRef(String applicationIdRef) {
            if (applicationIdRef == null) {
              throw new MissingRequiredPropertyException("GetGithubConnectorCredentialHttpGithubApp", "applicationIdRef");
            }
        ...
        public Builder installationId(String installationId) {
            if (installationId == null) {
              throw new MissingRequiredPropertyException("GetGithubConnectorCredentialHttpGithubApp", "installationId");
            }
        ...
        public Builder installationIdRef(String installationIdRef) {
            if (installationIdRef == null) {
              throw new MissingRequiredPropertyException("GetGithubConnectorCredentialHttpGithubApp", "installationIdRef");
            }
        ...
        public Builder privateKeyRef(String privateKeyRef) {
            if (privateKeyRef == null) {
              throw new MissingRequiredPropertyException("GetGithubConnectorCredentialHttpGithubApp", "privateKeyRef");
            }
            this.privateKeyRef = privateKeyRef;
            return this;
        }
        public GetGithubConnectorCredentialHttpGithubApp build() {
            final var _resultValue = new GetGithubConnectorCredentialHttpGithubApp();

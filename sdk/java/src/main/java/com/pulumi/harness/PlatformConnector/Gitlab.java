...
import com.pulumi.harness.PlatformConnector.GitlabArgs;
import com.pulumi.harness.PlatformConnector.inputs.GitlabState;
import com.pulumi.harness.PlatformConnector.outputs.GitlabApiAuthentication;
import com.pulumi.harness.PlatformConnector.outputs.GitlabCredentials;
 ...
 * 
 */
@ResourceType(type="harness:PlatformConnector/gitlab:Gitlab")
public class Gitlab extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="apiAuthentication", type=GitlabApiAuthentication.class, parameters={})
    private Output</* @Nullable */ GitlabApiAuthentication> apiAuthentication;
     ...
     * 
     */
    public Output<Optional<GitlabApiAuthentication>> apiAuthentication() {
     ...
     * 
     */
    @Export(name="credentials", type=GitlabCredentials.class, parameters={})
    private Output<GitlabCredentials> credentials;

    /**
     * @return Credentials to use for the connection.
     * 
     */
    public Output<GitlabCredentials> credentials() {
     ...
     */
    public Gitlab(String name) {
        this(name, GitlabArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public Gitlab(String name, GitlabArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Gitlab(String name, GitlabArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:PlatformConnector/gitlab:Gitlab", name, args == null ? GitlabArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Gitlab(String name, Output<String> id, @Nullable GitlabState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:PlatformConnector/gitlab:Gitlab", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static Gitlab get(String name, Output<String> id, @Nullable GitlabState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

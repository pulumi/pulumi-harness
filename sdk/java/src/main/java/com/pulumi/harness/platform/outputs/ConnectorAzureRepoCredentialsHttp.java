...
@CustomType
public final class ConnectorAzureRepoCredentialsHttp {
    /**
    ...
    private ConnectorAzureRepoCredentialsHttp() {}
    /**
     * @return Reference to a secret containing the personal access to use for authentication. To reference a secret at the organization scope, prefix &#39;org&#39; to the expression: org.{identifier}. To reference a secret at the account scope, prefix &#39;account` to the expression: account.{identifier}.
     * 
     */
    ...
    public static Builder builder(ConnectorAzureRepoCredentialsHttp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(ConnectorAzureRepoCredentialsHttp defaults) {
        ...
        public Builder tokenRef(String tokenRef) {
            if (tokenRef == null) {
              throw new MissingRequiredPropertyException("ConnectorAzureRepoCredentialsHttp", "tokenRef");
            }
        ...
        public ConnectorAzureRepoCredentialsHttp build() {
            final var _resultValue = new ConnectorAzureRepoCredentialsHttp();

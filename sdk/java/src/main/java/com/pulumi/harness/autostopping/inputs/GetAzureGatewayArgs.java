...
public final class GetAzureGatewayArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetAzureGatewayArgs Empty = new GetAzureGatewayArgs();
    ...
    private GetAzureGatewayArgs() {}

    private GetAzureGatewayArgs(GetAzureGatewayArgs $) {
    ...
    public static Builder builder(GetAzureGatewayArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAzureGatewayArgs();
        }

        public Builder(GetAzureGatewayArgs defaults) {
            $ = new GetAzureGatewayArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAzureGatewayArgs build() {
            if ($.azureFuncRegion == null) {
                throw new MissingRequiredPropertyException("GetAzureGatewayArgs", "azureFuncRegion");
            }
            if ($.cloudConnectorId == null) {
                throw new MissingRequiredPropertyException("GetAzureGatewayArgs", "cloudConnectorId");
            }
            ...
            if ($.region == null) {
                throw new MissingRequiredPropertyException("GetAzureGatewayArgs", "region");
            }
            if ($.resourceGroup == null) {
                throw new MissingRequiredPropertyException("GetAzureGatewayArgs", "resourceGroup");
            }
            if ($.vpc == null) {
                throw new MissingRequiredPropertyException("GetAzureGatewayArgs", "vpc");
            }
            return $;
        }
    }

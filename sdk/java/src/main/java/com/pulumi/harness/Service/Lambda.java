...
import com.pulumi.harness.service.inputs.LambdaState;
import com.pulumi.harness.service.outputs.LambdaVariable;
 ...
 * 
 */
@ResourceType(type="harness:service/lambda:Lambda")
public class Lambda extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="variables", type=List.class, parameters={LambdaVariable.class})
    private Output</* @Nullable */ List<LambdaVariable>> variables;

    /**
     * @return Variables to be used in the service
     * 
     */
    public Output<Optional<List<LambdaVariable>>> variables() {
     ...
     */
    public Lambda(String name, LambdaArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:service/lambda:Lambda", name, args == null ? LambdaArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Lambda(String name, Output<String> id, @Nullable LambdaState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:service/lambda:Lambda", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static Lambda get(String name, Output<String> id, @Nullable LambdaState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

...
@CustomType
public final class GetConnectorGcpKmsOidcAuthentication {
    /**
    ...
    private GetConnectorGcpKmsOidcAuthentication() {}
    /**
     * @return The delegates to inherit the credentials from.
     * 
     */
    ...
    public static Builder builder(GetConnectorGcpKmsOidcAuthentication defaults) {
    ...
    public static final class Builder {
        ...
        private String workloadPoolId;
        public Builder() {}
        public Builder(GetConnectorGcpKmsOidcAuthentication defaults) {
        ...
        public Builder delegateSelectors(List<String> delegateSelectors) {
            if (delegateSelectors == null) {
              throw new MissingRequiredPropertyException("GetConnectorGcpKmsOidcAuthentication", "delegateSelectors");
            }
        ...
        public Builder gcpProjectId(String gcpProjectId) {
            if (gcpProjectId == null) {
              throw new MissingRequiredPropertyException("GetConnectorGcpKmsOidcAuthentication", "gcpProjectId");
            }
        ...
        public Builder providerId(String providerId) {
            if (providerId == null) {
              throw new MissingRequiredPropertyException("GetConnectorGcpKmsOidcAuthentication", "providerId");
            }
        ...
        public Builder serviceAccountEmail(String serviceAccountEmail) {
            if (serviceAccountEmail == null) {
              throw new MissingRequiredPropertyException("GetConnectorGcpKmsOidcAuthentication", "serviceAccountEmail");
            }
        ...
        public Builder workloadPoolId(String workloadPoolId) {
            if (workloadPoolId == null) {
              throw new MissingRequiredPropertyException("GetConnectorGcpKmsOidcAuthentication", "workloadPoolId");
            }
            this.workloadPoolId = workloadPoolId;
            return this;
        }
        public GetConnectorGcpKmsOidcAuthentication build() {
            final var _resultValue = new GetConnectorGcpKmsOidcAuthentication();

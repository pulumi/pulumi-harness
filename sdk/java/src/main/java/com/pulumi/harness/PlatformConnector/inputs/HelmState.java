...
public final class HelmState extends com.pulumi.resources.ResourceArgs {

    public static final HelmState Empty = new HelmState();
    ...
    public static Builder builder(HelmState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HelmState defaults) {
            $ = new HelmState(Objects.requireNonNull(defaults));
        }

...
public final class GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorGitTemplateMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorGitTemplateMetadataArgs Empty = new GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorGitTemplateMetadataArgs();
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorGitTemplateMetadataArgs() {}

    private GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorGitTemplateMetadataArgs(GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorGitTemplateMetadataArgs $) {
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorGitTemplateMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorGitTemplateMetadataArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorGitTemplateMetadataArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorGitTemplateMetadataArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorGitTemplateMetadataArgs build() {
            return $;
        }
    }

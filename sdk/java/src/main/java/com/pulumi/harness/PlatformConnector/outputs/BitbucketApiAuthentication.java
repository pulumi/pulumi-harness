...
@CustomType
public final class BitbucketApiAuthentication {
    /**
    ...
    public static Builder builder(BitbucketApiAuthentication defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(BitbucketApiAuthentication defaults) {
        ...
        public BitbucketApiAuthentication build() {
            final var o = new BitbucketApiAuthentication();
            o.tokenRef = tokenRef;
            o.username = username;

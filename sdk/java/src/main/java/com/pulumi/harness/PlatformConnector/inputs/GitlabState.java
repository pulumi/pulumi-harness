...
import com.pulumi.harness.PlatformConnector.inputs.GitlabApiAuthenticationArgs;
import com.pulumi.harness.PlatformConnector.inputs.GitlabCredentialsArgs;
...
public final class GitlabState extends com.pulumi.resources.ResourceArgs {

    public static final GitlabState Empty = new GitlabState();
    ...
    private @Nullable Output<GitlabApiAuthenticationArgs> apiAuthentication;
     ...
     * 
     */
    public Optional<Output<GitlabApiAuthenticationArgs>> apiAuthentication() {
    ...
    private @Nullable Output<GitlabCredentialsArgs> credentials;

    /**
     * @return Credentials to use for the connection.
     * 
     */
    public Optional<Output<GitlabCredentialsArgs>> credentials() {
    ...
    private GitlabState(GitlabState $) {
    ...
    public static Builder builder(GitlabState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GitlabState defaults) {
            $ = new GitlabState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder apiAuthentication(@Nullable Output<GitlabApiAuthenticationArgs> apiAuthentication) {
         ...
         * 
         */
        public Builder apiAuthentication(GitlabApiAuthenticationArgs apiAuthentication) {
         ...
         * 
         */
        public Builder credentials(@Nullable Output<GitlabCredentialsArgs> credentials) {
         ...
         * 
         */
        public Builder credentials(GitlabCredentialsArgs credentials) {

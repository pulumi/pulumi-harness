...
import com.pulumi.harness.platform.inputs.GitopsProjectProjectArgs;
...
public final class GitopsProjectArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsProjectArgs Empty = new GitopsProjectArgs();
    ...
    private Output<List<GitopsProjectProjectArgs>> projects;

    /**
     * @return App projects configuration details.
     * 
     */
    public Output<List<GitopsProjectProjectArgs>> projects() {
    ...
    private GitopsProjectArgs() {}

    private GitopsProjectArgs(GitopsProjectArgs $) {
    ...
    public static Builder builder(GitopsProjectArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsProjectArgs();
        }

        public Builder(GitopsProjectArgs defaults) {
            $ = new GitopsProjectArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder projects(Output<List<GitopsProjectProjectArgs>> projects) {
            $.projects = projects;
            return this;
        }
         ...
         * 
         */
        public Builder projects(List<GitopsProjectProjectArgs> projects) {
         ...
         * 
         */
        public Builder projects(GitopsProjectProjectArgs... projects) {
        ...
        public GitopsProjectArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GitopsProjectArgs", "accountId");
            }
            if ($.agentId == null) {
                throw new MissingRequiredPropertyException("GitopsProjectArgs", "agentId");
            }
            if ($.projects == null) {
                throw new MissingRequiredPropertyException("GitopsProjectArgs", "projects");
            }
            return $;
        }
    }

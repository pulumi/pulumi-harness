...
public final class RuleScaleGroupHttpRouting {
    ...
    public static Builder builder(RuleScaleGroupHttpRouting defaults) {
    ...
    public static final class Builder {
        ...
        public Builder sourceProtocol(String sourceProtocol) {
            if (sourceProtocol == null) {
              throw new MissingRequiredPropertyException("RuleScaleGroupHttpRouting", "sourceProtocol");
            }
        ...
        public Builder targetProtocol(String targetProtocol) {
            if (targetProtocol == null) {
              throw new MissingRequiredPropertyException("RuleScaleGroupHttpRouting", "targetProtocol");
            }

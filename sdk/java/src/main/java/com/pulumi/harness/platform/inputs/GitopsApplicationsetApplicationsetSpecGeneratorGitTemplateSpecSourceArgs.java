...
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceHelmArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceKustomizeArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourcePluginArgs;
...
public final class GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceArgs Empty = new GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceArgs();
    ...
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs> directory;

    /**
     * @return Path/directory specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs>> directory() {
     ...
     */
    @Import(name="helm")
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceHelmArgs> helm;

    /**
     * @return Helm specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceHelmArgs>> helm() {
    ...
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceKustomizeArgs> kustomize;

    /**
     * @return Kustomize specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceKustomizeArgs>> kustomize() {
     ...
     */
    @Import(name="plugin")
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourcePluginArgs> plugin;

    /**
     * @return Config management plugin specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourcePluginArgs>> plugin() {
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceArgs() {}

    private GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceArgs(GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceArgs $) {
        this.chart = $.chart;
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder directory(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs> directory) {
            $.directory = directory;
            return this;
        }
         ...
         * 
         */
        public Builder directory(GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs directory) {
         ...
         * 
         */
        public Builder helm(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceHelmArgs> helm) {
            $.helm = helm;
            return this;
        }
         ...
         * 
         */
        public Builder helm(GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceHelmArgs helm) {
         ...
         * 
         */
        public Builder kustomize(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceKustomizeArgs> kustomize) {
            $.kustomize = kustomize;
            return this;
        }
         ...
         * 
         */
        public Builder kustomize(GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceKustomizeArgs kustomize) {
         ...
         * 
         */
        public Builder plugin(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourcePluginArgs> plugin) {
            $.plugin = plugin;
            return this;
        }
         ...
         * 
         */
        public Builder plugin(GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourcePluginArgs plugin) {
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceArgs build() {
            return $;
        }
    }

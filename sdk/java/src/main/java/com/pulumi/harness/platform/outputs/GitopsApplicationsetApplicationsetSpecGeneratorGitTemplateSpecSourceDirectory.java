...
import com.pulumi.harness.platform.outputs.GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryJsonnet;
...
@CustomType
public final class GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectory {
    /**
     ...
     * 
     */
    private @Nullable GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryJsonnet jsonnet;
    /**
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectory() {}
    /**
     * @return Glob pattern to match paths against that should be explicitly excluded from being used during manifest generation. This takes precedence over the `include` field. To match multiple patterns, wrap the patterns in {} and separate them with commas. For example: &#39;{config.yaml,env-use2/*}&#39;
     * 
     */
     ...
     * 
     */
    public Optional<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryJsonnet> jsonnet() {
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean recurse;
        public Builder() {}
        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectory defaults) {
        ...
        @CustomType.Setter
        public Builder jsonnet(@Nullable GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryJsonnet jsonnet) {
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectory build() {
            final var _resultValue = new GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectory();

...
public final class GetSecretFileAdditionalMetadataValueArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetSecretFileAdditionalMetadataValueArgs Empty = new GetSecretFileAdditionalMetadataValueArgs();
    ...
    private GetSecretFileAdditionalMetadataValueArgs() {}

    private GetSecretFileAdditionalMetadataValueArgs(GetSecretFileAdditionalMetadataValueArgs $) {
    ...
    public static Builder builder(GetSecretFileAdditionalMetadataValueArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSecretFileAdditionalMetadataValueArgs();
        }

        public Builder(GetSecretFileAdditionalMetadataValueArgs defaults) {
            $ = new GetSecretFileAdditionalMetadataValueArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSecretFileAdditionalMetadataValueArgs build() {
            return $;
        }
    }

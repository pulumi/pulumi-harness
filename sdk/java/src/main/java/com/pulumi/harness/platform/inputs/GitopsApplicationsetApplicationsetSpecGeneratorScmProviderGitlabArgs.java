...
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabCaRefArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabTokenRefArgs;
...
public final class GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabArgs Empty = new GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabArgs();
     ...
     */
    @Import(name="caRef")
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabCaRefArgs> caRef;

    /**
     * @return Reference to a ConfigMap containing a CA certificate for self-signed GitLab instances.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabCaRefArgs>> caRef() {
    ...
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabTokenRefArgs> tokenRef;

    /**
     * @return Authentication token reference.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabTokenRefArgs>> tokenRef() {
        return Optional.ofNullable(this.tokenRef);
    }

    private GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabArgs() {}

    private GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabArgs(GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabArgs $) {
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder caRef(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabCaRefArgs> caRef) {
            $.caRef = caRef;
            return this;
        }
         ...
         * 
         */
        public Builder caRef(GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabCaRefArgs caRef) {
         ...
         * 
         */
        public Builder tokenRef(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabTokenRefArgs> tokenRef) {
            $.tokenRef = tokenRef;
            return this;
        }
         ...
         * 
         */
        public Builder tokenRef(GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabTokenRefArgs tokenRef) {
            return tokenRef(Output.of(tokenRef));
        }

        public GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabArgs build() {
            if ($.group == null) {
                throw new MissingRequiredPropertyException("GitopsApplicationsetApplicationsetSpecGeneratorScmProviderGitlabArgs", "group");
            }
            return $;
        }
    }

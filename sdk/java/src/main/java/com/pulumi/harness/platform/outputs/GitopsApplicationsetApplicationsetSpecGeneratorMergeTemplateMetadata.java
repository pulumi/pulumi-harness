...
@CustomType
public final class GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateMetadata {
    /**
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateMetadata() {}
    /**
     * @return An unstructured key value map that may be used to store arbitrary metadata for the resulting Application.
     * 
     */
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String namespace;
        public Builder() {}
        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateMetadata defaults) {
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateMetadata build() {
            final var _resultValue = new GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateMetadata();

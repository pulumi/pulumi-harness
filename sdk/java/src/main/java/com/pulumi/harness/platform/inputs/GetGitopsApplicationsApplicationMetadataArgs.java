...
public final class GetGitopsApplicationsApplicationMetadataArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetGitopsApplicationsApplicationMetadataArgs build() {
            if ($.annotations == null) {
                throw new MissingRequiredPropertyException("GetGitopsApplicationsApplicationMetadataArgs", "annotations");
            }
            if ($.finalizers == null) {
                throw new MissingRequiredPropertyException("GetGitopsApplicationsApplicationMetadataArgs", "finalizers");
            }
            if ($.generation == null) {
                throw new MissingRequiredPropertyException("GetGitopsApplicationsApplicationMetadataArgs", "generation");
            }
            if ($.labels == null) {
                throw new MissingRequiredPropertyException("GetGitopsApplicationsApplicationMetadataArgs", "labels");
            }
            if ($.namespace == null) {
                throw new MissingRequiredPropertyException("GetGitopsApplicationsApplicationMetadataArgs", "namespace");
            }
            if ($.uid == null) {
                throw new MissingRequiredPropertyException("GetGitopsApplicationsApplicationMetadataArgs", "uid");
            }
            return $;
        }
    }

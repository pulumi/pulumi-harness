...
public final class GetPagerdutyConnectorResult {
    ...
    public static final class Builder {
        ...
        public Builder apiTokenRef(String apiTokenRef) {
            if (apiTokenRef == null) {
              throw new MissingRequiredPropertyException("GetPagerdutyConnectorResult", "apiTokenRef");
            }
        ...
        public Builder delegateSelectors(List<String> delegateSelectors) {
            if (delegateSelectors == null) {
              throw new MissingRequiredPropertyException("GetPagerdutyConnectorResult", "delegateSelectors");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetPagerdutyConnectorResult", "description");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetPagerdutyConnectorResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder identifier(String identifier) {
            if (identifier == null) {
              throw new MissingRequiredPropertyException("GetPagerdutyConnectorResult", "identifier");
            }
        ...
        public Builder tags(List<String> tags) {
            if (tags == null) {
              throw new MissingRequiredPropertyException("GetPagerdutyConnectorResult", "tags");
            }
            this.tags = tags;
            return this;
        }
        ...
        public GetPagerdutyConnectorResult build() {
            final var _resultValue = new GetPagerdutyConnectorResult();

...
import com.pulumi.harness.PlatformConnector.BitbucketArgs;
import com.pulumi.harness.PlatformConnector.inputs.BitbucketState;
import com.pulumi.harness.PlatformConnector.outputs.BitbucketApiAuthentication;
import com.pulumi.harness.PlatformConnector.outputs.BitbucketCredentials;
 ...
 * 
 */
@ResourceType(type="harness:PlatformConnector/bitbucket:Bitbucket")
public class Bitbucket extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="apiAuthentication", type=BitbucketApiAuthentication.class, parameters={})
    private Output</* @Nullable */ BitbucketApiAuthentication> apiAuthentication;
     ...
     * 
     */
    public Output<Optional<BitbucketApiAuthentication>> apiAuthentication() {
     ...
     * 
     */
    @Export(name="credentials", type=BitbucketCredentials.class, parameters={})
    private Output<BitbucketCredentials> credentials;

    /**
     * @return Credentials to use for the connection.
     * 
     */
    public Output<BitbucketCredentials> credentials() {
    ...
    public Bitbucket(String name, BitbucketArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:PlatformConnector/bitbucket:Bitbucket", name, args == null ? BitbucketArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Bitbucket(String name, Output<String> id, @Nullable BitbucketState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:PlatformConnector/bitbucket:Bitbucket", name, state, makeResourceOptions(options, id));
    }

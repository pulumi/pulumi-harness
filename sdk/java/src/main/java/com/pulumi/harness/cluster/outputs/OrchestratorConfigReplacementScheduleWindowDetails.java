...
@CustomType
public final class OrchestratorConfigReplacementScheduleWindowDetails {
    ...
    private OrchestratorConfigReplacementScheduleWindowDetails() {}
    ...
    public static Builder builder(OrchestratorConfigReplacementScheduleWindowDetails defaults) {
    ...
    public static final class Builder {
        ...
        private String timeZone;
        public Builder() {}
        public Builder(OrchestratorConfigReplacementScheduleWindowDetails defaults) {
        ...
        public Builder days(List<String> days) {
            if (days == null) {
              throw new MissingRequiredPropertyException("OrchestratorConfigReplacementScheduleWindowDetails", "days");
            }
            this.days = days;
            return this;
        }
        ...
        public Builder timeZone(String timeZone) {
            if (timeZone == null) {
              throw new MissingRequiredPropertyException("OrchestratorConfigReplacementScheduleWindowDetails", "timeZone");
            }
            this.timeZone = timeZone;
            return this;
        }
        public OrchestratorConfigReplacementScheduleWindowDetails build() {
            final var _resultValue = new OrchestratorConfigReplacementScheduleWindowDetails();

...
public final class ConnectorJdbcCredentialsInheritFromDelegateArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConnectorJdbcCredentialsInheritFromDelegateArgs Empty = new ConnectorJdbcCredentialsInheritFromDelegateArgs();
    ...
    private ConnectorJdbcCredentialsInheritFromDelegateArgs() {}

    private ConnectorJdbcCredentialsInheritFromDelegateArgs(ConnectorJdbcCredentialsInheritFromDelegateArgs $) {
    ...
    public static Builder builder(ConnectorJdbcCredentialsInheritFromDelegateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectorJdbcCredentialsInheritFromDelegateArgs();
        }

        public Builder(ConnectorJdbcCredentialsInheritFromDelegateArgs defaults) {
            $ = new ConnectorJdbcCredentialsInheritFromDelegateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ConnectorJdbcCredentialsInheritFromDelegateArgs build() {
            return $;
        }
    }

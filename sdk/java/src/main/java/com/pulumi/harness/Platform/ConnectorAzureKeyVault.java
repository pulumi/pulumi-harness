...
import com.pulumi.harness.platform.inputs.ConnectorAzureKeyVaultState;
 ...
 * 
 */
@ResourceType(type="harness:platform/connectorAzureKeyVault:ConnectorAzureKeyVault")
public class ConnectorAzureKeyVault extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ConnectorAzureKeyVault(String name) {
        this(name, ConnectorAzureKeyVaultArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ConnectorAzureKeyVault(String name, ConnectorAzureKeyVaultArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ConnectorAzureKeyVault(String name, ConnectorAzureKeyVaultArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/connectorAzureKeyVault:ConnectorAzureKeyVault", name, args == null ? ConnectorAzureKeyVaultArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ConnectorAzureKeyVault(String name, Output<String> id, @Nullable ConnectorAzureKeyVaultState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/connectorAzureKeyVault:ConnectorAzureKeyVault", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static ConnectorAzureKeyVault get(String name, Output<String> id, @Nullable ConnectorAzureKeyVaultState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

...
public final class RuleEcsContainerArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleEcsContainerArgs Empty = new RuleEcsContainerArgs();
    ...
    private RuleEcsContainerArgs() {}

    private RuleEcsContainerArgs(RuleEcsContainerArgs $) {
    ...
    public static Builder builder(RuleEcsContainerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleEcsContainerArgs();
        }

        public Builder(RuleEcsContainerArgs defaults) {
            $ = new RuleEcsContainerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RuleEcsContainerArgs build() {
            if ($.cluster == null) {
                throw new MissingRequiredPropertyException("RuleEcsContainerArgs", "cluster");
            }
            if ($.region == null) {
                throw new MissingRequiredPropertyException("RuleEcsContainerArgs", "region");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("RuleEcsContainerArgs", "service");
            }
            return $;
        }
    }

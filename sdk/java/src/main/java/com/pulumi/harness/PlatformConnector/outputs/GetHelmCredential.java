...
@CustomType
public final class GetHelmCredential {
    private String passwordRef;
    private String username;
    private String usernameRef;

    private GetHelmCredential() {}
    ...
    public static Builder builder(GetHelmCredential defaults) {
    ...
    public static final class Builder {
        ...
        private String usernameRef;
        public Builder() {}
        public Builder(GetHelmCredential defaults) {
        ...
        public GetHelmCredential build() {
            final var o = new GetHelmCredential();

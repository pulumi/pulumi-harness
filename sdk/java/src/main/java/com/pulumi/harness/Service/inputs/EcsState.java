...
public final class EcsState extends com.pulumi.resources.ResourceArgs {

    public static final EcsState Empty = new EcsState();
    ...
    public static Builder builder(EcsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(EcsState defaults) {
            $ = new EcsState(Objects.requireNonNull(defaults));
        }

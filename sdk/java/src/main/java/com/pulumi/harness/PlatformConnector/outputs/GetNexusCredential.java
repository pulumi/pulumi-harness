...
@CustomType
public final class GetNexusCredential {
    private String passwordRef;
    private String username;
    private String usernameRef;

    private GetNexusCredential() {}
    ...
    public static Builder builder(GetNexusCredential defaults) {
    ...
    public static final class Builder {
        ...
        private String usernameRef;
        public Builder() {}
        public Builder(GetNexusCredential defaults) {
        ...
        public GetNexusCredential build() {
            final var o = new GetNexusCredential();

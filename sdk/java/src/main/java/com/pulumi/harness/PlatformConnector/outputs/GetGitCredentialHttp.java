...
@CustomType
public final class GetGitCredentialHttp {
    private String passwordRef;
    private String username;
    private String usernameRef;

    private GetGitCredentialHttp() {}
    ...
    public static Builder builder(GetGitCredentialHttp defaults) {
    ...
    public static final class Builder {
        ...
        private String usernameRef;
        public Builder() {}
        public Builder(GetGitCredentialHttp defaults) {
        ...
        public GetGitCredentialHttp build() {
            final var o = new GetGitCredentialHttp();

...
public final class ServiceNowConnectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceNowConnectorArgs Empty = new ServiceNowConnectorArgs();
    ...
    private Output<ServiceNowConnectorAuthArgs> auth;

    /**
     * @return The credentials to use for the service now authentication.
     * 
     */
    public Output<ServiceNowConnectorAuthArgs> auth() {
        return this.auth;
    }
    ...
    private ServiceNowConnectorArgs() {}

    private ServiceNowConnectorArgs(ServiceNowConnectorArgs $) {
        this.auth = $.auth;
    ...
    public static Builder builder(ServiceNowConnectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceNowConnectorArgs();
        }

        public Builder(ServiceNowConnectorArgs defaults) {
            $ = new ServiceNowConnectorArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder auth(Output<ServiceNowConnectorAuthArgs> auth) {
            $.auth = auth;
            return this;
        }
        ...
        public ServiceNowConnectorArgs build() {
            if ($.auth == null) {
                throw new MissingRequiredPropertyException("ServiceNowConnectorArgs", "auth");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("ServiceNowConnectorArgs", "identifier");
            }
            if ($.serviceNowUrl == null) {
                throw new MissingRequiredPropertyException("ServiceNowConnectorArgs", "serviceNowUrl");
            }
            return $;
        }
    }

...
@CustomType
public final class ArtifactoryCredentials {
    /**
    ...
    private ArtifactoryCredentials() {}
    /**
     * @return Reference to a secret containing the password to use for authentication.
     * 
     */
    ...
    public static Builder builder(ArtifactoryCredentials defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(ArtifactoryCredentials defaults) {
        ...
        public ArtifactoryCredentials build() {
            final var o = new ArtifactoryCredentials();

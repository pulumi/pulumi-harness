...
@CustomType
public final class AwsInheritFromDelegate {
    /**
    ...
    private AwsInheritFromDelegate() {}
    /**
     * @return The delegates to inherit the credentials from.
     * 
     */
    ...
    public static Builder builder(AwsInheritFromDelegate defaults) {
    ...
    public static final class Builder {
        private List<String> delegateSelectors;
        public Builder() {}
        public Builder(AwsInheritFromDelegate defaults) {
        ...
        public AwsInheritFromDelegate build() {
            final var o = new AwsInheritFromDelegate();

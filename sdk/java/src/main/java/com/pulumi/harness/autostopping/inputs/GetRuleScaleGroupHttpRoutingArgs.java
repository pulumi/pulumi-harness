...
public final class GetRuleScaleGroupHttpRoutingArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRuleScaleGroupHttpRoutingArgs Empty = new GetRuleScaleGroupHttpRoutingArgs();
    ...
    private GetRuleScaleGroupHttpRoutingArgs() {}

    private GetRuleScaleGroupHttpRoutingArgs(GetRuleScaleGroupHttpRoutingArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(GetRuleScaleGroupHttpRoutingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRuleScaleGroupHttpRoutingArgs();
        }

        public Builder(GetRuleScaleGroupHttpRoutingArgs defaults) {
            $ = new GetRuleScaleGroupHttpRoutingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRuleScaleGroupHttpRoutingArgs build() {
            if ($.sourceProtocol == null) {
                throw new MissingRequiredPropertyException("GetRuleScaleGroupHttpRoutingArgs", "sourceProtocol");
            }
            if ($.targetProtocol == null) {
                throw new MissingRequiredPropertyException("GetRuleScaleGroupHttpRoutingArgs", "targetProtocol");
            }
            return $;
        }
    }

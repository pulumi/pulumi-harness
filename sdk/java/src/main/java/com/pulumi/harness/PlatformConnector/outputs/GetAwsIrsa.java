...
public final class GetAwsIrsa {
    ...
    public static Builder builder(GetAwsIrsa defaults) {
    ...
    public static final class Builder {
        private List<String> delegateSelectors;
        public Builder() {}
        public Builder(GetAwsIrsa defaults) {
        ...
        public GetAwsIrsa build() {
            final var o = new GetAwsIrsa();

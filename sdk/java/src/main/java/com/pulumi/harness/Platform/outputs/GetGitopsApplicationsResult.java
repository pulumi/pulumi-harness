...
public final class GetGitopsApplicationsResult {
    ...
    public static final class Builder {
        ...
        public GetGitopsApplicationsResult build() {
            final var o = new GetGitopsApplicationsResult();
            ...
            o.kind = kind;
            o.name = name;
            o.optionsRemoveExistingFinalizers = optionsRemoveExistingFinalizers;
            o.orgId = orgId;
            o.project = project;
            o.projectId = projectId;
            o.queryProject = queryProject;
            o.queryRefresh = queryRefresh;
            o.queryRepo = queryRepo;
            o.queryResourceVersion = queryResourceVersion;
            o.querySelector = querySelector;
            o.repoId = repoId;
            o.requestCascade = requestCascade;
            o.requestName = requestName;
            o.requestPropagationPolicy = requestPropagationPolicy;
            o.upsert = upsert;
            o.validate = validate;
            return o;
        }

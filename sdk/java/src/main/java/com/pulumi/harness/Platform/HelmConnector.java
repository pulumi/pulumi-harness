...
public class HelmConnector extends com.pulumi.resources.CustomResource {
     ...
     */
    public HelmConnector(String name) {
     ...
     */
    public HelmConnector(String name, HelmConnectorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/helmConnector:HelmConnector", name, args == null ? HelmConnectorArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private HelmConnector(String name, Output<String> id, @Nullable HelmConnectorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/helmConnector:HelmConnector", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static HelmConnector get(String name, Output<String> id, @Nullable HelmConnectorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

...
public final class GetProbeTemplateK8sProbeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetProbeTemplateK8sProbeArgs Empty = new GetProbeTemplateK8sProbeArgs();
    ...
    private GetProbeTemplateK8sProbeArgs() {}

    private GetProbeTemplateK8sProbeArgs(GetProbeTemplateK8sProbeArgs $) {
    ...
    public static Builder builder(GetProbeTemplateK8sProbeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetProbeTemplateK8sProbeArgs();
        }

        public Builder(GetProbeTemplateK8sProbeArgs defaults) {
            $ = new GetProbeTemplateK8sProbeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetProbeTemplateK8sProbeArgs build() {
            if ($.resource == null) {
                throw new MissingRequiredPropertyException("GetProbeTemplateK8sProbeArgs", "resource");
            }
            if ($.version == null) {
                throw new MissingRequiredPropertyException("GetProbeTemplateK8sProbeArgs", "version");
            }
            return $;
        }
    }

...
public final class GetAzureProxyCertificatesArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetAzureProxyCertificatesArgs Empty = new GetAzureProxyCertificatesArgs();
    ...
    private GetAzureProxyCertificatesArgs() {}

    private GetAzureProxyCertificatesArgs(GetAzureProxyCertificatesArgs $) {
    ...
    public static Builder builder(GetAzureProxyCertificatesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAzureProxyCertificatesArgs();
        }

        public Builder(GetAzureProxyCertificatesArgs defaults) {
            $ = new GetAzureProxyCertificatesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAzureProxyCertificatesArgs build() {
            if ($.certSecretId == null) {
                throw new MissingRequiredPropertyException("GetAzureProxyCertificatesArgs", "certSecretId");
            }
            if ($.keySecretId == null) {
                throw new MissingRequiredPropertyException("GetAzureProxyCertificatesArgs", "keySecretId");
            }
            return $;
        }
    }

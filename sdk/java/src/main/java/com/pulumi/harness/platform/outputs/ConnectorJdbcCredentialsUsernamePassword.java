...
@CustomType
public final class ConnectorJdbcCredentialsUsernamePassword {
    /**
    ...
    private ConnectorJdbcCredentialsUsernamePassword() {}
    /**
     * @return Reference to a secret containing the password to use for authentication. To reference a secret at the organization scope, prefix &#39;org&#39; to the expression: org.{identifier}. To reference a secret at the account scope, prefix &#39;account` to the expression: account.{identifier}.
     * 
     */
    ...
    public static Builder builder(ConnectorJdbcCredentialsUsernamePassword defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(ConnectorJdbcCredentialsUsernamePassword defaults) {
        ...
        public Builder passwordRef(String passwordRef) {
            if (passwordRef == null) {
              throw new MissingRequiredPropertyException("ConnectorJdbcCredentialsUsernamePassword", "passwordRef");
            }
        ...
        public ConnectorJdbcCredentialsUsernamePassword build() {
            final var _resultValue = new ConnectorJdbcCredentialsUsernamePassword();

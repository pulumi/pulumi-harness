...
public final class JenkinsConnectorAuthJenkinsUserNamePassword {
    ...
    public static final class Builder {
        ...
        public Builder passwordRef(String passwordRef) {
            if (passwordRef == null) {
              throw new MissingRequiredPropertyException("JenkinsConnectorAuthJenkinsUserNamePassword", "passwordRef");
            }
        ...
        public JenkinsConnectorAuthJenkinsUserNamePassword build() {
            final var _resultValue = new JenkinsConnectorAuthJenkinsUserNamePassword();

...
public final class GitArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<GitCredentialsArgs> credentials;

    /**
     * @return Credentials to use for the connection.
     * 
     */
    public Output<GitCredentialsArgs> credentials() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder credentials(Output<GitCredentialsArgs> credentials) {

...
@CustomType
public final class RuleK8sDepend {
    /**
    ...
    public static Builder builder(RuleK8sDepend defaults) {
    ...
    public static final class Builder {
        ...
        private Integer ruleId;
        public Builder() {}
        public Builder(RuleK8sDepend defaults) {
        ...
        public Builder ruleId(Integer ruleId) {
            if (ruleId == null) {
              throw new MissingRequiredPropertyException("RuleK8sDepend", "ruleId");
            }
            this.ruleId = ruleId;
            return this;
        }
        public RuleK8sDepend build() {
            final var _resultValue = new RuleK8sDepend();

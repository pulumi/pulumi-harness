...
@CustomType
public final class RuleEcsDepend {
    /**
    ...
    public static Builder builder(RuleEcsDepend defaults) {
    ...
    public static final class Builder {
        ...
        private Integer ruleId;
        public Builder() {}
        public Builder(RuleEcsDepend defaults) {
        ...
        public Builder ruleId(Integer ruleId) {
            if (ruleId == null) {
              throw new MissingRequiredPropertyException("RuleEcsDepend", "ruleId");
            }
            this.ruleId = ruleId;
            return this;
        }
        public RuleEcsDepend build() {
            final var _resultValue = new RuleEcsDepend();

...
@CustomType
public final class GithubCredentialsHttp {
    private String tokenRef;
    private @Nullable String username;
    private @Nullable String usernameRef;

    private GithubCredentialsHttp() {}
    ...
    public static Builder builder(GithubCredentialsHttp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(GithubCredentialsHttp defaults) {
        ...
        public GithubCredentialsHttp build() {
            final var o = new GithubCredentialsHttp();
            o.tokenRef = tokenRef;
            o.username = username;

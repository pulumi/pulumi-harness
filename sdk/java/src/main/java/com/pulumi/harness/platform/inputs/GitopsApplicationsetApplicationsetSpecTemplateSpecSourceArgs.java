...
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecTemplateSpecSourceDirectoryArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecTemplateSpecSourceKustomizeArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecTemplateSpecSourcePluginArgs;
...
public final class GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs Empty = new GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs();
    ...
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSourceDirectoryArgs> directory;

    /**
     * @return Path/directory specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSourceDirectoryArgs>> directory() {
     ...
     */
    @Import(name="helm")
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmArgs> helm;

    /**
     * @return Helm specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmArgs>> helm() {
    ...
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSourceKustomizeArgs> kustomize;

    /**
     * @return Kustomize specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSourceKustomizeArgs>> kustomize() {
     ...
     */
    @Import(name="plugin")
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSourcePluginArgs> plugin;

    /**
     * @return Config management plugin specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSourcePluginArgs>> plugin() {
    ...
    private GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs() {}

    private GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs(GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs $) {
        this.chart = $.chart;
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder directory(@Nullable Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSourceDirectoryArgs> directory) {
            $.directory = directory;
            return this;
        }
         ...
         * 
         */
        public Builder directory(GitopsApplicationsetApplicationsetSpecTemplateSpecSourceDirectoryArgs directory) {
         ...
         * 
         */
        public Builder helm(@Nullable Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmArgs> helm) {
            $.helm = helm;
            return this;
        }
         ...
         * 
         */
        public Builder helm(GitopsApplicationsetApplicationsetSpecTemplateSpecSourceHelmArgs helm) {
         ...
         * 
         */
        public Builder kustomize(@Nullable Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSourceKustomizeArgs> kustomize) {
            $.kustomize = kustomize;
            return this;
        }
         ...
         * 
         */
        public Builder kustomize(GitopsApplicationsetApplicationsetSpecTemplateSpecSourceKustomizeArgs kustomize) {
         ...
         * 
         */
        public Builder plugin(@Nullable Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSourcePluginArgs> plugin) {
            $.plugin = plugin;
            return this;
        }
         ...
         * 
         */
        public Builder plugin(GitopsApplicationsetApplicationsetSpecTemplateSpecSourcePluginArgs plugin) {
        ...
        public GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs build() {
            if ($.repoUrl == null) {
                throw new MissingRequiredPropertyException("GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs", "repoUrl");
            }
            return $;
        }
    }

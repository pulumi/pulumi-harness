...
public final class JiraConnectorArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public JiraConnectorArgs build() {
            if ($.auth == null) {
                throw new MissingRequiredPropertyException("JiraConnectorArgs", "auth");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("JiraConnectorArgs", "identifier");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("JiraConnectorArgs", "url");
            }
            return $;
        }
    }

...
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryJsonnetArgs;
...
public final class GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs Empty = new GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs();
     ...
     */
    @Import(name="jsonnet")
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryJsonnetArgs> jsonnet;

    /**
     * @return Jsonnet specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryJsonnetArgs>> jsonnet() {
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs() {}

    private GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs(GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs $) {
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder jsonnet(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryJsonnetArgs> jsonnet) {
            $.jsonnet = jsonnet;
            return this;
        }
         ...
         * 
         */
        public Builder jsonnet(GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryJsonnetArgs jsonnet) {
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorGitTemplateSpecSourceDirectoryArgs build() {
            return $;
        }
    }

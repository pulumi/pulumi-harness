...
@CustomType
public final class UserGroupPermissionsAppPermissionsEnvironment {
    /**
    ...
    public static Builder builder(UserGroupPermissionsAppPermissionsEnvironment defaults) {
    ...
    public static final class Builder {
        ...
        public Builder actions(List<String> actions) {
            if (actions == null) {
              throw new MissingRequiredPropertyException("UserGroupPermissionsAppPermissionsEnvironment", "actions");
            }
        ...
        public UserGroupPermissionsAppPermissionsEnvironment build() {
            final var _resultValue = new UserGroupPermissionsAppPermissionsEnvironment();

...
import com.pulumi.harness.Platform.inputs.GetUsergroupNotificationConfigArgs;
...
public final class GetUsergroupArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private @Nullable Output<List<GetUsergroupNotificationConfigArgs>> notificationConfigs;

    /**
     * @return List of notification settings.
     * 
     */
    public Optional<Output<List<GetUsergroupNotificationConfigArgs>>> notificationConfigs() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder notificationConfigs(@Nullable Output<List<GetUsergroupNotificationConfigArgs>> notificationConfigs) {
         ...
         * 
         */
        public Builder notificationConfigs(List<GetUsergroupNotificationConfigArgs> notificationConfigs) {
         ...
         * 
         */
        public Builder notificationConfigs(GetUsergroupNotificationConfigArgs... notificationConfigs) {

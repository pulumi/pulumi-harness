...
public final class SecretFileArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public SecretFileArgs build() {
            if ($.filePath == null) {
                throw new MissingRequiredPropertyException("SecretFileArgs", "filePath");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("SecretFileArgs", "identifier");
            }
            if ($.secretManagerIdentifier == null) {
                throw new MissingRequiredPropertyException("SecretFileArgs", "secretManagerIdentifier");
            }
            return $;
        }
    }

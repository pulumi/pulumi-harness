...
public final class GetRuleScaleGroupHttpHealth extends com.pulumi.resources.InvokeArgs {

    public static final GetRuleScaleGroupHttpHealth Empty = new GetRuleScaleGroupHttpHealth();
    ...
    private GetRuleScaleGroupHttpHealth() {}

    private GetRuleScaleGroupHttpHealth(GetRuleScaleGroupHttpHealth $) {
        this.path = $.path;
        this.port = $.port;
    ...
    public static Builder builder(GetRuleScaleGroupHttpHealth defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRuleScaleGroupHttpHealth();
        }

        public Builder(GetRuleScaleGroupHttpHealth defaults) {
            $ = new GetRuleScaleGroupHttpHealth(Objects.requireNonNull(defaults));
        }
        ...
        public GetRuleScaleGroupHttpHealth build() {
            if ($.port == null) {
                throw new MissingRequiredPropertyException("GetRuleScaleGroupHttpHealth", "port");
            }
            if ($.protocol == null) {
                throw new MissingRequiredPropertyException("GetRuleScaleGroupHttpHealth", "protocol");
            }
            return $;
        }
    }

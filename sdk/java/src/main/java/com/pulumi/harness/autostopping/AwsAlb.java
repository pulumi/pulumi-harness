...
public class AwsAlb extends com.pulumi.resources.CustomResource {
     ...
     */
    public AwsAlb(String name, AwsAlbArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:autostopping/awsAlb:AwsAlb", name, args == null ? AwsAlbArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AwsAlb(String name, Output<String> id, @Nullable AwsAlbState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:autostopping/awsAlb:AwsAlb", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static AwsAlb get(String name, Output<String> id, @Nullable AwsAlbState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

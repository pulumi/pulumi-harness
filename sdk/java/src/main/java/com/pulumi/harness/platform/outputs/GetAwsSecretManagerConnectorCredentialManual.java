...
@CustomType
public final class GetAwsSecretManagerConnectorCredentialManual {
    /**
    ...
    private GetAwsSecretManagerConnectorCredentialManual() {}
    /**
     * @return The reference to the Harness secret containing the AWS access key. To reference a secret at the organization scope, prefix &#39;org&#39; to the expression: org.{identifier}. To reference a secret at the account scope, prefix &#39;account` to the expression: account.{identifier}.
     * 
     */
    ...
    public static Builder builder(GetAwsSecretManagerConnectorCredentialManual defaults) {
    ...
    public static final class Builder {
        ...
        private String secretKeyRef;
        public Builder() {}
        public Builder(GetAwsSecretManagerConnectorCredentialManual defaults) {
        ...
        public Builder accessKeyRef(String accessKeyRef) {
            if (accessKeyRef == null) {
              throw new MissingRequiredPropertyException("GetAwsSecretManagerConnectorCredentialManual", "accessKeyRef");
            }
        ...
        public Builder secretKeyRef(String secretKeyRef) {
            if (secretKeyRef == null) {
              throw new MissingRequiredPropertyException("GetAwsSecretManagerConnectorCredentialManual", "secretKeyRef");
            }
            this.secretKeyRef = secretKeyRef;
            return this;
        }
        public GetAwsSecretManagerConnectorCredentialManual build() {
            final var _resultValue = new GetAwsSecretManagerConnectorCredentialManual();

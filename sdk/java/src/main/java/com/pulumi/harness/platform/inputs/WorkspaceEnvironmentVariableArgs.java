...
public final class WorkspaceEnvironmentVariableArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceEnvironmentVariableArgs Empty = new WorkspaceEnvironmentVariableArgs();
    ...
    private WorkspaceEnvironmentVariableArgs() {}

    private WorkspaceEnvironmentVariableArgs(WorkspaceEnvironmentVariableArgs $) {
        this.key = $.key;
        this.value = $.value;
    ...
    public static Builder builder(WorkspaceEnvironmentVariableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceEnvironmentVariableArgs();
        }

        public Builder(WorkspaceEnvironmentVariableArgs defaults) {
            $ = new WorkspaceEnvironmentVariableArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WorkspaceEnvironmentVariableArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("WorkspaceEnvironmentVariableArgs", "key");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("WorkspaceEnvironmentVariableArgs", "value");
            }
            if ($.valueType == null) {
                throw new MissingRequiredPropertyException("WorkspaceEnvironmentVariableArgs", "valueType");
            }
            return $;
        }
    }

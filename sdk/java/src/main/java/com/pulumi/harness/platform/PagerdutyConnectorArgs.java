...
public final class PagerdutyConnectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final PagerdutyConnectorArgs Empty = new PagerdutyConnectorArgs();
    ...
    private PagerdutyConnectorArgs() {}

    private PagerdutyConnectorArgs(PagerdutyConnectorArgs $) {
    ...
    public static Builder builder(PagerdutyConnectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PagerdutyConnectorArgs();
        }

        public Builder(PagerdutyConnectorArgs defaults) {
            $ = new PagerdutyConnectorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PagerdutyConnectorArgs build() {
            if ($.apiTokenRef == null) {
                throw new MissingRequiredPropertyException("PagerdutyConnectorArgs", "apiTokenRef");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("PagerdutyConnectorArgs", "identifier");
            }
            return $;
        }
    }

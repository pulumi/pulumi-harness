...
import com.pulumi.harness.fmeFeatureFlag.DefinitionArgs;
import com.pulumi.harness.fmeFeatureFlag.inputs.DefinitionState;
 ...
 * 
 */
@ResourceType(type="harness:fmeFeatureFlag/definition:Definition")
public class Definition extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="flagName", refs={String.class}, tree="[0]")
    ...
    public Definition(java.lang.String name, DefinitionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:fmeFeatureFlag/definition:Definition", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Definition(java.lang.String name, Output<java.lang.String> id, @Nullable DefinitionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:fmeFeatureFlag/definition:Definition", name, state, makeResourceOptions(options, id), false);
    }

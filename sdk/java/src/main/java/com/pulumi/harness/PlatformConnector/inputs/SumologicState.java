...
public final class SumologicState extends com.pulumi.resources.ResourceArgs {

    public static final SumologicState Empty = new SumologicState();
    ...
    private SumologicState() {}

    private SumologicState(SumologicState $) {
    ...
    public static Builder builder(SumologicState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SumologicState defaults) {
            $ = new SumologicState(Objects.requireNonNull(defaults));
        }

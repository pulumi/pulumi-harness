...
public final class JenkinsConnectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final JenkinsConnectorArgs Empty = new JenkinsConnectorArgs();
    ...
    private JenkinsConnectorArgs() {}

    private JenkinsConnectorArgs(JenkinsConnectorArgs $) {
        this.auth = $.auth;
    ...
    public static Builder builder(JenkinsConnectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JenkinsConnectorArgs();
        }

        public Builder(JenkinsConnectorArgs defaults) {
            $ = new JenkinsConnectorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JenkinsConnectorArgs build() {
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("JenkinsConnectorArgs", "identifier");
            }
            if ($.jenkinsUrl == null) {
                throw new MissingRequiredPropertyException("JenkinsConnectorArgs", "jenkinsUrl");
            }
            return $;
        }
    }

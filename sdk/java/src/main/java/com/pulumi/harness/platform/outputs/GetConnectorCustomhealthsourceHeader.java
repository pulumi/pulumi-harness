...
@CustomType
public final class GetConnectorCustomhealthsourceHeader {
    /**
    ...
    private GetConnectorCustomhealthsourceHeader() {}
    /**
     * @return Reference to the Harness secret containing the encrypted value. To reference a secret at the organization scope, prefix &#39;org&#39; to the expression: org.{identifier}. To reference a secret at the account scope, prefix &#39;account` to the expression: account.{identifier}.
     * 
     */
    ...
    public static Builder builder(GetConnectorCustomhealthsourceHeader defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean valueEncrypted;
        public Builder() {}
        public Builder(GetConnectorCustomhealthsourceHeader defaults) {
        ...
        public Builder encryptedValueRef(String encryptedValueRef) {
            if (encryptedValueRef == null) {
              throw new MissingRequiredPropertyException("GetConnectorCustomhealthsourceHeader", "encryptedValueRef");
            }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetConnectorCustomhealthsourceHeader", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetConnectorCustomhealthsourceHeader", "value");
            }
            this.value = value;
            return this;
        }
        ...
        public Builder valueEncrypted(Boolean valueEncrypted) {
            if (valueEncrypted == null) {
              throw new MissingRequiredPropertyException("GetConnectorCustomhealthsourceHeader", "valueEncrypted");
            }
            this.valueEncrypted = valueEncrypted;
            return this;
        }
        public GetConnectorCustomhealthsourceHeader build() {
            final var _resultValue = new GetConnectorCustomhealthsourceHeader();

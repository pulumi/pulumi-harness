...
public final class PolicySetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PolicySetArgs build() {
            if ($.action == null) {
                throw new MissingRequiredPropertyException("PolicySetArgs", "action");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("PolicySetArgs", "identifier");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("PolicySetArgs", "type");
            }
            return $;
        }
    }

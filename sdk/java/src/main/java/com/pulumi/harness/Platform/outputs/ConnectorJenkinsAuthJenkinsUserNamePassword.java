...
@CustomType
public final class ConnectorJenkinsAuthJenkinsUserNamePassword {
    private String passwordRef;
    private @Nullable String username;
    private @Nullable String usernameRef;

    private ConnectorJenkinsAuthJenkinsUserNamePassword() {}
    ...
    public static Builder builder(ConnectorJenkinsAuthJenkinsUserNamePassword defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(ConnectorJenkinsAuthJenkinsUserNamePassword defaults) {
        ...
        public ConnectorJenkinsAuthJenkinsUserNamePassword build() {
            final var o = new ConnectorJenkinsAuthJenkinsUserNamePassword();

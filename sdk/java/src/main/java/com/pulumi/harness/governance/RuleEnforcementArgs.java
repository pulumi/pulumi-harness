...
public final class RuleEnforcementArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleEnforcementArgs Empty = new RuleEnforcementArgs();
     ...
     * 
     */
    @Import(name="executionSchedule", required=true)
     ...
     * 
     */
    @Import(name="executionTimezone", required=true)
    ...
    private RuleEnforcementArgs() {}

    private RuleEnforcementArgs(RuleEnforcementArgs $) {
    ...
    public static Builder builder(RuleEnforcementArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleEnforcementArgs();
        }

        public Builder(RuleEnforcementArgs defaults) {
            $ = new RuleEnforcementArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder executionSchedule(Output<String> executionSchedule) {
         ...
         * 
         */
        public Builder executionTimezone(Output<String> executionTimezone) {
        ...
        public RuleEnforcementArgs build() {
            if ($.cloudProvider == null) {
                throw new MissingRequiredPropertyException("RuleEnforcementArgs", "cloudProvider");
            }
            if ($.executionSchedule == null) {
                throw new MissingRequiredPropertyException("RuleEnforcementArgs", "executionSchedule");
            }
            if ($.executionTimezone == null) {
                throw new MissingRequiredPropertyException("RuleEnforcementArgs", "executionTimezone");
            }
            if ($.targetAccounts == null) {
                throw new MissingRequiredPropertyException("RuleEnforcementArgs", "targetAccounts");
            }
            return $;
        }
    }

...
public final class GitOpsClusterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GitOpsClusterArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GitOpsClusterArgs", "accountId");
            }
            if ($.agentId == null) {
                throw new MissingRequiredPropertyException("GitOpsClusterArgs", "agentId");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("GitOpsClusterArgs", "identifier");
            }
            return $;
        }
    }

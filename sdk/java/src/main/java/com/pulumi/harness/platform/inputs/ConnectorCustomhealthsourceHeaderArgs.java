...
public final class ConnectorCustomhealthsourceHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConnectorCustomhealthsourceHeaderArgs Empty = new ConnectorCustomhealthsourceHeaderArgs();
    ...
    private ConnectorCustomhealthsourceHeaderArgs() {}

    private ConnectorCustomhealthsourceHeaderArgs(ConnectorCustomhealthsourceHeaderArgs $) {
    ...
    public static Builder builder(ConnectorCustomhealthsourceHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectorCustomhealthsourceHeaderArgs();
        }

        public Builder(ConnectorCustomhealthsourceHeaderArgs defaults) {
            $ = new ConnectorCustomhealthsourceHeaderArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ConnectorCustomhealthsourceHeaderArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("ConnectorCustomhealthsourceHeaderArgs", "key");
            }
            return $;
        }
    }

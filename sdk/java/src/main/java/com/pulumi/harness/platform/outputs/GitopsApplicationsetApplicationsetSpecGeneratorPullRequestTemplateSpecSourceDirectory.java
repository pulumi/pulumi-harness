...
import com.pulumi.harness.platform.outputs.GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryJsonnet;
...
@CustomType
public final class GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectory {
    /**
     ...
     * 
     */
    private @Nullable GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryJsonnet jsonnet;
    /**
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectory() {}
    /**
     * @return Glob pattern to match paths against that should be explicitly excluded from being used during manifest generation. This takes precedence over the `include` field. To match multiple patterns, wrap the patterns in {} and separate them with commas. For example: &#39;{config.yaml,env-use2/*}&#39;
     * 
     */
     ...
     * 
     */
    public Optional<GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryJsonnet> jsonnet() {
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean recurse;
        public Builder() {}
        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectory defaults) {
        ...
        @CustomType.Setter
        public Builder jsonnet(@Nullable GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectoryJsonnet jsonnet) {
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectory build() {
            final var _resultValue = new GitopsApplicationsetApplicationsetSpecGeneratorPullRequestTemplateSpecSourceDirectory();

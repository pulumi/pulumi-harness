...
@CustomType
public final class RuleVmTcpRdp {
    /**
    ...
    public static Builder builder(RuleVmTcpRdp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer port;
        public Builder() {}
        public Builder(RuleVmTcpRdp defaults) {
        ...
        public RuleVmTcpRdp build() {
            final var _resultValue = new RuleVmTcpRdp();

...
import com.pulumi.harness.PlatformConnector.outputs.GetKubernetesClientKeyCert;
import com.pulumi.harness.PlatformConnector.outputs.GetKubernetesInheritFromDelegate;
import com.pulumi.harness.PlatformConnector.outputs.GetKubernetesOpenidConnect;
import com.pulumi.harness.PlatformConnector.outputs.GetKubernetesServiceAccount;
import com.pulumi.harness.PlatformConnector.outputs.GetKubernetesUsernamePassword;
...
public final class GetKubernetesResult {
     ...
     * 
     */
    private List<GetKubernetesClientKeyCert> clientKeyCerts;
    /**
     ...
     * 
     */
    private List<GetKubernetesInheritFromDelegate> inheritFromDelegates;
    /**
     ...
     * 
     */
    private List<GetKubernetesOpenidConnect> openidConnects;
    /**
     ...
     * 
     */
    private List<GetKubernetesServiceAccount> serviceAccounts;
    /**
     ...
     * 
     */
    private List<GetKubernetesUsernamePassword> usernamePasswords;
     ...
     * 
     */
    public List<GetKubernetesClientKeyCert> clientKeyCerts() {
     ...
     * 
     */
    public List<GetKubernetesInheritFromDelegate> inheritFromDelegates() {
     ...
     * 
     */
    public List<GetKubernetesOpenidConnect> openidConnects() {
     ...
     * 
     */
    public List<GetKubernetesServiceAccount> serviceAccounts() {
     ...
     * 
     */
    public List<GetKubernetesUsernamePassword> usernamePasswords() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder clientKeyCerts(List<GetKubernetesClientKeyCert> clientKeyCerts) {
            this.clientKeyCerts = Objects.requireNonNull(clientKeyCerts);
            return this;
        }
        public Builder clientKeyCerts(GetKubernetesClientKeyCert... clientKeyCerts) {
        ...
        @CustomType.Setter
        public Builder inheritFromDelegates(List<GetKubernetesInheritFromDelegate> inheritFromDelegates) {
            this.inheritFromDelegates = Objects.requireNonNull(inheritFromDelegates);
            return this;
        }
        public Builder inheritFromDelegates(GetKubernetesInheritFromDelegate... inheritFromDelegates) {
        ...
        @CustomType.Setter
        public Builder openidConnects(List<GetKubernetesOpenidConnect> openidConnects) {
            this.openidConnects = Objects.requireNonNull(openidConnects);
            return this;
        }
        public Builder openidConnects(GetKubernetesOpenidConnect... openidConnects) {
        ...
        @CustomType.Setter
        public Builder serviceAccounts(List<GetKubernetesServiceAccount> serviceAccounts) {
            this.serviceAccounts = Objects.requireNonNull(serviceAccounts);
            return this;
        }
        public Builder serviceAccounts(GetKubernetesServiceAccount... serviceAccounts) {
        ...
        @CustomType.Setter
        public Builder usernamePasswords(List<GetKubernetesUsernamePassword> usernamePasswords) {
            this.usernamePasswords = Objects.requireNonNull(usernamePasswords);
            return this;
        }
        public Builder usernamePasswords(GetKubernetesUsernamePassword... usernamePasswords) {

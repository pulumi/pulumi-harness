...
public class IacmDefaultPipeline extends com.pulumi.resources.CustomResource {
     ...
     */
    public IacmDefaultPipeline(java.lang.String name) {
     ...
     */
    public IacmDefaultPipeline(java.lang.String name, IacmDefaultPipelineArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IacmDefaultPipeline(java.lang.String name, IacmDefaultPipelineArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/iacmDefaultPipeline:IacmDefaultPipeline", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private IacmDefaultPipeline(java.lang.String name, Output<java.lang.String> id, @Nullable IacmDefaultPipelineState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/iacmDefaultPipeline:IacmDefaultPipeline", name, state, makeResourceOptions(options, id), false);
    }

    private static IacmDefaultPipelineArgs makeArgs(IacmDefaultPipelineArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? IacmDefaultPipelineArgs.Empty : args;
    }
     ...
     */
    public static IacmDefaultPipeline get(java.lang.String name, Output<java.lang.String> id, @Nullable IacmDefaultPipelineState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

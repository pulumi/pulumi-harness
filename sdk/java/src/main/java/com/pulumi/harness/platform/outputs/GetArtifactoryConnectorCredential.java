...
public final class GetArtifactoryConnectorCredential {
    ...
    public static final class Builder {
        ...
        public Builder passwordRef(String passwordRef) {
            if (passwordRef == null) {
              throw new MissingRequiredPropertyException("GetArtifactoryConnectorCredential", "passwordRef");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetArtifactoryConnectorCredential", "username");
            }
        ...
        public Builder usernameRef(String usernameRef) {
            if (usernameRef == null) {
              throw new MissingRequiredPropertyException("GetArtifactoryConnectorCredential", "usernameRef");
            }
            this.usernameRef = usernameRef;
            return this;
        }
        public GetArtifactoryConnectorCredential build() {
            final var _resultValue = new GetArtifactoryConnectorCredential();

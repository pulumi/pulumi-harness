...
public final class GetInfrastructureV2VolumeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetInfrastructureV2VolumeArgs Empty = new GetInfrastructureV2VolumeArgs();
    ...
    private GetInfrastructureV2VolumeArgs() {}

    private GetInfrastructureV2VolumeArgs(GetInfrastructureV2VolumeArgs $) {
        this.name = $.name;
    ...
    public static Builder builder(GetInfrastructureV2VolumeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetInfrastructureV2VolumeArgs();
        }

        public Builder(GetInfrastructureV2VolumeArgs defaults) {
            $ = new GetInfrastructureV2VolumeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetInfrastructureV2VolumeArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetInfrastructureV2VolumeArgs", "name");
            }
            return $;
        }
    }

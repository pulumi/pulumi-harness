...
public final class AwsKmsState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<AwsKmsCredentialsArgs> credentials;

    /**
     * @return The credentials to use for connecting to aws.
     * 
     */
    public Optional<Output<AwsKmsCredentialsArgs>> credentials() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder credentials(@Nullable Output<AwsKmsCredentialsArgs> credentials) {

...
@CustomType
public final class GitopsApplicationsetApplicationsetSpecGeneratorScmProviderFilter {
    /**
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorScmProviderFilter() {}
    /**
     * @return A regex which must match the branch name.
     * 
     */
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorScmProviderFilter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String repositoryMatch;
        public Builder() {}
        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorScmProviderFilter defaults) {
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorScmProviderFilter build() {
            final var _resultValue = new GitopsApplicationsetApplicationsetSpecGeneratorScmProviderFilter();

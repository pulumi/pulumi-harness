...
@CustomType
public final class GitConnectorUsageScope {
    /**
    ...
    public static Builder builder(GitConnectorUsageScope defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String environmentId;
        public Builder() {}
        public Builder(GitConnectorUsageScope defaults) {
        ...
        public GitConnectorUsageScope build() {
            final var _resultValue = new GitConnectorUsageScope();

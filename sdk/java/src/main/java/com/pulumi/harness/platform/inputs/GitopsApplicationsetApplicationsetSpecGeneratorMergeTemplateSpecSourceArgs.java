...
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceDirectoryArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceKustomizeArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourcePluginArgs;
...
public final class GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceArgs Empty = new GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceArgs();
    ...
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceDirectoryArgs> directory;

    /**
     * @return Path/directory specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceDirectoryArgs>> directory() {
     ...
     */
    @Import(name="helm")
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmArgs> helm;

    /**
     * @return Helm specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmArgs>> helm() {
    ...
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceKustomizeArgs> kustomize;

    /**
     * @return Kustomize specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceKustomizeArgs>> kustomize() {
     ...
     */
    @Import(name="plugin")
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourcePluginArgs> plugin;

    /**
     * @return Config management plugin specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourcePluginArgs>> plugin() {
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceArgs() {}

    private GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceArgs(GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceArgs $) {
        this.chart = $.chart;
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder directory(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceDirectoryArgs> directory) {
            $.directory = directory;
            return this;
        }
         ...
         * 
         */
        public Builder directory(GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceDirectoryArgs directory) {
         ...
         * 
         */
        public Builder helm(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmArgs> helm) {
            $.helm = helm;
            return this;
        }
         ...
         * 
         */
        public Builder helm(GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceHelmArgs helm) {
         ...
         * 
         */
        public Builder kustomize(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceKustomizeArgs> kustomize) {
            $.kustomize = kustomize;
            return this;
        }
         ...
         * 
         */
        public Builder kustomize(GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceKustomizeArgs kustomize) {
         ...
         * 
         */
        public Builder plugin(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourcePluginArgs> plugin) {
            $.plugin = plugin;
            return this;
        }
         ...
         * 
         */
        public Builder plugin(GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourcePluginArgs plugin) {
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorMergeTemplateSpecSourceArgs build() {
            return $;
        }
    }

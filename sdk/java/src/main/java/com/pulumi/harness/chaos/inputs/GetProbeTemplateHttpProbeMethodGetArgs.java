...
public final class GetProbeTemplateHttpProbeMethodGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetProbeTemplateHttpProbeMethodGetArgs Empty = new GetProbeTemplateHttpProbeMethodGetArgs();
    ...
    private GetProbeTemplateHttpProbeMethodGetArgs() {}

    private GetProbeTemplateHttpProbeMethodGetArgs(GetProbeTemplateHttpProbeMethodGetArgs $) {
    ...
    public static Builder builder(GetProbeTemplateHttpProbeMethodGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetProbeTemplateHttpProbeMethodGetArgs();
        }

        public Builder(GetProbeTemplateHttpProbeMethodGetArgs defaults) {
            $ = new GetProbeTemplateHttpProbeMethodGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetProbeTemplateHttpProbeMethodGetArgs build() {
            return $;
        }
    }

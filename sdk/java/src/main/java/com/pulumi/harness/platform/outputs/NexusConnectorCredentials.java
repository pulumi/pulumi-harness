...
public final class NexusConnectorCredentials {
    ...
    public static Builder builder(NexusConnectorCredentials defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(NexusConnectorCredentials defaults) {
        ...
        public Builder passwordRef(String passwordRef) {
            if (passwordRef == null) {
              throw new MissingRequiredPropertyException("NexusConnectorCredentials", "passwordRef");
            }
        ...
        public NexusConnectorCredentials build() {
            final var _resultValue = new NexusConnectorCredentials();

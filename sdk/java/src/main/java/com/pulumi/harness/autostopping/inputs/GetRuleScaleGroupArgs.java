...
import com.pulumi.harness.autostopping.inputs.GetRuleScaleGroupDependArgs;
import com.pulumi.harness.autostopping.inputs.GetRuleScaleGroupHttpArgs;
import com.pulumi.harness.autostopping.inputs.GetRuleScaleGroupScaleGroupArgs;
...
public final class GetRuleScaleGroupArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetRuleScaleGroupArgs Empty = new GetRuleScaleGroupArgs();
     ...
     */
    @Import(name="depends")
    private @Nullable Output<List<GetRuleScaleGroupDependArgs>> depends;

    /**
     * @return Dependent rules
     * 
     */
    public Optional<Output<List<GetRuleScaleGroupDependArgs>>> depends() {
     ...
     */
    @Import(name="https")
    private @Nullable Output<List<GetRuleScaleGroupHttpArgs>> https;

    /**
     * @return Http routing configuration
     * 
     */
    public Optional<Output<List<GetRuleScaleGroupHttpArgs>>> https() {
    ...
    private Output<GetRuleScaleGroupScaleGroupArgs> scaleGroup;

    /**
     * @return Scaling Group configuration
     * 
     */
    public Output<GetRuleScaleGroupScaleGroupArgs> scaleGroup() {
        return this.scaleGroup;
    }

    private GetRuleScaleGroupArgs() {}

    private GetRuleScaleGroupArgs(GetRuleScaleGroupArgs $) {
    ...
    public static Builder builder(GetRuleScaleGroupArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRuleScaleGroupArgs();
        }

        public Builder(GetRuleScaleGroupArgs defaults) {
            $ = new GetRuleScaleGroupArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder depends(@Nullable Output<List<GetRuleScaleGroupDependArgs>> depends) {
            $.depends = depends;
            return this;
        }
         ...
         * 
         */
        public Builder depends(List<GetRuleScaleGroupDependArgs> depends) {
         ...
         * 
         */
        public Builder depends(GetRuleScaleGroupDependArgs... depends) {
         ...
         * 
         */
        public Builder https(@Nullable Output<List<GetRuleScaleGroupHttpArgs>> https) {
            $.https = https;
            return this;
        }
         ...
         * 
         */
        public Builder https(List<GetRuleScaleGroupHttpArgs> https) {
         ...
         * 
         */
        public Builder https(GetRuleScaleGroupHttpArgs... https) {
         ...
         * 
         */
        public Builder scaleGroup(Output<GetRuleScaleGroupScaleGroupArgs> scaleGroup) {
         ...
         * 
         */
        public Builder scaleGroup(GetRuleScaleGroupScaleGroupArgs scaleGroup) {
            return scaleGroup(Output.of(scaleGroup));
        }

        public GetRuleScaleGroupArgs build() {
            if ($.cloudConnectorId == null) {
                throw new MissingRequiredPropertyException("GetRuleScaleGroupArgs", "cloudConnectorId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetRuleScaleGroupArgs", "name");
            }
            if ($.scaleGroup == null) {
                throw new MissingRequiredPropertyException("GetRuleScaleGroupArgs", "scaleGroup");
            }
            return $;
        }
    }

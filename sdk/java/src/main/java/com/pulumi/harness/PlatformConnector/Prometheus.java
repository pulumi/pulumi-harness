...
import com.pulumi.harness.PlatformConnector.PrometheusArgs;
import com.pulumi.harness.PlatformConnector.inputs.PrometheusState;
 ...
 * 
 */
@ResourceType(type="harness:PlatformConnector/prometheus:Prometheus")
public class Prometheus extends com.pulumi.resources.CustomResource {
    ...
    public Prometheus(String name, PrometheusArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:PlatformConnector/prometheus:Prometheus", name, args == null ? PrometheusArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Prometheus(String name, Output<String> id, @Nullable PrometheusState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:PlatformConnector/prometheus:Prometheus", name, state, makeResourceOptions(options, id));
    }

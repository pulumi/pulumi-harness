...
@CustomType
public final class ConnectorJdbcCredentialsInheritFromDelegate {
    /**
    ...
    private ConnectorJdbcCredentialsInheritFromDelegate() {}
    /**
     * @return Username to use for authentication.
     * 
     */
    ...
    public static Builder builder(ConnectorJdbcCredentialsInheritFromDelegate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(ConnectorJdbcCredentialsInheritFromDelegate defaults) {
        ...
        public ConnectorJdbcCredentialsInheritFromDelegate build() {
            final var _resultValue = new ConnectorJdbcCredentialsInheritFromDelegate();

...
@CustomType
public final class AwsKmsCredentialsManual {
    private String accessKeyRef;
    private String secretKeyRef;

    private AwsKmsCredentialsManual() {}
    ...
    public static Builder builder(AwsKmsCredentialsManual defaults) {
    ...
    public static final class Builder {
        ...
        private String secretKeyRef;
        public Builder() {}
        public Builder(AwsKmsCredentialsManual defaults) {
        ...
        public AwsKmsCredentialsManual build() {
            final var o = new AwsKmsCredentialsManual();

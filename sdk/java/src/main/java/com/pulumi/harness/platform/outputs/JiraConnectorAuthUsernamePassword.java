...
@CustomType
public final class JiraConnectorAuthUsernamePassword {
    /**
    ...
    private JiraConnectorAuthUsernamePassword() {}
    /**
     * @return Reference to a secret containing the password to use for authentication. To reference a secret at the organization scope, prefix &#39;org&#39; to the expression: org.{identifier}. To reference a secret at the account scope, prefix &#39;account` to the expression: account.{identifier}.
     * 
     */
    ...
    public static Builder builder(JiraConnectorAuthUsernamePassword defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(JiraConnectorAuthUsernamePassword defaults) {
        ...
        public Builder passwordRef(String passwordRef) {
            if (passwordRef == null) {
              throw new MissingRequiredPropertyException("JiraConnectorAuthUsernamePassword", "passwordRef");
            }
        ...
        public JiraConnectorAuthUsernamePassword build() {
            final var _resultValue = new JiraConnectorAuthUsernamePassword();

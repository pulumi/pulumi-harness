...
public final class DatadogConnectorArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DatadogConnectorArgs build() {
            if ($.apiKeyRef == null) {
                throw new MissingRequiredPropertyException("DatadogConnectorArgs", "apiKeyRef");
            }
            if ($.applicationKeyRef == null) {
                throw new MissingRequiredPropertyException("DatadogConnectorArgs", "applicationKeyRef");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("DatadogConnectorArgs", "identifier");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("DatadogConnectorArgs", "url");
            }
            return $;
        }
    }

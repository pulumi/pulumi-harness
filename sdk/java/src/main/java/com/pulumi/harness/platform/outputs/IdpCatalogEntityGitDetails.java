...
public final class IdpCatalogEntityGitDetails {
    ...
    public static Builder builder(IdpCatalogEntityGitDetails defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String storeType;
        public Builder() {}
        public Builder(IdpCatalogEntityGitDetails defaults) {
        ...
        public IdpCatalogEntityGitDetails build() {
            final var _resultValue = new IdpCatalogEntityGitDetails();

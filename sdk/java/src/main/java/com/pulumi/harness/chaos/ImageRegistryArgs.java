...
public final class ImageRegistryArgs extends com.pulumi.resources.ResourceArgs {

    public static final ImageRegistryArgs Empty = new ImageRegistryArgs();
    ...
    private ImageRegistryArgs() {}

    private ImageRegistryArgs(ImageRegistryArgs $) {
    ...
    public static Builder builder(ImageRegistryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ImageRegistryArgs();
        }

        public Builder(ImageRegistryArgs defaults) {
            $ = new ImageRegistryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ImageRegistryArgs build() {
            if ($.isPrivate == null) {
                throw new MissingRequiredPropertyException("ImageRegistryArgs", "isPrivate");
            }
            if ($.registryAccount == null) {
                throw new MissingRequiredPropertyException("ImageRegistryArgs", "registryAccount");
            }
            if ($.registryServer == null) {
                throw new MissingRequiredPropertyException("ImageRegistryArgs", "registryServer");
            }
            return $;
        }
    }

...
public final class AmiVariable {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("AmiVariable", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("AmiVariable", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("AmiVariable", "value");
            }
            this.value = value;
            return this;
        }
        public AmiVariable build() {
            final var _resultValue = new AmiVariable();

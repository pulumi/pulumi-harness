...
public final class KubernetesConnectorUsernamePasswordArgs extends com.pulumi.resources.ResourceArgs {

    public static final KubernetesConnectorUsernamePasswordArgs Empty = new KubernetesConnectorUsernamePasswordArgs();
    ...
    private KubernetesConnectorUsernamePasswordArgs() {}

    private KubernetesConnectorUsernamePasswordArgs(KubernetesConnectorUsernamePasswordArgs $) {
    ...
    public static Builder builder(KubernetesConnectorUsernamePasswordArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KubernetesConnectorUsernamePasswordArgs();
        }

        public Builder(KubernetesConnectorUsernamePasswordArgs defaults) {
            $ = new KubernetesConnectorUsernamePasswordArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KubernetesConnectorUsernamePasswordArgs build() {
            if ($.masterUrl == null) {
                throw new MissingRequiredPropertyException("KubernetesConnectorUsernamePasswordArgs", "masterUrl");
            }
            if ($.passwordRef == null) {
                throw new MissingRequiredPropertyException("KubernetesConnectorUsernamePasswordArgs", "passwordRef");
            }
            return $;
        }
    }

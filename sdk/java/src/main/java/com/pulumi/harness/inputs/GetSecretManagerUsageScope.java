...
public final class GetSecretManagerUsageScope extends com.pulumi.resources.InvokeArgs {

    public static final GetSecretManagerUsageScope Empty = new GetSecretManagerUsageScope();
    ...
    private GetSecretManagerUsageScope() {}

    private GetSecretManagerUsageScope(GetSecretManagerUsageScope $) {
    ...
    public static Builder builder(GetSecretManagerUsageScope defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSecretManagerUsageScope();
        }

        public Builder(GetSecretManagerUsageScope defaults) {
            $ = new GetSecretManagerUsageScope(Objects.requireNonNull(defaults));
        }

...
public final class DatadogArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatadogArgs Empty = new DatadogArgs();
    ...
    private DatadogArgs(DatadogArgs $) {
    ...
    public static Builder builder(DatadogArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DatadogArgs defaults) {
            $ = new DatadogArgs(Objects.requireNonNull(defaults));
        }

...
public final class GetJiraConnectorAuthUsernamePassword {
    ...
    public static final class Builder {
        ...
        public Builder passwordRef(String passwordRef) {
            if (passwordRef == null) {
              throw new MissingRequiredPropertyException("GetJiraConnectorAuthUsernamePassword", "passwordRef");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetJiraConnectorAuthUsernamePassword", "username");
            }
        ...
        public Builder usernameRef(String usernameRef) {
            if (usernameRef == null) {
              throw new MissingRequiredPropertyException("GetJiraConnectorAuthUsernamePassword", "usernameRef");
            }
            this.usernameRef = usernameRef;
            return this;
        }
        public GetJiraConnectorAuthUsernamePassword build() {
            final var _resultValue = new GetJiraConnectorAuthUsernamePassword();

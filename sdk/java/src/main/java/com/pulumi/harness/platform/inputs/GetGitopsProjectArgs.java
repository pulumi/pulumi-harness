...
import com.pulumi.harness.platform.inputs.GetGitopsProjectProjectArgs;
...
public final class GetGitopsProjectArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetGitopsProjectArgs Empty = new GetGitopsProjectArgs();
    ...
    private Output<List<GetGitopsProjectProjectArgs>> projects;

    /**
     * @return App projects configuration details.
     * 
     */
    public Output<List<GetGitopsProjectProjectArgs>> projects() {
    ...
    private GetGitopsProjectArgs() {}

    private GetGitopsProjectArgs(GetGitopsProjectArgs $) {
    ...
    public static Builder builder(GetGitopsProjectArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGitopsProjectArgs();
        }

        public Builder(GetGitopsProjectArgs defaults) {
            $ = new GetGitopsProjectArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder projects(Output<List<GetGitopsProjectProjectArgs>> projects) {
            $.projects = projects;
            return this;
        }
         ...
         * 
         */
        public Builder projects(List<GetGitopsProjectProjectArgs> projects) {
         ...
         * 
         */
        public Builder projects(GetGitopsProjectProjectArgs... projects) {
        ...
        public GetGitopsProjectArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GetGitopsProjectArgs", "accountId");
            }
            if ($.agentId == null) {
                throw new MissingRequiredPropertyException("GetGitopsProjectArgs", "agentId");
            }
            if ($.projects == null) {
                throw new MissingRequiredPropertyException("GetGitopsProjectArgs", "projects");
            }
            return $;
        }
    }

...
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecTemplateSpecIgnoreDifferenceArgs;
...
public final class GitopsApplicationsetApplicationsetSpecTemplateSpecArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecTemplateSpecArgs Empty = new GitopsApplicationsetApplicationsetSpecTemplateSpecArgs();
    ...
    private Output<GitopsApplicationsetApplicationsetSpecTemplateSpecDestinationArgs> destination;

    /**
     * @return Reference to the Kubernetes server and namespace in which the application will be deployed.
     * 
     */
    public Output<GitopsApplicationsetApplicationsetSpecTemplateSpecDestinationArgs> destination() {
    ...
    private @Nullable Output<List<GitopsApplicationsetApplicationsetSpecTemplateSpecIgnoreDifferenceArgs>> ignoreDifferences;
     ...
     * 
     */
    public Optional<Output<List<GitopsApplicationsetApplicationsetSpecTemplateSpecIgnoreDifferenceArgs>>> ignoreDifferences() {
     ...
     */
    @Import(name="infos")
    private @Nullable Output<List<GitopsApplicationsetApplicationsetSpecTemplateSpecInfoArgs>> infos;

    /**
     * @return List of information (URLs, email addresses, and plain text) that relates to the application.
     * 
     */
    public Optional<Output<List<GitopsApplicationsetApplicationsetSpecTemplateSpecInfoArgs>>> infos() {
    ...
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSyncPolicyArgs> syncPolicy;

    /**
     * @return Controls when and how a sync will be performed.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSyncPolicyArgs>> syncPolicy() {
        return Optional.ofNullable(this.syncPolicy);
    }

    private GitopsApplicationsetApplicationsetSpecTemplateSpecArgs() {}

    private GitopsApplicationsetApplicationsetSpecTemplateSpecArgs(GitopsApplicationsetApplicationsetSpecTemplateSpecArgs $) {
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecTemplateSpecArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecTemplateSpecArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecTemplateSpecArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecTemplateSpecArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder destination(Output<GitopsApplicationsetApplicationsetSpecTemplateSpecDestinationArgs> destination) {
         ...
         * 
         */
        public Builder destination(GitopsApplicationsetApplicationsetSpecTemplateSpecDestinationArgs destination) {
         ...
         * 
         */
        public Builder ignoreDifferences(@Nullable Output<List<GitopsApplicationsetApplicationsetSpecTemplateSpecIgnoreDifferenceArgs>> ignoreDifferences) {
         ...
         * 
         */
        public Builder ignoreDifferences(List<GitopsApplicationsetApplicationsetSpecTemplateSpecIgnoreDifferenceArgs> ignoreDifferences) {
         ...
         * 
         */
        public Builder ignoreDifferences(GitopsApplicationsetApplicationsetSpecTemplateSpecIgnoreDifferenceArgs... ignoreDifferences) {
         ...
         * 
         */
        public Builder infos(@Nullable Output<List<GitopsApplicationsetApplicationsetSpecTemplateSpecInfoArgs>> infos) {
            $.infos = infos;
            return this;
        }
         ...
         * 
         */
        public Builder infos(List<GitopsApplicationsetApplicationsetSpecTemplateSpecInfoArgs> infos) {
         ...
         * 
         */
        public Builder infos(GitopsApplicationsetApplicationsetSpecTemplateSpecInfoArgs... infos) {
         ...
         * 
         */
        public Builder source(List<GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs> source) {
         ...
         * 
         */
        public Builder source(GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs... source) {
         ...
         * 
         */
        public Builder sources(@Nullable Output<List<GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs>> sources) {
            $.sources = sources;
            return this;
        }
         ...
         * 
         */
        public Builder sources(List<GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs> sources) {
         ...
         * 
         */
        public Builder sources(GitopsApplicationsetApplicationsetSpecTemplateSpecSourceArgs... sources) {
         ...
         * 
         */
        public Builder syncPolicy(@Nullable Output<GitopsApplicationsetApplicationsetSpecTemplateSpecSyncPolicyArgs> syncPolicy) {
         ...
         * 
         */
        public Builder syncPolicy(GitopsApplicationsetApplicationsetSpecTemplateSpecSyncPolicyArgs syncPolicy) {

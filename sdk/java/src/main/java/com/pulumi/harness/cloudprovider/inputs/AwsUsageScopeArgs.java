...
public final class AwsUsageScopeArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsUsageScopeArgs Empty = new AwsUsageScopeArgs();
    ...
    private AwsUsageScopeArgs() {}

    private AwsUsageScopeArgs(AwsUsageScopeArgs $) {
    ...
    public static Builder builder(AwsUsageScopeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsUsageScopeArgs();
        }

        public Builder(AwsUsageScopeArgs defaults) {
            $ = new AwsUsageScopeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsUsageScopeArgs build() {
            return $;
        }
    }

...
@CustomType
public final class GetArtifactoryCredential {
    private String passwordRef;
    private String username;
    private String usernameRef;

    private GetArtifactoryCredential() {}
    ...
    public static Builder builder(GetArtifactoryCredential defaults) {
    ...
    public static final class Builder {
        ...
        private String usernameRef;
        public Builder() {}
        public Builder(GetArtifactoryCredential defaults) {
        ...
        public GetArtifactoryCredential build() {
            final var o = new GetArtifactoryCredential();

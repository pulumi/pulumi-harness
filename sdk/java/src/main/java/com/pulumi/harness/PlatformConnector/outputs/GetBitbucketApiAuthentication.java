...
@CustomType
public final class GetBitbucketApiAuthentication {
    private String tokenRef;
    private String username;
    private String usernameRef;

    private GetBitbucketApiAuthentication() {}
    ...
    public static Builder builder(GetBitbucketApiAuthentication defaults) {
    ...
    public static final class Builder {
        ...
        private String usernameRef;
        public Builder() {}
        public Builder(GetBitbucketApiAuthentication defaults) {
        ...
        public GetBitbucketApiAuthentication build() {
            final var o = new GetBitbucketApiAuthentication();
            o.tokenRef = tokenRef;
            o.username = username;

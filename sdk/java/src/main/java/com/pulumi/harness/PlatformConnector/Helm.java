...
import com.pulumi.harness.PlatformConnector.HelmArgs;
import com.pulumi.harness.PlatformConnector.inputs.HelmState;
import com.pulumi.harness.PlatformConnector.outputs.HelmCredentials;
 ...
 * 
 */
@ResourceType(type="harness:PlatformConnector/helm:Helm")
public class Helm extends com.pulumi.resources.CustomResource {
    /**
     * Credentials to use for authentication.
     * 
     */
    @Export(name="credentials", type=HelmCredentials.class, parameters={})
    private Output</* @Nullable */ HelmCredentials> credentials;

    /**
     * @return Credentials to use for authentication.
     * 
     */
    public Output<Optional<HelmCredentials>> credentials() {
    ...
    public Helm(String name, HelmArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:PlatformConnector/helm:Helm", name, args == null ? HelmArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Helm(String name, Output<String> id, @Nullable HelmState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:PlatformConnector/helm:Helm", name, state, makeResourceOptions(options, id));
    }

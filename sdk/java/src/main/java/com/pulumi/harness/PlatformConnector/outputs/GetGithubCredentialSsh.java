...
@CustomType
public final class GetGithubCredentialSsh {
    private String sshKeyRef;

    private GetGithubCredentialSsh() {}
    ...
    public static Builder builder(GetGithubCredentialSsh defaults) {
    ...
    public static final class Builder {
        private String sshKeyRef;
        public Builder() {}
        public Builder(GetGithubCredentialSsh defaults) {
        ...
        public GetGithubCredentialSsh build() {
            final var o = new GetGithubCredentialSsh();

...
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceDirectoryArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceHelmArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceKustomizeArgs;
import com.pulumi.harness.platform.inputs.GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourcePluginArgs;
...
public final class GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceArgs Empty = new GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceArgs();
    ...
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceDirectoryArgs> directory;

    /**
     * @return Path/directory specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceDirectoryArgs>> directory() {
     ...
     */
    @Import(name="helm")
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceHelmArgs> helm;

    /**
     * @return Helm specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceHelmArgs>> helm() {
    ...
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceKustomizeArgs> kustomize;

    /**
     * @return Kustomize specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceKustomizeArgs>> kustomize() {
     ...
     */
    @Import(name="plugin")
    private @Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourcePluginArgs> plugin;

    /**
     * @return Config management plugin specific options.
     * 
     */
    public Optional<Output<GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourcePluginArgs>> plugin() {
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceArgs() {}

    private GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceArgs(GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceArgs $) {
        this.chart = $.chart;
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder directory(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceDirectoryArgs> directory) {
            $.directory = directory;
            return this;
        }
         ...
         * 
         */
        public Builder directory(GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceDirectoryArgs directory) {
         ...
         * 
         */
        public Builder helm(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceHelmArgs> helm) {
            $.helm = helm;
            return this;
        }
         ...
         * 
         */
        public Builder helm(GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceHelmArgs helm) {
         ...
         * 
         */
        public Builder kustomize(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceKustomizeArgs> kustomize) {
            $.kustomize = kustomize;
            return this;
        }
         ...
         * 
         */
        public Builder kustomize(GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceKustomizeArgs kustomize) {
         ...
         * 
         */
        public Builder plugin(@Nullable Output<GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourcePluginArgs> plugin) {
            $.plugin = plugin;
            return this;
        }
         ...
         * 
         */
        public Builder plugin(GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourcePluginArgs plugin) {
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorMatrixTemplateSpecSourceArgs build() {
            return $;
        }
    }

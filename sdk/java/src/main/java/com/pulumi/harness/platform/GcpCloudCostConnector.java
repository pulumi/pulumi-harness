...
public class GcpCloudCostConnector extends com.pulumi.resources.CustomResource {
     ...
     */
    public GcpCloudCostConnector(String name) {
     ...
     */
    public GcpCloudCostConnector(String name, GcpCloudCostConnectorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/gcpCloudCostConnector:GcpCloudCostConnector", name, args == null ? GcpCloudCostConnectorArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private GcpCloudCostConnector(String name, Output<String> id, @Nullable GcpCloudCostConnectorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/gcpCloudCostConnector:GcpCloudCostConnector", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static GcpCloudCostConnector get(String name, Output<String> id, @Nullable GcpCloudCostConnectorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

...
@CustomType
public final class GetAwsKmsConnectorCredentialManual {
    /**
    ...
    private GetAwsKmsConnectorCredentialManual() {}
    /**
     * @return The reference to the Harness secret containing the AWS access key. To reference a secret at the organization scope, prefix &#39;org&#39; to the expression: org.{identifier}. To reference a secret at the account scope, prefix &#39;account` to the expression: account.{identifier}.
     * 
     */
    ...
    public static Builder builder(GetAwsKmsConnectorCredentialManual defaults) {
    ...
    public static final class Builder {
        ...
        private String secretKeyRef;
        public Builder() {}
        public Builder(GetAwsKmsConnectorCredentialManual defaults) {
        ...
        public Builder accessKeyRef(String accessKeyRef) {
            if (accessKeyRef == null) {
              throw new MissingRequiredPropertyException("GetAwsKmsConnectorCredentialManual", "accessKeyRef");
            }
        ...
        public Builder secretKeyRef(String secretKeyRef) {
            if (secretKeyRef == null) {
              throw new MissingRequiredPropertyException("GetAwsKmsConnectorCredentialManual", "secretKeyRef");
            }
            this.secretKeyRef = secretKeyRef;
            return this;
        }
        public GetAwsKmsConnectorCredentialManual build() {
            final var _resultValue = new GetAwsKmsConnectorCredentialManual();

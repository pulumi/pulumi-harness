...
public final class BitbucketConnectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final BitbucketConnectorArgs Empty = new BitbucketConnectorArgs();
    ...
    private @Nullable Output<BitbucketConnectorApiAuthenticationArgs> apiAuthentication;
     ...
     * 
     */
    public Optional<Output<BitbucketConnectorApiAuthenticationArgs>> apiAuthentication() {
    ...
    private Output<BitbucketConnectorCredentialsArgs> credentials;

    /**
     * @return Credentials to use for the connection.
     * 
     */
    public Output<BitbucketConnectorCredentialsArgs> credentials() {
    ...
    private BitbucketConnectorArgs() {}

    private BitbucketConnectorArgs(BitbucketConnectorArgs $) {
    ...
    public static Builder builder(BitbucketConnectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BitbucketConnectorArgs();
        }

        public Builder(BitbucketConnectorArgs defaults) {
            $ = new BitbucketConnectorArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param apiAuthentication Configuration for using the BitBucket api. API Access is required for using “Git Experience”, for creation of Git based triggers, Webhooks management and updating Git statuses.
         * 
         * @return builder
         * 
         */
        public Builder apiAuthentication(@Nullable Output<BitbucketConnectorApiAuthenticationArgs> apiAuthentication) {
         ...
         * 
         */
        public Builder apiAuthentication(BitbucketConnectorApiAuthenticationArgs apiAuthentication) {
            return apiAuthentication(Output.of(apiAuthentication));
        }

        /**
         * @param connectionType Whether the connection we&#39;re making is to a BitBucket repository or a BitBucket account. Valid values are Account, Repo.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder credentials(Output<BitbucketConnectorCredentialsArgs> credentials) {
         ...
         * 
         */
        public Builder credentials(BitbucketConnectorCredentialsArgs credentials) {
        ...
        public BitbucketConnectorArgs build() {
            if ($.connectionType == null) {
                throw new MissingRequiredPropertyException("BitbucketConnectorArgs", "connectionType");
            }
            if ($.credentials == null) {
                throw new MissingRequiredPropertyException("BitbucketConnectorArgs", "credentials");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("BitbucketConnectorArgs", "identifier");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("BitbucketConnectorArgs", "url");
            }
            return $;
        }
    }

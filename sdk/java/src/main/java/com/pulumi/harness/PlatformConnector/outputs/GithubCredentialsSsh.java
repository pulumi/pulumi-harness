...
@CustomType
public final class GithubCredentialsSsh {
    private String sshKeyRef;

    private GithubCredentialsSsh() {}
    ...
    public static Builder builder(GithubCredentialsSsh defaults) {
    ...
    public static final class Builder {
        private String sshKeyRef;
        public Builder() {}
        public Builder(GithubCredentialsSsh defaults) {
        ...
        public GithubCredentialsSsh build() {
            final var o = new GithubCredentialsSsh();

...
public final class HarRegistryConfigAuthUserPasswordArgs extends com.pulumi.resources.ResourceArgs {

    public static final HarRegistryConfigAuthUserPasswordArgs Empty = new HarRegistryConfigAuthUserPasswordArgs();
    ...
    private HarRegistryConfigAuthUserPasswordArgs() {}

    private HarRegistryConfigAuthUserPasswordArgs(HarRegistryConfigAuthUserPasswordArgs $) {
    ...
    public static Builder builder(HarRegistryConfigAuthUserPasswordArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HarRegistryConfigAuthUserPasswordArgs();
        }

        public Builder(HarRegistryConfigAuthUserPasswordArgs defaults) {
            $ = new HarRegistryConfigAuthUserPasswordArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HarRegistryConfigAuthUserPasswordArgs build() {
            if ($.userName == null) {
                throw new MissingRequiredPropertyException("HarRegistryConfigAuthUserPasswordArgs", "userName");
            }
            return $;
        }
    }

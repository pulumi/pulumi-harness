...
import com.pulumi.harness.PlatformConnector.GithubArgs;
import com.pulumi.harness.PlatformConnector.inputs.GithubState;
import com.pulumi.harness.PlatformConnector.outputs.GithubApiAuthentication;
import com.pulumi.harness.PlatformConnector.outputs.GithubCredentials;
 ...
 * 
 */
@ResourceType(type="harness:PlatformConnector/github:Github")
public class Github extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="apiAuthentication", type=GithubApiAuthentication.class, parameters={})
    private Output</* @Nullable */ GithubApiAuthentication> apiAuthentication;
     ...
     * 
     */
    public Output<Optional<GithubApiAuthentication>> apiAuthentication() {
     ...
     * 
     */
    @Export(name="credentials", type=GithubCredentials.class, parameters={})
    private Output<GithubCredentials> credentials;

    /**
     * @return Credentials to use for the connection.
     * 
     */
    public Output<GithubCredentials> credentials() {
    ...
    public Github(String name, GithubArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:PlatformConnector/github:Github", name, args == null ? GithubArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Github(String name, Output<String> id, @Nullable GithubState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:PlatformConnector/github:Github", name, state, makeResourceOptions(options, id));
    }

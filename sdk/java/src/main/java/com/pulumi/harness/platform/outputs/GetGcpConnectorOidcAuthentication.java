...
@CustomType
public final class GetGcpConnectorOidcAuthentication {
    /**
    ...
    private GetGcpConnectorOidcAuthentication() {}
    /**
     * @return The delegates to inherit the credentials from.
     * 
     */
    ...
    public static Builder builder(GetGcpConnectorOidcAuthentication defaults) {
    ...
    public static final class Builder {
        ...
        private String workloadPoolId;
        public Builder() {}
        public Builder(GetGcpConnectorOidcAuthentication defaults) {
        ...
        public Builder delegateSelectors(List<String> delegateSelectors) {
            if (delegateSelectors == null) {
              throw new MissingRequiredPropertyException("GetGcpConnectorOidcAuthentication", "delegateSelectors");
            }
        ...
        public Builder gcpProjectId(String gcpProjectId) {
            if (gcpProjectId == null) {
              throw new MissingRequiredPropertyException("GetGcpConnectorOidcAuthentication", "gcpProjectId");
            }
        ...
        public Builder providerId(String providerId) {
            if (providerId == null) {
              throw new MissingRequiredPropertyException("GetGcpConnectorOidcAuthentication", "providerId");
            }
        ...
        public Builder serviceAccountEmail(String serviceAccountEmail) {
            if (serviceAccountEmail == null) {
              throw new MissingRequiredPropertyException("GetGcpConnectorOidcAuthentication", "serviceAccountEmail");
            }
        ...
        public Builder workloadPoolId(String workloadPoolId) {
            if (workloadPoolId == null) {
              throw new MissingRequiredPropertyException("GetGcpConnectorOidcAuthentication", "workloadPoolId");
            }
            this.workloadPoolId = workloadPoolId;
            return this;
        }
        public GetGcpConnectorOidcAuthentication build() {
            final var _resultValue = new GetGcpConnectorOidcAuthentication();

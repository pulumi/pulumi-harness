...
public class GcpProxy extends com.pulumi.resources.CustomResource {
     ...
     */
    public GcpProxy(String name, GcpProxyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:autostopping/gcpProxy:GcpProxy", name, args == null ? GcpProxyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private GcpProxy(String name, Output<String> id, @Nullable GcpProxyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:autostopping/gcpProxy:GcpProxy", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static GcpProxy get(String name, Output<String> id, @Nullable GcpProxyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

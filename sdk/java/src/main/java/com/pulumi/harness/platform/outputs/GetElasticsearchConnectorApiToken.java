...
public final class GetElasticsearchConnectorApiToken {
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetElasticsearchConnectorApiToken", "clientId");
            }
        ...
        public Builder clientSecretRef(String clientSecretRef) {
            if (clientSecretRef == null) {
              throw new MissingRequiredPropertyException("GetElasticsearchConnectorApiToken", "clientSecretRef");
            }
            this.clientSecretRef = clientSecretRef;
            return this;
        }
        public GetElasticsearchConnectorApiToken build() {
            final var _resultValue = new GetElasticsearchConnectorApiToken();

...
public final class GetAppDynamicsConnectorApiToken {
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetAppDynamicsConnectorApiToken", "clientId");
            }
        ...
        public Builder clientSecretRef(String clientSecretRef) {
            if (clientSecretRef == null) {
              throw new MissingRequiredPropertyException("GetAppDynamicsConnectorApiToken", "clientSecretRef");
            }
            this.clientSecretRef = clientSecretRef;
            return this;
        }
        public GetAppDynamicsConnectorApiToken build() {
            final var _resultValue = new GetAppDynamicsConnectorApiToken();

...
public final class VariablesArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public VariablesArgs build() {
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("VariablesArgs", "identifier");
            }
            if ($.spec == null) {
                throw new MissingRequiredPropertyException("VariablesArgs", "spec");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("VariablesArgs", "type");
            }
            return $;
        }
    }

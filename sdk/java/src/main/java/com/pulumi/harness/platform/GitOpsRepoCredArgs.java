...
public final class GitOpsRepoCredArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GitOpsRepoCredArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("GitOpsRepoCredArgs", "accountId");
            }
            if ($.agentId == null) {
                throw new MissingRequiredPropertyException("GitOpsRepoCredArgs", "agentId");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("GitOpsRepoCredArgs", "identifier");
            }
            return $;
        }
    }

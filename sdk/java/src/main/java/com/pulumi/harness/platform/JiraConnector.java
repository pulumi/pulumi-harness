...
public class JiraConnector extends com.pulumi.resources.CustomResource {
     ...
     */
    public JiraConnector(String name) {
     ...
     */
    public JiraConnector(String name, JiraConnectorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/jiraConnector:JiraConnector", name, args == null ? JiraConnectorArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private JiraConnector(String name, Output<String> id, @Nullable JiraConnectorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("harness:platform/jiraConnector:JiraConnector", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static JiraConnector get(String name, Output<String> id, @Nullable JiraConnectorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

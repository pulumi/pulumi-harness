...
public final class SplunkConnectorArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public SplunkConnectorArgs build() {
            if ($.accountId == null) {
                throw new MissingRequiredPropertyException("SplunkConnectorArgs", "accountId");
            }
            if ($.identifier == null) {
                throw new MissingRequiredPropertyException("SplunkConnectorArgs", "identifier");
            }
            if ($.passwordRef == null) {
                throw new MissingRequiredPropertyException("SplunkConnectorArgs", "passwordRef");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("SplunkConnectorArgs", "url");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("SplunkConnectorArgs", "username");
            }
            return $;
        }
    }

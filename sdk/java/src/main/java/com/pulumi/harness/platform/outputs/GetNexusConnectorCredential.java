...
@CustomType
public final class GetNexusConnectorCredential {
    /**
    ...
    private GetNexusConnectorCredential() {}
    /**
     * @return Reference to a secret containing the password to use for authentication. To reference a secret at the organization scope, prefix &#39;org&#39; to the expression: org.{identifier}. To reference a secret at the account scope, prefix &#39;account` to the expression: account.{identifier}.
     * 
     */
    ...
    public static Builder builder(GetNexusConnectorCredential defaults) {
    ...
    public static final class Builder {
        ...
        private String usernameRef;
        public Builder() {}
        public Builder(GetNexusConnectorCredential defaults) {
        ...
        public Builder passwordRef(String passwordRef) {
            if (passwordRef == null) {
              throw new MissingRequiredPropertyException("GetNexusConnectorCredential", "passwordRef");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetNexusConnectorCredential", "username");
            }
        ...
        public Builder usernameRef(String usernameRef) {
            if (usernameRef == null) {
              throw new MissingRequiredPropertyException("GetNexusConnectorCredential", "usernameRef");
            }
            this.usernameRef = usernameRef;
            return this;
        }
        public GetNexusConnectorCredential build() {
            final var _resultValue = new GetNexusConnectorCredential();

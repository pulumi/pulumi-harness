...
public final class GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorScmProviderFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorScmProviderFilterArgs Empty = new GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorScmProviderFilterArgs();
    ...
    private GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorScmProviderFilterArgs() {}

    private GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorScmProviderFilterArgs(GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorScmProviderFilterArgs $) {
    ...
    public static Builder builder(GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorScmProviderFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorScmProviderFilterArgs();
        }

        public Builder(GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorScmProviderFilterArgs defaults) {
            $ = new GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorScmProviderFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GitopsApplicationsetApplicationsetSpecGeneratorMergeGeneratorScmProviderFilterArgs build() {
            return $;
        }
    }

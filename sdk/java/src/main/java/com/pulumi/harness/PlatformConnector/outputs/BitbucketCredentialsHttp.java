...
public final class BitbucketCredentialsHttp {
    ...
    public static Builder builder(BitbucketCredentialsHttp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(BitbucketCredentialsHttp defaults) {
        ...
        public BitbucketCredentialsHttp build() {
            final var o = new BitbucketCredentialsHttp();

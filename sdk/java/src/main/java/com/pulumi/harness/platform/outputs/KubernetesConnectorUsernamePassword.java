...
@CustomType
public final class KubernetesConnectorUsernamePassword {
    /**
    ...
    public static Builder builder(KubernetesConnectorUsernamePassword defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usernameRef;
        public Builder() {}
        public Builder(KubernetesConnectorUsernamePassword defaults) {
        ...
        public Builder masterUrl(String masterUrl) {
            if (masterUrl == null) {
              throw new MissingRequiredPropertyException("KubernetesConnectorUsernamePassword", "masterUrl");
            }
        ...
        public Builder passwordRef(String passwordRef) {
            if (passwordRef == null) {
              throw new MissingRequiredPropertyException("KubernetesConnectorUsernamePassword", "passwordRef");
            }
        ...
        public KubernetesConnectorUsernamePassword build() {
            final var _resultValue = new KubernetesConnectorUsernamePassword();

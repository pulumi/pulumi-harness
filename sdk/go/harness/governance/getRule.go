...
func LookupRule(ctx *pulumi.Context, args *LookupRuleArgs, opts ...pulumi.InvokeOption) (*LookupRuleResult, error) {
	...
	err := ctx.Invoke("harness:governance/getRule:getRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupRuleOutput(ctx *pulumi.Context, args LookupRuleOutputArgs, opts ...pulumi.InvokeOption) LookupRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRuleResultOutput, error) {
			...
			return ctx.InvokeOutput("harness:governance/getRule:getRule", args, LookupRuleResultOutput{}, options).(LookupRuleResultOutput), nil
...
// The cloud provider for the rule.
func (o LookupRuleResultOutput) CloudProvider() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRuleResult) string { return v.CloudProvider }).(pulumi.StringOutput)
}
...
// Policy YAML of the rule.
func (o LookupRuleResultOutput) RulesYaml() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRuleResult) string { return v.RulesYaml }).(pulumi.StringOutput)
}

...
func LookupExperimentTemplateOutput(ctx *pulumi.Context, args LookupExperimentTemplateOutputArgs, opts ...pulumi.InvokeOption) LookupExperimentTemplateResultOutput {
	...
	return ctx.InvokeOutput("harness:chaos/getExperimentTemplate:getExperimentTemplate", args, LookupExperimentTemplateResultOutput{}, options).(LookupExperimentTemplateResultOutput)
}

...
func LookupPrometheusConnectorOutput(ctx *pulumi.Context, args LookupPrometheusConnectorOutputArgs, opts ...pulumi.InvokeOption) LookupPrometheusConnectorResultOutput {
	...
	return ctx.InvokeOutput("harness:platform/getPrometheusConnector:getPrometheusConnector", args, LookupPrometheusConnectorResultOutput{}, options).(LookupPrometheusConnectorResultOutput)
}

...
func GetCurrentAccount(ctx *pulumi.Context, args *GetCurrentAccountArgs, opts ...pulumi.InvokeOption) (*GetCurrentAccountResult, error) {
	...
	err := ctx.Invoke("harness:platform/getCurrentAccount:getCurrentAccount", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetCurrentAccountOutput(ctx *pulumi.Context, args GetCurrentAccountOutputArgs, opts ...pulumi.InvokeOption) GetCurrentAccountResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetCurrentAccountResultOutput, error) {
			...
			return ctx.InvokeOutput("harness:platform/getCurrentAccount:getCurrentAccount", args, GetCurrentAccountResultOutput{}, options).(GetCurrentAccountResultOutput), nil

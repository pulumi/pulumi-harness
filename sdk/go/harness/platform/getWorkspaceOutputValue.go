...
type GetWorkspaceOutputValueResult struct {
	...
	// Organization identifier of the organization the workspace resides in.
	OrgId   string                          `pulumi:"orgId"`
	Outputs []GetWorkspaceOutputValueOutput `pulumi:"outputs"`
	// Project identifier of the project the workspace resides in.
	ProjectId string `pulumi:"projectId"`
}
...
func GetWorkspaceOutputValueOutput(ctx *pulumi.Context, args GetWorkspaceOutputValueOutputArgs, opts ...pulumi.InvokeOption) GetWorkspaceOutputValueResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetWorkspaceOutputValueResult, error) {
			args := v.(GetWorkspaceOutputValueArgs)
			r, err := GetWorkspaceOutputValue(ctx, &args, opts...)
			var s GetWorkspaceOutputValueResult
			if r != nil {
				s = *r
			}
			return s, err
...
func (o GetWorkspaceOutputValueResultOutput) Outputs() GetWorkspaceOutputValueOutputArrayOutput {
	return o.ApplyT(func(v GetWorkspaceOutputValueResult) []GetWorkspaceOutputValueOutput { return v.Outputs }).(GetWorkspaceOutputValueOutputArrayOutput)
}

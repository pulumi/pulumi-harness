 ...
 * ```
 */
export class ConnectorAzureKeyVault extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConnectorAzureKeyVaultState, opts?: pulumi.CustomResourceOptions): ConnectorAzureKeyVault {
        return new ConnectorAzureKeyVault(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'harness:platform/connectorAzureKeyVault:ConnectorAzureKeyVault';

    /**
     * Returns true if the given object is an instance of ConnectorAzureKeyVault.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ConnectorAzureKeyVault {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ConnectorAzureKeyVault.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ConnectorAzureKeyVaultArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ConnectorAzureKeyVaultArgs | ConnectorAzureKeyVaultState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ConnectorAzureKeyVaultState | undefined;
            ...
            const args = argsOrState as ConnectorAzureKeyVaultArgs | undefined;
        ...
        super(ConnectorAzureKeyVault.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ConnectorAzureKeyVaultState {
    /**
     * Azure environment type. Possible values: AZURE or AZURE*US*GOVERNMENT. Default value: AZURE
     */
 ...
 */
export interface ConnectorAzureKeyVaultArgs {
    /**
     * Azure environment type. Possible values: AZURE or AZURE*US*GOVERNMENT. Default value: AZURE
     */
    azureEnvironmentType?: pulumi.Input<string>;

...
export class PipelineCentralNotificationRule extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PipelineCentralNotificationRuleState, opts?: pulumi.CustomResourceOptions): PipelineCentralNotificationRule {
        return new PipelineCentralNotificationRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'harness:platform/pipelineCentralNotificationRule:PipelineCentralNotificationRule';

    /**
     * Returns true if the given object is an instance of PipelineCentralNotificationRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PipelineCentralNotificationRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PipelineCentralNotificationRule.__pulumiType;
    }
    ...
    declare public readonly customNotificationTemplateRef: pulumi.Output<outputs.platform.PipelineCentralNotificationRuleCustomNotificationTemplateRef | undefined>;
     ...
     */
    constructor(name: string, args: PipelineCentralNotificationRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PipelineCentralNotificationRuleArgs | PipelineCentralNotificationRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PipelineCentralNotificationRuleState | undefined;
            ...
            const args = argsOrState as PipelineCentralNotificationRuleArgs | undefined;
        ...
        super(PipelineCentralNotificationRule.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface PipelineCentralNotificationRuleState {
    /**
     * Account identifier associated with this notification channel.
     */

...
export class JenkinsConnector extends pulumi.CustomResource {
     ...
     */
    declare public readonly auth: pulumi.Output<outputs.platform.JenkinsConnectorAuth | undefined>;
    /**
...
export interface JenkinsConnectorState {
     ...
     * This entity contains the details for Jenkins Authentication.
     */
    auth?: pulumi.Input<inputs.platform.JenkinsConnectorAuth | undefined>;
    /**
     * Tags to filter delegates for connection.
     */

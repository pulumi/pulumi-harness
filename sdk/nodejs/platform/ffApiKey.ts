 ...
 * ```
 */
export class FfApiKey extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FfApiKeyState, opts?: pulumi.CustomResourceOptions): FfApiKey {
        return new FfApiKey(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'harness:platform/ffApiKey:FfApiKey';

    /**
     * Returns true if the given object is an instance of FfApiKey.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FfApiKey {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FfApiKey.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: FfApiKeyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FfApiKeyArgs | FfApiKeyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FfApiKeyState | undefined;
            ...
            const args = argsOrState as FfApiKeyArgs | undefined;
        ...
        super(FfApiKey.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FfApiKeyState {
    /**
     * The value of the SDK API Key
     */

 ...
 * ```
 */
export class ConnectorGcpSecretManager extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConnectorGcpSecretManagerState, opts?: pulumi.CustomResourceOptions): ConnectorGcpSecretManager {
        return new ConnectorGcpSecretManager(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'harness:platform/connectorGcpSecretManager:ConnectorGcpSecretManager';

    /**
     * Returns true if the given object is an instance of ConnectorGcpSecretManager.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ConnectorGcpSecretManager {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ConnectorGcpSecretManager.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ConnectorGcpSecretManagerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ConnectorGcpSecretManagerArgs | ConnectorGcpSecretManagerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ConnectorGcpSecretManagerState | undefined;
            ...
            const args = argsOrState as ConnectorGcpSecretManagerArgs | undefined;
        ...
        super(ConnectorGcpSecretManager.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ConnectorGcpSecretManagerState {
    /**
     * Reference to the secret containing credentials of IAM service account for Google Secret Manager. To reference a secret at the organization scope, prefix 'org' to the expression: org.{identifier}. To reference a secret at the account scope, prefix 'account` to the expression: account.{identifier}.
     */
 ...
 */
export interface ConnectorGcpSecretManagerArgs {
    /**
     * Reference to the secret containing credentials of IAM service account for Google Secret Manager. To reference a secret at the organization scope, prefix 'org' to the expression: org.{identifier}. To reference a secret at the account scope, prefix 'account` to the expression: account.{identifier}.
     */
    credentialsRef: pulumi.Input<string>;

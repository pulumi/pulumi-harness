...
export class OciHelmConnector extends pulumi.CustomResource {
     ...
     */
    declare public readonly credentials: pulumi.Output<outputs.platform.OciHelmConnectorCredentials | undefined>;
    /**
...
export interface OciHelmConnectorState {
     ...
     * Credentials to use for authentication.
     */
    credentials?: pulumi.Input<inputs.platform.OciHelmConnectorCredentials | undefined>;
    /**
     * Tags to filter delegates for connection.
     */

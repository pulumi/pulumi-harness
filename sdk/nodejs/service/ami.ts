...
export class Ami extends pulumi.CustomResource {
     ...
     */
    declare public readonly variables: pulumi.Output<outputs.service.AmiVariable[] | undefined>;
...
export interface AmiState {
     ...
     * Variables to be used in the service
     */
    variables?: pulumi.Input<pulumi.Input<inputs.service.AmiVariable>[] | undefined>;
}

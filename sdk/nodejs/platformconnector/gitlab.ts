 ...
 */
export class Gitlab extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GitlabState, opts?: pulumi.CustomResourceOptions): Gitlab {
        return new Gitlab(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'harness:PlatformConnector/gitlab:Gitlab';

    /**
     * Returns true if the given object is an instance of Gitlab.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Gitlab {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Gitlab.__pulumiType;
    }
     ...
     */
    public readonly apiAuthentication!: pulumi.Output<outputs.PlatformConnector.GitlabApiAuthentication | undefined>;
    /**
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.PlatformConnector.GitlabCredentials>;
    /**
     ...
     */
    constructor(name: string, args: GitlabArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: GitlabArgs | GitlabState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GitlabState | undefined;
            ...
            const args = argsOrState as GitlabArgs | undefined;
        ...
        super(Gitlab.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface GitlabState {
     ...
     * Configuration for using the gitlab api. API Access is required for using “Git Experience”, for creation of Git based triggers, Webhooks management and updating Git statuses.
     */
    apiAuthentication?: pulumi.Input<inputs.PlatformConnector.GitlabApiAuthentication>;
    /**
     * Whether the connection we're making is to a gitlab repository or a gitlab account. Valid values are Account, Repo.
     */
     ...
     * Credentials to use for the connection.
     */
    credentials?: pulumi.Input<inputs.PlatformConnector.GitlabCredentials>;
    /**
     * Connect using only the delegates which have these tags.
     */

...
export class Github extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'harness:PlatformConnector/github:Github';
     ...
     */
    public readonly apiAuthentication!: pulumi.Output<outputs.PlatformConnector.GithubApiAuthentication | undefined>;
    /**
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.PlatformConnector.GithubCredentials>;
    /**
...
export interface GithubState {
     ...
     * Configuration for using the github api. API Access is required for using “Git Experience”, for creation of Git based triggers, Webhooks management and updating Git statuses.
     */
    apiAuthentication?: pulumi.Input<inputs.PlatformConnector.GithubApiAuthentication>;
    /**
     * Whether the connection we're making is to a github repository or a github account. Valid values are Account, Repo.
     */
     ...
     * Credentials to use for the connection.
     */
    credentials?: pulumi.Input<inputs.PlatformConnector.GithubCredentials>;
    /**
     * Connect using only the delegates which have these tags.
     */

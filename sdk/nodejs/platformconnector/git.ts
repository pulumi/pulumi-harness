...
export class Git extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'harness:PlatformConnector/git:Git';
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.PlatformConnector.GitCredentials>;
    /**
...
export interface GitState {
     ...
     * Credentials to use for the connection.
     */
    credentials?: pulumi.Input<inputs.PlatformConnector.GitCredentials>;
    /**
     * Connect using only the delegates which have these tags.
     */

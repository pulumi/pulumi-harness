 ...
 */
export function getAwsCC(args?: GetAwsCCArgs, opts?: pulumi.InvokeOptions): Promise<GetAwsCCResult> {
    args = args || {};
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("harness:PlatformConnector/getAwsCC:getAwsCC", {
 ...
 */
export interface GetAwsCCResult {
    /**
     * The AWS account id.
     */
     ...
     */
    readonly crossAccountAccesses: outputs.PlatformConnector.GetAwsCCCrossAccountAccess[];
    /**
...
export function getAwsCCOutput(args?: GetAwsCCOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAwsCCResult> {
    return pulumi.output(args).apply(a => getAwsCC(a, opts))
}

/**
 * A collection of arguments for invoking getAwsCC.
 */
export interface GetAwsCCOutputArgs {
    /**
     * Unique identifier of the resource.
     */

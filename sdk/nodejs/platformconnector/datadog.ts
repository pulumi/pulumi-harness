 ...
 */
export class Datadog extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatadogState, opts?: pulumi.CustomResourceOptions): Datadog {
        return new Datadog(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'harness:PlatformConnector/datadog:Datadog';

    /**
     * Returns true if the given object is an instance of Datadog.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Datadog {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Datadog.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: DatadogArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DatadogArgs | DatadogState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DatadogState | undefined;
            ...
            const args = argsOrState as DatadogArgs | undefined;
        ...
        super(Datadog.__pulumiType, name, resourceInputs, opts);
    }
}

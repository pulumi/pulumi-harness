...
export class Bitbucket extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'harness:PlatformConnector/bitbucket:Bitbucket';
     ...
     */
    public readonly apiAuthentication!: pulumi.Output<outputs.PlatformConnector.BitbucketApiAuthentication | undefined>;
    /**
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.PlatformConnector.BitbucketCredentials>;
    /**
...
export interface BitbucketState {
     ...
     * Configuration for using the BitBucket api. API Access is required for using “Git Experience”, for creation of Git based triggers, Webhooks management and updating Git statuses.
     */
    apiAuthentication?: pulumi.Input<inputs.PlatformConnector.BitbucketApiAuthentication>;
    /**
     * Whether the connection we're making is to a BitBucket repository or a BitBucket account. Valid values are Account, Repo.
     */
     ...
     * Credentials to use for the connection.
     */
    credentials?: pulumi.Input<inputs.PlatformConnector.BitbucketCredentials>;
    /**
     * Connect using only the delegates which have these tags.
     */

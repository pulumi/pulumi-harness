...
export class Helm extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'harness:PlatformConnector/helm:Helm';
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.PlatformConnector.HelmCredentials | undefined>;
    /**
...
export interface HelmState {
     ...
     * Credentials to use for authentication.
     */
    credentials?: pulumi.Input<inputs.PlatformConnector.HelmCredentials>;
    /**
     * Connect using only the delegates which have these tags.
     */

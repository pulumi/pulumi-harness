 ...
 */
export class Jira extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: JiraState, opts?: pulumi.CustomResourceOptions): Jira {
        return new Jira(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'harness:PlatformConnector/jira:Jira';

    /**
     * Returns true if the given object is an instance of Jira.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Jira {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Jira.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: JiraArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: JiraArgs | JiraState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as JiraState | undefined;
            ...
            const args = argsOrState as JiraArgs | undefined;
        ...
        super(Jira.__pulumiType, name, resourceInputs, opts);
    }
}
